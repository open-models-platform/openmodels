...
const STORAGE_URL = 'https://dev.openmodels.co/storage/v1/object/public/images/lw6'
...
export async function handler(req: Request) {
  ...
  try {
    // Try to get image from OpenModels Storage CDN.
      ...
      (
        <>
          ...
          >
            ...
            >
              open-models-platform.com/launch-week
            </p>
          </div>
          {/* Ticket No  */}
          <div
    ...
    const { error } = await openmodelsAdminClient.storage
      .from('images')
