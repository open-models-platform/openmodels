              ...
              actions: [
                TextButton(
                  onPressed: () async {
                    ...
                    await openmodels.removeChannel(_gameChannel!);
                    _openLobbyDialog();
                  },
        ...
        builder: (context) {
          return _LobbyDialog(
            onGameStarted: (gameId) async {
              ...
              _gameChannel = openmodels.channel(gameId,
...
class _LobbyDialogState extends State<_LobbyDialog> {
  ...
  void initState() {
    ...
    _lobbyChannel = openmodels.channel(
      'lobby',
  ...
  @override
  void dispose() {
    openmodels.removeChannel(_lobbyChannel);
    super.dispose();
  }
