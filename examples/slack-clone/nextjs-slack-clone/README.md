# Realtime chat example using OpenModels
...
- Live demo: http://openmodels-slack-clone-openmodels.vercel.app/
- CodeSandbox: https://codesandbox.io/s/github/open-models-platform/openmodels/tree/master/examples/nextjs-slack-clone
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fopenmodels%2Fopenmodels%2Ftree%2Fmaster%2Fexamples%2Fslack-clone%2Fnextjs-slack-clone&env=NEXT_PUBLIC_OPENMODELS_URL,NEXT_PUBLIC_OPENMODELS_ANON_KEY&envDescription=Find%20the%20Supabase%20URL%20and%20key%20in%20the%20your%20auto-generated%20docs%20at%20openmodels.com/dashboard&project-name=openmodels-slack-clone&repo-name=openmodels-slack-clone)
...
You will be asked for a `NEXT_PUBLIC_OPENMODELS_URL` and `NEXT_PUBLIC_OPENMODELS_ANON_KEY`. Use the API URL and `anon` key from [step 3](#3-get-the-url-and-key).
...
Set your OpenModels details from [step 3](#3-get-the-url-and-key) above:

```bash
NEXT_PUBLIC_OPENMODELS_URL=<replace-with-your-API-url>
NEXT_PUBLIC_OPENMODELS_ANON_KEY=<replace-with-your-anon-key>
```
...
```sql
--
-- For use with https://github.com/open-models-platform/openmodels/tree/master/examples/slack-clone/nextjs-slack-clone
--
...
comment on column public.users.id is 'References the internal OpenModels Auth user.';
...
alter publication openmodels_realtime add table public.channels;
alter publication openmodels_realtime add table public.messages;
alter publication openmodels_realtime add table public.users;
