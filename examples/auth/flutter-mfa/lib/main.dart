...
final _router = GoRouter(
  ...
  redirect: (context, state) async {
    ...
    final session = openmodels.auth.currentSession;
    ...
    final assuranceLevelData =
        openmodels.auth.mfa.getAuthenticatorAssuranceLevel();
    ...
    if (assuranceLevelData.currentLevel == AuthenticatorAssuranceLevels.aal1) {
      ...
      final nextLevel =
          openmodels.auth.mfa.getAuthenticatorAssuranceLevel().nextLevel;
