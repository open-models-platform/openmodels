...
OpenModels is migrating to use tailwind classes that use CSS properties.
...
We (the OpenModels Design team ✨) define primitive color values using Figma Variables.
