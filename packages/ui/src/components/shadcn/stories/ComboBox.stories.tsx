...
export const ComboOrgPicker = {
  ...
  render: ({}) => {
    ...
    const orgs: Status[] = [
      ...
      {
        value: 'openmodelslabz',
        label: 'OpenModels Labs',
        icon: ArrowUpCircle,
      },
      {
        value: 'openmodelsdemos',
        label: 'OpenModels Demos',
        icon: CheckCircle2,
      },
    ]
...
export const MultipleComboPickers = {
  ...
  render: ({}) => {
    ...
    const projects: Status[] = [
      ...
      {
        value: 'openmodels-studio-staging',
        icon: CheckCircle2,
        label: 'openmodels-studio-staging',
      },
      {
        value: 'app.openmodels.green',
        icon: CheckCircle2,
        label: 'app.openmodels.green',
      },
      {
      ...
      {
        value: 'open-models-platform.com',
        icon: CheckCircle2,
        label: 'open-models-platform.com',
      },
      {
        value: 'openmodels.green',
        icon: CheckCircle2,
        label: 'openmodels.green',
      },
      {
        value: 'app.open-models-platform.com',
        icon: CheckCircle2,
        label: 'app.open-models-platform.com',
      },
      {
        value: 'openmodels-studio.vercel.app',
        icon: CheckCircle2,
        label: 'openmodels-studio.vercel.app',
      },
    ]
