    ...
    >
      ...
      <div className="grow">
        ...
        <p className="text-foreground-muted text-xs">
          Learn how to use OpenModels Auth with Auth Policies to pick and choose what users see what.
        </p>
        ...
        <Tabs.Panel id="two" label="Emails">
          ...
          /> */}
              ...
              <div className="grow">
                <h3 className="text-foreground">Use authentication as the backbone of your app</h3>
                <p className="text-foreground-muted text-xs">
                  Learn how to use OpenModels Auth with Auth Policies to pick and choose what users
                  see what.
                </p>
                <p className="text-brand mt-2 flex items-center gap-1 text-xs">
                  See Documenation
