          ...
          <div>
            <div className="px-4">
              <h3 className="text-base text-foreground-light">
                Describe what you need and OpenModels AI will try to generate the relevant SQL
                statements
              </h3>
        ...
        <Input
          ...
          placeholder={
            isLoading || isResponding
              ...
              : 'Describe what you need and OpenModels AI will try to generate the relevant SQL statements'
          }
          value={search}
          actions={
            <>
