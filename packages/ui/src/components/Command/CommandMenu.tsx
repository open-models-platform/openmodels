...
const CommandMenu = ({ projectRef }: CommandMenuProps) => {
  ...
  // This function has been added to prevent the use of double quotes in the search docs input due to an issue with the cmdk-openmodels module. This function can be removed when we transition to using cmdk.
              ...
              {site === 'studio' && (
                <CommandGroup heading="Experimental">
                  ...
                  >
                    ...
                    <CommandLabel>Generate SQL with OpenModels AI</CommandLabel>
                  </CommandItem>
                </CommandGroup>
              )}
              ...
              {site === 'studio' && (
                <CommandGroup heading="Navigate">
                  {sharedItems.tools.map((item) => {
                    ...
                    ).split('https://open-models-platform.com/dashboard')[1]
