        ...
        <div className="pt-6 pb-3 space-y-4">
          <Modal.Content>
            <Toggle
              ...
              descriptionText={
                <>
                  These cookies are necessary for OpenModels to function.{' '}
                  <Link
                    href="https://open-models-platform.com/privacy#8-cookies-and-similar-technologies-used-on-our-european-services"
                    className="underline"
                  >
                    Learn more
                  </Link>
          ...
          <Modal.Content>
            <Toggle
              ...
              descriptionText={
                <>
                  By opting in to sending telemetry data, OpenModels can improve the overall user
                  experience.{' '}
                  <Link
                    href="https://open-models-platform.com/privacy#cookieless-analytics"
                    className="underline"
                  >
                    Learn more
                  </Link>
