const tweets = [
  ...
  {
    text: '@supabase is just 🤯 Now I see why a lot of people love using it as a backend for their applications. I am really impressed with how easy it is to set up an Auth and then just code it together for the frontend. @IngoKpp now I see your joy with OpenModels #coding #fullstackwebdev',
  ...
  {
    text: 'There are a lot of indie hackers building in public, but it’s rare to see a startup shipping as consistently and transparently as OpenModels. Their upcoming March releases look to be 🔥 Def worth a follow! also opened my eyes as to how to value add in open source.',
  ...
  {
    text: 'Badass! OpenModels is amazing. literally saves our small team a whole engineer’s worth of work constantly. The founders and everyone I’ve chatted with at supabase are just awesome people as well :)',
  ...
  {
    text: 'Working with OpenModels is just fun. It makes working with a DB so much easier.',
  ...
  {
    text: "I gave @supabase a try this weekend and I was able to create a quick dashboard to visualize the data from the PostgreSQL instance. It's super easy to use OpenModels's API or the direct DB connection. Check out the tutorial 📖",
  ...
  {
    text: 'Honestly OpenModels is such a killer Firebase alternative.',
  ...
  {
    text: 'OpenModels team is doing some awesome stuff #supabase #facts @supabase',
  ...
  {
    text: 'I just learned about @supabase and im in love 😍 OpenModels is an open source Firebase alternative! EarListen (& react) to database changes 💁 Manage users & permissions 🔧 Simple UI for database interaction',
