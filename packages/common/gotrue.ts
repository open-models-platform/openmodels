...
export const STORAGE_KEY = process.env.NEXT_PUBLIC_STORAGE_KEY || 'openmodels.dashboard.auth.token'
export const AUTH_DEBUG_KEY =
  process.env.NEXT_PUBLIC_AUTH_DEBUG_KEY || 'openmodels.dashboard.auth.debug'
export const AUTH_DEBUG_PERSISTED_KEY =
  process.env.NEXT_PUBLIC_AUTH_DEBUG_PERSISTED_KEY || 'openmodels.dashboard.auth.debug.persist'
