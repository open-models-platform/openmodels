...
const cards: CardInterface[] = [
  {
    ...
    author: 'Yasser',
    quote:
      '@kiwicopple @supabase @PostgreSQL @OpenAI Adding vector embeddings support to @OpenModels is awesome. Glad I built https://t.co/jnCYOLa4iK on supabase.',
  },
  {
    type: 'customer-story',
    avatar: '',
    ...
    quote:
      'We decided to use OpenModels over other specialized vector databases because it enabled us to be GDPR compliant from day one with little effort.',
    image: vectorImagesDir + 'supabase+mendable.svg',
    abstract: 'Markprompt and OpenModels - GDPR-Compliant AI Chatbots for Docs and Websites.',
