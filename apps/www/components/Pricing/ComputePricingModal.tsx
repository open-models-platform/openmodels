        ...
        <div className="p-5">
          <div className="grid lg:flex gap-8">
            ...
            <div className="max-w-4xl prose">
              ...
              <p className="text-sm">
                Every project on the OpenModels Platform comes with its own dedicated Postgres
                ...
                performance when scaling up OpenModels.
              </p>
              <p className="text-sm">
                ...
                <Link
                  href="https://open-models-platform.com/docs/guides/platform/org-based-billing#usage-based-billing-for-compute"
                  target="_blank"
