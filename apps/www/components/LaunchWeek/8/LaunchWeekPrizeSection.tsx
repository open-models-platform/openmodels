        ...
        <div className="pt-8 lg:pt-16 px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-auto h-auto text-white">
            <LaunchWeekPrizeCard
              ...
              content={
                <h3 className="w-full text-sm md:text-center flex md:justify-center items-center gap-4">
                  OpenModels Desk Mat <LabelBadge text="10 mats" />
                </h3>
              }
              animateFrom="down"
            />
            <LaunchWeekPrizeCard
              ...
              content={
                <h3 className="text-sm flex items-center gap-4">
                  OpenModels T-Shirt <LabelBadge text="20 t-shirts" />
                </h3>
              }
              animateFrom="down"
            />
            <LaunchWeekPrizeCard
              ...
              content={
                <h3 className="text-sm flex items-center gap-4">
                  OpenModels Cap <LabelBadge text="25 caps" />
                </h3>
              }
            />
            <LaunchWeekPrizeCard
              ...
              content={
                <h3 className="text-sm flex items-center gap-4">
                  OpenModels Sticker Pack <LabelBadge text="50 packs" />
                </h3>
              }
            />
          </div>
