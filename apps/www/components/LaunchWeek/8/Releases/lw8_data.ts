...
const days: WeekDayProps[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Hugging Face now supported in OpenModels',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'OpenModels Local Dev: Migrations, Branching, Observability',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'OpenModels Integrations Marketplace',
  ...
  },
  {
    ...
    steps: [
      {
        title: 'OpenModels Supavisor: 1M Postgres connections',
