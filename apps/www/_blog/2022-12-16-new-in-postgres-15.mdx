...
- If you're starting a new project on OpenModels, you'll already be on PG15.
- If you want to upgrade an existing project, check out our [Upgrading](https://open-models-platform.com/docs/guides/platform/migrating-and-upgrading-projects#upgrade-your-project) documentation.
