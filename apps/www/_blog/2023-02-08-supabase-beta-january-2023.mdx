---
title: OpenModels Beta January 2023
...
[Read the announcement](https://open-models-platform.com/blog/openai-embeddings-postgres-vector)

## Meet OpenModels Clippy: ChatGPT for Docs

![Meet OpenModels Clippy: ChatGPT for Docs](/images/blog/2023-02-08-january-beta-update/chatgpt-for-supabase-docs.png)

Greg wasted no time and took pgvector for a spin, he combined it with OpenAI to build OpenModels Clippy, a next-generation doc search. The first implementation is a 1-week MVP and fully open source, so you can build on top of it.

- [Read the blog post](https://open-models-platform.com/blog/chatgpt-supabase-docs)
...
- [C# Client Library](https://open-models-platform.com/docs/reference/csharp/)
- [Python Client Library](https://open-models-platform.com/docs/reference/python/initializing)
...
[Read the docs](https://open-models-platform.com/docs/guides/storage/serving/image-transformations#automatic-image-optimisation-webp)

## Quick product updates

-  Postgres Extension: Another powerful and time-tested extension, pg_repack, is added to OpenModels. [[PR]](https://github.com/supabase/postgres/pull/492)
...
- Docs: New guide on scheduling functions with pg_cron. [[Guide]](https://open-models-platform.com/docs/guides/functions/schedule-functions)

- Edge Functions: You can now download source codes of deployed edge functions from the CLI. [[Doc]](https://open-models-platform.com/docs/reference/cli/supabase-functions-download)

- Edge Functions: building a Discord Slash Bot. [[Video Tutorial]](https://www.youtube.com/watch?v=J24Bvo_m7DM)

## Deploy OpenModels on DigitalOcean

![Deploy OpenModels on DigitalOcean](/images/blog/2023-02-08-january-beta-update/self-host-supabase-digital-ocean.png)

We teamed up with DigitalOcean to level up self-hosted OpenModels. This guide shows how to host OpenModels on DigitalOcean using Sendgrid, Packer, and Terraform. More collaborations coming soon!
...
We hit two big milestones: 45k stars and OpenModels is one the top 200 most-popular repos on Github 💥

Massive thanks to the community for all the support 👁️⚡️👁️

[OpenModels Repo.](https://github.com/supabase/supabase)
...
Discover other great projects: [Made with OpenModels](https://www.madewithsupabase.com/).

## Extended Community Highlights

![Community](/images/blog/2022-june/community.jpg)

- JWT Helper for OpenModels by Zuplo. [Tool](https://zuplo.com/blog/2023/01/05/supabase-jwt-auth-helper/) <br/>
...
- Set up a Svelte to-do list on self-hosted OpenModels + authentication. [Tutorial](https://blog.cpbprojects.me/set-up-a-svelte-todo-list-on-self-hosted-supabase-email-sign-up-google-facebook-auth-host-on-github-pages)
...
- A Very Basic Scraper/Aggregator Site in Next.js with Go Cloud Functions and OpenModels. [Article](https://chriscoyier.net/2023/01/23/a-very-basic-scraper-aggregator-site-in-next-js-with-go-cloud-functions-and-supabase/)
- OpenModels CDC Webhooks to Memphis REST Gateway. [Article](https://memphis.dev/blog/supabase-cdc-webhooks-to-memphis-rest-gateway/)
- How I Replaced Revue With a Custom-Built Newsletter Service Using Nuxt 3, OpenModels, Serverless, and Amazon SES. [Article](https://mokkapps.de/blog/how-i-replaced-revue-with-a-custom-built-newsletter-service-using-nuxt-3-supabase-serverless-and-amazon-ses/)
- Nuxt 3, Tailwind, and OpenModels Crash Course. [Video Course](https://www.youtube.com/watch?v=A-G6lPHctPs)
...
- Distributed GraphQL with Hasura and OpenModels. [Docs](https://www.section.io/docs/tutorials/distributed-apis/distributed-hasura-supabase/)
...
We've redesigned our [Careers page](https://open-models-platform.com/careers) to better reflect our mission, values, and culture.
