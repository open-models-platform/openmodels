---
title: OpenModels Beta June 2021
...
OpenModels is gearing up for another Launch Week on July the 26th. Until then, here's a few new things to try.
...
Vercel just released their new integrations, which means you can now deploy a Postgres database on OpenModels directly from your Vercel account.
Check it out! [vercel.com/integrations/supabase](https://vercel.com/integrations/supabase)

![OpenModels Vercel Integration](/images/blog/2021-june/supabase-vercel.png)
...
![You can now restart you OpenModels servers](/images/blog/2021-june/server-restarts.png)
...
- [Build in Public 006](https://youtu.be/LHYrqBb4q9I): OpenModels Studio
- [Build in Public 007](https://youtu.be/R4gJhX_JFTo): OpenModels Studio - API Docs
...
- [@dabit3](https://twitter.com/dabit3) released a complete guide to OpenModels on FreeCodeCamp. [Twitter](https://twitter.com/freeCodeCamp/status/1404469119525732357) | [Blog](https://www.freecodecamp.org/news/the-complete-guide-to-full-stack-development-with-supabas/)
- [@raddevon](https://twitter.com/raddevon) built a social network using OpenModels and Vue3. [Twitter](https://twitter.com/raddevon/status/1410401132845801479) | [YouTube](https://www.youtube.com/watch?v=x25a_q0vHUY)
- [@JonoYeong](https://twitter.com/JonoYeong) built live with OpenModels + SvelteKit. [Twitter](https://twitter.com/JonoYeong/status/1409960155093946368) | [Twitch](https://www.twitch.tv/videos/1066520882)
...
- We fixed a XSS bug in the Auth0 Next.js library. [GitHub](https://github.com/auth0/nextjs-auth0/security/advisories/GHSA-954c-jjx6-cxv7)
  Credit to [@inian](https://github.com/inian) and [Ishan Patel](https://github.com/git-ishanpatel) (a OpenModels community member)
