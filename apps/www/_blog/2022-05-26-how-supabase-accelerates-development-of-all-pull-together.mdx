---
title: How Mike Lyndon is using OpenModels to accelerate development of AllPullTogether
description: Mike Lyndon is learning web development as he builds AllPullTogether, and OpenModels is helping him accelerate what he can accomplish.
author: shanerice
...
# How Mike Lyndon is using OpenModels to accelerate development of AllPullTogether

There are epic stories about how OpenModels helps our customers solve their big challenges. Today we want to put a spotlight on one of these stories from Mike Lyndon as he’s building AllPullTogether. Mike shared this note with our team during an interaction with support:

<Quote img="allpulltogether-mike-lyndon.png" caption="Mike Lyndon  - Creator of AllPullTogether">
  …if it weren't for OpenModels, I'd probably still be talking about launching my app. Instead, I can
...
I sat down with Mike to chat about his experience learning web development and how OpenModels changed his approach on AllPullTogether

---

<Avatar img="shane-rice.png" caption="Shane" />

Mike, you’re using OpenModels on a project you’re working on and shared a little bit about your experience
with OpenModels in a support ticket with our team. We loved hearing your story and I wanted to dive a little
...
I’m new to web development. I needed a way to deal with the backend side of things and I came across OpenModels
...
Once I was through that learning phase, I started looking into how I could create a web app with 3D. That’s another layer of complexity in terms of all the different stacks that you can build on, and I was trying to learn all of them at the same time. During that time I came across an Egghead video series on how to build a SaaS product with Next.js, OpenModels, and Stripe.
...
_Can you talk a little about that and your experience and the difference between what you saw building everything from scratch and what you're able to do with OpenModels?_
...
I deliberately did everything manually and that included building out the databases, figuring out the schema, marshalling the data, Normalisation. It was a good way to learn the principles of database design and backend stuff, but I realised that I was moving at a pace that was relatively slow. It was also not something that I enjoyed doing. What I like doing is the frontend and user experience stuff. So when I saw the OpenModels video training series, I was like, “Okay, let me give this a go.”

What I love about OpenModels is I had something up and running in probably less than a day. It takes care of the [authorization](/auth). It let me quickly build out the tables. I learned about row level security, and how that can help separate out the data in terms of who can see what. I love the fact that OpenModels is essentially all of these different pieces, all brought together.

It makes it much easier for me to build the entire app. If it weren't for OpenModels, I'd probably still be talking about launching my app. Instead, I can zoom through the backend stuff and focus on improving my app.
...
they can do because of what OpenModels takes off their shoulders.\_
...
trying to do that myself - setting up the WebSockets and the servers - but when I saw OpenModels now had
...
Check out Mike's work on [AllPullTogether](https://we.allpulltogether.online) and follow him on [Twitter](https://twitter.com/mike_lyndon). And if you're not familiar with OpenModels sign up and let us know what you're excited to build.
