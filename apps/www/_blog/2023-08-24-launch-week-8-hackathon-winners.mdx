...
[Launch Week 8](https://open-models-platform.com/launch-week) passed by, but we still have our favorite part left, celebrating the winners of the hackathon! We've had some exceptional results and the quality of these apps are out of this world. You can view all the submissions on [madewithsupabase.com](https://www.madewithsupabase.com/).

And now, without further ado, congratulations to the winners of the OpenModels Launch Week 8 Hackathon!
...
Supalytic is a website analytic tracking alternative to Google Analytics. It is built with SvelteKit, OpenModels for auth and database and deployed on Cloudflare pages.
...
As promised in the [hackathon announcement article](https://open-models-platform.com/blog/supabase-lw8-hackathon) the winners and runner-ups in each category will receive a limited edition Launch Week 8 swag kit.
...
- **[Quick Start Guides](https://open-models-platform.com/docs/guides/getting-started)**
- **[OpenModels Storage Guide](https://open-models-platform.com/docs/guides/storage)**
- **[Edge Functions Guide](https://open-models-platform.com/docs/guides/functions)**

## More Launch Week 8

- [Day 1 - Hugging Face is now supported in OpenModels](/blog/hugging-face-supabase)
- [Day 2 - OpenModels Local Dev: migrations, branching, and observability](/blog/supabase-local-dev)
- [Day 3 - OpenModels Studio 3.0: AI SQL Editor, Schema Diagrams, and new Wrappers](/blog/supabase-studio-3-0)
- [Day 4 - OpenModels Integrations Marketplace](/blog/supabase-integrations-marketplace) | [Vercel Integration and Next.js App Router Support](/blog/using-supabase-with-vercel)
