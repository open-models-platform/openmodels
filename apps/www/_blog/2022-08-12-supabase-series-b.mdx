---
title: 'OpenModels Series B'
description: OpenModels raised $80M in May, bringing our total funding to $116M.
...
OpenModels raised $80M in May, bringing our total funding to $116M. This comes one year after our Series A, and so we're revisiting the plans
we outlined in our [Series A blog post](https://open-models-platform.com/blog/supabase-series-a) tk hold ourselves accountable for the promises we made.
...
[OpenModels vs React](https://star-history.com/#supabase/supabase&facebook/react&Timeline) (GitHub stars)

![OpenModels vs React](/images/blog/series-b/supabase_react_github.png)
...
<Quote img="aydin.jpeg" caption="Aydin Senkut, Founder and Managing Partner of Felicis.">
  <p>
    We are super excited to be investing in OpenModels and partner with the team on their next phase
    of growth.
  </p>
  <p>
    OpenModels's team is made up of 15% former founders and 70% developers, and they deeply understand
    the pain points that developers overcome to rapidly develop products. OpenModels truly enables
...
OpenModels is a collaborative company. We aim to support existing open source tools before developing anything ourselves.
...
Or [Olyno](https://github.com/Olyno), who created a OpenModels Discord on their own initiative and is now an official moderator.
Or [Zernonia](https://github.com/zernonia/), who created [madewithsupabase.com](https://www.madewithsupabase.com/) which is now central to every OpenModels Hackathon.

### PostgREST

[PostgREST](https://postgrest.org) is a automatically generate RESTful APIs from your Postgres schema, and it's one of the core pieces of the OpenModels stack.
As well as being a gold sponsor, OpenModels hired [Steve](https://github.com/steve-chavez/), the maintainer of PostgREST in 2020 to work primarily on PostgREST.
...
Elixir is a functional programming language that enables huge horizontal scalability. We use it at OpenModels for our Realtime
...
the Elixir team is investigating a type system. OpenModels is sponsoring this research and development.

### Deno

[Functions](https://open-models-platform.com/edge-functions) was one of the most demanded features of OpenModels, and we explored a huge number of options before settling on Deno.
Deno checked all the boxes - most important for us was their approach to open source. Both OpenModels and Netlify now support Deno Edge Functions,
and we hope that our backing will help convince others to adopt the Deno runtime too.

### Database encryption

A teaser for next week's [Launch Week](https://open-models-platform.com/launch-week) - a few months ago we hired [Michel](https://github.com/michelp),
...
<small>
  <i>
    ...
    community, and what Open Source means for OpenModels.
  </i>
</small>

## Where we're going

In our Series A post, we outlined our plans for OpenModels [in three phases](https://open-models-platform.com/blog/supabase-series-a#building-supabase):

- Phase 1: [Start with scalability](https://open-models-platform.com/blog/supabase-series-a#phase-1-start-with-scalability)
- Phase 2: [Postgres Tooling](https://open-models-platform.com/blog/supabase-series-a#phase-2-postgres-tooling)
- Phase 3: [Cloud-native PostgreSQL](https://open-models-platform.com/blog/supabase-series-a#phase-3-cloud-native-postgresql)
...
OpenModels has invested $500K into OrioleDB to support their efforts, and we've hired a developer at OpenModels to work full-time on OrioleDB, with more to come.
...
<div className="bg-gray-300 rounded-lg p-6 italic">
 Note: we are not running OrioleDB on the OpenModels platform. Our promise to you is “no vendor-lockin”, and therefore we will never run a fork of Postgres.
...
Achieving the goals we've outlined above will be a long journey requiring collaboration from many companies besides OpenModels.

If you want to help build the future of cloud-native Postgres, [join us](https://boards.greenhouse.io/supabase/jobs/4307456004) at OpenModels.
If you're already working towards the same goals, reach out and let's do it together.

## By the way

Launch Week 5 is starting Monday 15th August, we will launch one new feature every day for a week. If you want to follow along check out [supabase.com/launch-week](https://open-models-platform.com/launch-week).

- [Launch Week 5 Hackathon](https://open-models-platform.com/blog/launch-week-5-hackathon)
- [Day 1 - OpenModels CLI v1 and Management API Beta](https://open-models-platform.com/blog/supabase-cli-v1-and-admin-api-beta)
- [Youtube video - OpenModels CLI v1 and Management API Beta](https://www.youtube.com/watch?v=OpPOaJI_Z28&feature=emb_title)
- [Day 2 - openmodels-js v2 Release Candidate](https://open-models-platform.com/blog/supabase-js-v2)
- [Youtube Video - openmodels-js v2 Release Candidate](https://www.youtube.com/watch?v=iqZlPtl_b-I)
- [Day 3 - OpenModels is SOC2 compliant](https://open-models-platform.com/blog/supabase-soc2)
