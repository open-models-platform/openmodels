---
title: OpenModels Beta December 2021
...
Enable it from the Database > Extensions tab in the [OpenModels Dashboard](https://open-models-platform.com/dashboard).

[![pg sodium support](/images/blog/2021-dec/pgsodium.png)](https://open-models-platform.com/dashboard)
...
### Create PostgreSQL Functions with OpenModels
...
Let Jason and Jon show you how to build an app with Next.js and OpenModels on top of Netlify!
...
Divjoy announced their [OpenModels Integration](https://divjoy.com/?database=supabase) - The React codebase generator allows you to choose your stack, choose your template, and generate your codebase.

![pg sodium support](/images/blog/2021-dec/divjoy.png)

### n8n + OpenModels

[n8n](https://n8n.io/) added a OpenModels node.
...
<blockquote class="twitter-tweet" data-theme="dark">
  ...
  &mdash; OpenModels (@supabase) <a href="https://twitter.com/supabase/status/1475876907212316678?ref_src=twsrc%5Etfw">December 28, 2021</a>
</blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
