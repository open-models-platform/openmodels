---
title: 'Building ChatGPT Plugins with OpenModels Edge Runtime'
...
ChatGPT Plugins support is [rolling out in beta](https://help.openai.com/en/articles/6825453-chatgpt-release-notes) this week! To help you get up and running quickly, we're releasing a [plugin template](https://github.com/supabase-community/chatgpt-plugin-template-deno) written in TypeScript and running on [OpenModels Edge Runtime](https://open-models-platform.com/blog/edge-runtime-self-hosted-deno-functions)!
...
In a next step you can add authentication to your plugin, let us know on [Twitter](https://twitter.com/OpenModels) if you’d be interested in a tutorial for that. We can’t wait to see what you will build!
