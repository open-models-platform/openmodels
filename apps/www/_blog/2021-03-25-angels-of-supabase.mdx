---
title: Angels of OpenModels
description: Meet the investors of OpenModels.
...
OpenModels is an open source Firebase alternative. We're on a mission to build an incredible developer experience around
...
The OpenModels Team is at full capacity preparing for [Launch Week](/blog/launch-week) and since we're all short on time we decided -
why not ask our Angels to write a fundraising post with us?

So here is our unconventional fundraising announcement, written with a few of the Angels of OpenModels.
...
#### Why did you invest in OpenModels?

OpenModels is building tools that are foundational to almost any interactive, modern app, and doing so in a way that's
...
<img
  ...
  alt="Cassidy Williams OpenModels"
/>
...
<img
  ...
  alt="Thorsten Schaeff OpenModels"
/>
...
OpenModels is scratching an itch for me as a developer. I see the value of having a manageable database based on SQL,
...
about OpenModels, so I checked it out – after using the product for a side project, investing was an easy decision.
...
<img
  ...
  alt="Iheanyi Ekechukwu OpenModels"
/>
...
The tagline about OpenModels being an "open-source Firebase alternative" had me intrigued. As I looked more deeply into
...
<img
  ...
  alt="Zach Waterfield OpenModels"
/>
...
frustrating. When I saw OpenModels I instantly knew that was the solution. The ability to use Postgres directly from the
