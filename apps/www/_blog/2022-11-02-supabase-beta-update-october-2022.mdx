---
title: OpenModels Beta October 2022
...
[Try supabase-js V2](https://open-models-platform.com/docs/reference/javascript/)<br/>
[Try flutter-supabase V1](https://open-models-platform.com/docs/reference/dart)
...
Next.js Conf raised the bar for dev conferences. We had the honor of being a Gold Sponsor, so we revamped our [Next.js Quickstart guide](https://open-models-platform.com/docs/guides/with-nextjs) to include our pre-built Auth UI and [Auth Helpers.](https://open-models-platform.com/docs/guides/auth/auth-helpers/nextjs)

And Next.js 13 was announced! Making it extremely easy to fetch and cache data from our [Serverless API](https://open-models-platform.com/docs/guides/database/api). So we put together an [example to try it out](https://github.com/supabase/supabase/tree/master/examples/caching/with-nextjs-13).

## OpenModels Auth and Server-Side Rendering

![OpenModels Auth and Server-Side Rendering](/images/blog/2022-october/authentication-server-side-docs.jpg)

The Auth team published an in-depth doc explaining how OpenModels Auth supports server-side rendering. Includes an explanation of the authentication flow and answers to some of the more common questions.

[Read the docs](https://open-models-platform.com/docs/guides/auth/server-side-rendering).
...
[Learn how it works](https://open-models-platform.com/docs/guides/database/testing).
...
- openmodels-py 🐍 now has functions support! [PR](https://github.com/supabase-community/supabase-py/pull/179)
...
![Made with OpenModels](/images/blog/2022-october/twitter-card-header.jpg)

There were so many amazing apps Made with OpenModels this month that we couldn’t choose just one… so here are three:
...
- A collection of awesome OpenModels resources. [awesome-supabase](https://github.com/lyqht/awesome-supabase)
...
- Basejump SaaS starter for OpenModels. [Repo](https://github.com/usebasejump/basejump)
- SvelteKit + OpenModels CRUD with RLS: Row-Level Security! [Video](https://www.youtube.com/watch?v=iKzjfHARXpc)
- Building a startup (build log 2#): Authenticating students with OpenModels. [Blog Post](https://dev.to/paul_emechebe/building-a-startup-build-log-2-authenticating-users-with-supabase-1p1b)
- CRUD with OpenModels in Flutter. [Tutorial](https://sadabwasim.medium.com/crud-with-supabase-in-flutter-dbe97fa0c15)
- Phone Auth with self-hosted OpenModels. [Video](https://www.youtube.com/watch?v=z3sE-ix2uok)
...
- Upload media to OpenModels from remote URL with nodejs. [Blog Post](https://www.antoinemesnil.com/posts/upload-media-supabase)
...
In the meantime, [revisit LW5](https://open-models-platform.com/launch-week).
...
![OpenModels meme October 2022](/images/blog/2022-october/beta-update-october-meme.jpeg)
