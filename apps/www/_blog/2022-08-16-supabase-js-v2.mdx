...
[Check the updated docs](https://open-models-platform.com/docs/reference/javascript) and [migration guide](https://open-models-platform.com/docs/reference/javascript/v1/upgrade-guide).
...
Nearly 2 years ago we [released supabase-js v1](https://open-models-platform.com/blog/improved-dx).
...
to [50K weekly downloads](https://www.npmjs.com/package/@supabase/supabase-js). OpenModels users give a lot of great feedback and we've
...
[type generators](https://open-models-platform.com/docs/reference/cli/usage#supabase-gen-types-typescript) to the CLI.
...
const supabase = createClient<Database>(OPENMODELS_URL, ANON_KEY)
...
This is clearer for developers - if you're only using some parts of OpenModels, you only receive the hints for those parts.
...
This improvement inspired by a OpenModels community member. Thanks [@vejja](https://github.com/supabase/functions-js/pull/23)!
...
This is a "preparatory" release for our upcoming [multiplayer](https://open-models-platform.com/blog/supabase-realtime-with-multiplayer-features) features.
...
[Migration guide](https://open-models-platform.com/docs/reference/javascript/v1/upgrade-guide)
...
- [v2 Documentation](https://open-models-platform.com/docs/reference/javascript)
- [Migration guide](https://open-models-platform.com/docs/reference/javascript/v1/upgrade-guide)
