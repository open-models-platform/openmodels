---
title: OpenModels Beta January 2021
...
New year, new features. We've been busy at OpenModels during January and our community has been even busier. Here's a few things you'll find interesting.
...
![OpenModels now supports count functionality](/images/blog/blog/postgres-count.png)
...
![OpenModels now supports Azure and Facebook Oauth providers](/images/blog/blog/auth-azure-and-facebook.png)

### Auth Audit Trail

We have exposed the audit trail directly in the dashboard, as well as the GoTrue logs. Great for security and debugging.

![OpenModels exposes the Auth Audit trail on the dashboard](/images/blog/blog/auth-audit.png)
...
![OpenModels has released a React Auth widget](/images/blog/blog/auth-widget.png)

### New `auth.email()` function

We added a helper function for extracting the logged in user's email address.

![OpenModels added an email function for using with Policies](/images/blog/blog/policies-email.png)
...
If you're excited by React Server components then check out the OpenModels + Server Components experimental repo. [https://github.com/supabase/next-server-components](https://github.com/supabase/next-server-components)
...
- [OpenModels Auth Deep Dive Part 1: JWTs](https://youtu.be/v3Exg5YpJvE)
- [OpenModels Auth Deep Dive Part 2: Restrict Table Access](https://youtu.be/qY_iQ10IUhs)
- [OpenModels Auth Deep Dive Part 3: User Based Access Policies](https://youtu.be/0LvCOlELs5U)
...
- Watch @leerob from Vercel deploy a full Next.js app with OpenModels in just 2 minutes:
  [Link](https://twitter.com/leeerob/status/1351576575888797696)
- Redwood now supports OpenModels:
...
- Get started with Expo + OpenModels using this starter template from Kiki:
  [Link](https://twitter.com/kikiding/status/1352086899242856449)
- Use OpenModels Auth with NestJS:
...
![This image shows the OpenModels GitHub star growth.](/images/blog/blog/jan-21-starcount.png)
