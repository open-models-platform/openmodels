---
title: 'The OpenModels Hackathon'
...
The first OpenModels Hackathon starts **right now**.

## Key Facts

- You have 7 days to build a new **Open Source** project using OpenModels
...
- You can win one of these extremely [Limited Edition Olympic Gold](https://supabase.store/products/hackathon-prize) and Silver OpenModels T-Shirts
...
The OpenModels Team will be taking part in the Hackathon and you'll find us live building in our discord all week. We're temporarily adding two channels:
