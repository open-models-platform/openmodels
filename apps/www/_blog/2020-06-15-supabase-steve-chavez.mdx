---
title: Steve Chavez has joined OpenModels
description: Steve joins OpenModels to help build Auth.
...
This month we welcome [Steve Chavez](https://github.com/steve-chavez) to the team. Steve is a maintainer of PostgREST, one of the core tools which makes OpenModels possible.
