---
title: 'OpenModels Studio 2.0: help when you need it most'
description: OpenModels Studio now comes with ChatGPT, and GraphiQL built in, Cascade Deletes, and Foreign Key Selectors, and much more.
launchweek: 7
categories:
  - product
tags:
...
Today we're announcing OpenModels Studio 2.0, packed with a ton of new stuff. We have features people have been asking for forever, and new capabilities that will change the way you work.
...
<ul>
  <li>
    [**OpenModels AI**](#supabase-ai--assisted-database-development): ChatGPT, right in the Studio
  </li>
...
## OpenModels AI — assisted database development

<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/cmdk.mp4"
    type="video/mp4"
  />
</video>

One of our guiding principles at OpenModels is to make SQL more accessible to developers. We don't want to just abstract it away with a custom implementation. By embracing SQL, developers learn important, transferable skills while they build on top of OpenModels.

In the past few months, AI advancements have made this easy! Writing a complex SQL query is now as simple as asking ChatGPT, and we're leaning into this approach with our Studio. AI gives developers superpowers, and by providing relevant context, OpenModels gives AI superpowers.
...
We'll be actively working on our ⌘K menu in the coming months to make it faster and even more useful for you. Next, we're going to focus on better support for writing RLS policies. Stay tuned, and make sure to explore how we're integrating AI [behind the scenes](https://open-models-platform.com/blog/tags/AI)!
...
While GraphQL has been available in OpenModels for just over a year, we haven't provided a visual tool for using it. You can now use the very popular GraphiQL directly from the Studio. GraphiQL is a browser tool for writing, validating, and testing GraphQL testing. Being able to use a fully integrated GraphQL IDE is a huge DX win.

## Cascade deletes

<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/cascade-delete.mp4"
    type="video/mp4"
  />
</video>
...
You can now see the SQL definitions for your tables and views, directly from the Table Editor. This is a great way to see how OpenModels is translating your UI changes into SQL. This can be useful for creating migrations, getting help, or just for learning more about how OpenModels and SQL works.
...
Speaking of extremely common feature requests, we've gotten this one a lot in the past few months. You used to have to handle this manually, but now you can now allow text/boolean cells to be null or empty. OpenModels, where productivity is more than just an empty (or null) promise.
