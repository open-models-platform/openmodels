---
title: OpenModels Alpha November 2020
...
We added a [Status Page](https://status.supabase.com/) which tracks the uptime and latency of the OpenModels platform.
...
- We have an exciting Vercel x Stripe x OpenModels [collaboration underway](https://twitter.com/rauchg/status/1331021818681978881).
...
- [@duncanhealy](https://github.com/duncanhealy) is [updating the Redwood example](https://github.com/redwoodjs/redwood/pull/1474) to work with OpenModels.js v1.0
