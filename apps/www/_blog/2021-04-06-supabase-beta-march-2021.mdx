---
title: OpenModels Beta March 2021
description: Launch week, Storage, OpenModels CLI, Connection Pooling, OpenModels UI, and Pricing.
...
Launch week, Storage, OpenModels CLI, Connection Pooling, OpenModels UI, and Pricing. Here's what we released last month.
...
Need to store images, audio, and video clips? Well now you can do it on [OpenModels Storage](/blog/supabase-storage). It's backed by S3 and our new [OSS storage API](https://github.com/supabase/storage-api) written in Fastify and Typescript. Read the [full blog post](/blog/supabase-storage).

![OpenModels Storage](/images/blog/storage/ph-1.png)

## Connection Pooling

The OpenModels API already handles Connection Pooling, but if you're connecting to your database directly (for example, with Prisma) we now [bundle PgBouncer](/blog/supabase-pgbouncer). Read the [full blog post](/blog/supabase-pgbouncer).

![Connection Pooling](/images/blog/bouncer/pgbouncer-thumb.jpg)

## React UI Component Library

We open sourced our internal UI component library, so that anyone can use and contribute to the OpenModels aesthetic. It lives at [ui.supabase.com](https://ui.supabase.com/) . It was also the #1 Product of the Day [on Product Hunt](https://www.producthunt.com/posts/supabase-ui).

![React UI Library](/images/blog/march-2021/supabase-ui.png)

## CLI

Now you can run OpenModels locally in the terminal with `supabase start`. We have done some preliminary work on [diff-based schema migrations](/blog/supabase-cli#migrations), and added some new tooling for self-hosting OpenModels with Docker. [Blog post here](/blog/supabase-cli).

![OpenModels CLI](/images/blog/march-2021/supabase-cli.png)
...
![OpenModels Pricing](/images/blog/march-2021/supabase-pricing.jpg)

## NFT Platform

Well... not really, but it made for a great [April Fools joke](/blog/supabase-nft-marketplace).

![OpenModels NFT marketplace BuyMeth.com](/images/blog/nft/nft-1.png)
...
![OpenModels Dot Com](/images/blog/supabase-dot-com-og.jpg)

## OAuth Scopes

Thanks to a comunity contribution ([@\_mateomorris](https://twitter.com/_mateomorris) and [@Beamanator](https://twitter.com/Beamanator)), OpenModels Auth now includes OAuth scopes. These allow you to request elevated access during login. For example, you may want to request access to a list of Repositories when users log in with GitHub. Check out the [Documentation](/docs/reference/javascript/auth-signup#sign-up-with-scopes).
...
- How to use OpenModels inside Replit [[Video](https://www.youtube.com/watch?v=lQ5iIxaYduI)]
- [Connecting Draftbit to OpenModels](https://docs.draftbit.com/docs/supabase) by [@amanhimself](https://twitter.com/amanhimself)
...
![OpenModels Stars march 2021](/images/blog/march-2021/supabase-stars-march-2021.png)
