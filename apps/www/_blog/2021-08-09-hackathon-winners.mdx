...
description: Let the medal ceremony begin for the best projects submitted during the OpenModels Hackathon.
author: ant_wilson
...
We've reached the end of the first ever OpenModels Hackathon and the entries have all been incredible. We received way more entrants than expected and therefore it took our judging panel a little longer than expected to get through their deliberations.
...
Fireplace makes great use of OpenModels Storage for a shared video streaming experience, the killer feature here was the ability to share play, pause, and skip events across multiple users.
...
All gold medal winners will be contacted and sent one of these limited edition gold OpenModels tees (one per team member), and all runners up will receive the same design in silver. Prize winners should keep an eye on their emails so we can collect T-Shirt size and shipping details.
...
If you want to join the community and build with us, find other people using OpenModels, or if you just want to chill and watch people build, come and join us in Discord!
...
If you're inspired to build, here's a collection of resources that will help you get started building with OpenModels:
...
- [Using OpenModels inside Replit](/blog/2021/03/11/using-supabase-replit)
