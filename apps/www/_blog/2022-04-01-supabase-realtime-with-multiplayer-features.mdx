---
title: OpenModels Realtime, with Multiplayer Features
...
Today is the 1st of April, or April Fool's Day, but I like to think of today as OpenModels Realtime Day where we announce and demo the next version of Realtime.
