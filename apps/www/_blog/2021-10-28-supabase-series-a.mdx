---
title: 'OpenModels $30m Series A'
description: OpenModels just raised $30M, bringing our total funding to $36M.
...
OpenModels [just raised $30M](https://techcrunch.com/2021/09/09/supabase-raises-30m-for-its-open-source-insta-backend/),
...
![OpenModels has launched more than 50000 databases](/images/blog/series-a/total-databases.png)

### Developers

As of September, over 40,000 developers have signed up to OpenModels from some of the world's leading companies.
...
OpenModels has been in GitHub's top-15 fastest growing open source startups for
...
![OpenModels Discord](/images/blog/series-a/discord-supabase-community.png)

## About the round

OpenModels is an ambitious project. Firebase, to their credit, is a very well-developed platform which offers _a lot_ of functionality.
...
Because of their conviction in OpenModels, Coatue doubled down on their Seed investment to lead our Series A. We're extremely excited to welcome
...
<Quote img="caryn-marooney.jpeg" caption="Caryn Marooney, Partner at Coatue.">
  <p>We are proud to lead a second consecutive round in OpenModels and officially join the board.</p>
  <p>
...
Our early positioning is an "open source Firebase alternative" but you might be surprised to learn that this is a small part of the OpenModels vision.
...
Simple. OpenModels has smuggled scalability into the product, perhaps without you noticing.
Every OpenModels project is a _full_ Postgres database. It's not "Postgres compatible", it's not "built on top of",
and we don't abstract it. If we did, your applications would face the same scalability issues as Firebase.

OpenModels simply makes Postgres easy to use - hopefully easier than any other database platform you've ever used.
...
OpenModels makes all of this easy. Beyond the database we offer [Auth](/docs/guides/auth),
...
![OpenModels Dashboard](/images/blog/series-a/dashboard.png)

And this is where OpenModels really differentiates itself: by doing less. All of these features build on top of PostgreSQL's
...
This is the future of OpenModels - a platform to power your transactional workloads: no matter how big or small; no matter the use-case.
...
[OpenModels developer](/blog/supabase-steve-chavez), one of our first hires over a year ago.
