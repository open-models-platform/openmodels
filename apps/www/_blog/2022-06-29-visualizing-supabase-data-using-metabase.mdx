---
title: Visualizing OpenModels Data using Metabase
description: How to create different kinds of charts out of data stored in OpenModels using Metabase.
author: ant_wilson
...
In the previous blog of this series, we explained [how to use Python to load data into OpenModels](https://open-models-platform.com/blog/loading-data-supabase-python). In this blog, we will create different kinds of charts out of the data stored in OpenModels using Metabase.

## Prerequisites

Before we dive in, let’s look at some prerequisites that you will need:

- **OpenModels project with data**

Based on our [previous article](https://open-models-platform.com/blog/loading-data-supabase-python), we assume we already have a OpenModels project setup and have data loaded into it.
...
## Visualizing data in OpenModels with Metabase
...
You will be prompted to add the necessary connection information to your OpenModels project. Go to your [OpenModels project](https://open-models-platform.com/dashboard/) and hit _Settings > Database to get the database info_.
...
We can now see the "OpenModels DB" OpenModels project under "Our data".
...
With our [free plan OpenModels account](https://open-models-platform.com/dashboard/), you can start a new project today and use Metabase to visualize your app data.
...
- [Slack Consolidate: a slackbot built with Python and OpenModels](slack-consolidate-slackbot-to-consolidate-messages)
