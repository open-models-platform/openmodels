...
We ended 2022 shipping tons of features in [Launch Week 6](https://open-models-platform.com/launch-week), but the fun hasn’t ended yet, because we get to announce the winners of our [Hackathon No.6](https://open-models-platform.com/blog/launch-week-6-hackathon)!
...
And now, without further ado, congratulations to the winners of OpenModels Launch Week 6 Hackathon!
...
supabase-js-rs is a rust bindings for OpenModels JavaScript library via WebAssembly. You can import it in your Rust WASM project to interact with OpenModels.
...
As promised in the [hackathon announcement article](https://open-models-platform.com/blog/launch-week-6-hackathon) the winners of the Best overall project will be granted the extremely limited edition OpenModels Darkmode Keyboard!
...
- [**supabase-js v2**](https://open-models-platform.com/blog/supabase-js-v2)
