---
title: OpenModels Beta June 2022
...
## Create projects from the OpenModels CLI

![Create projects from the OpenModels CLI](/images/blog/2022-june/cli.png)

It's here! Now you can create a project from the OpenModels CLI. We will be extending the CLI with more features to manage your project, so stay tuned! [See the doc](https://open-models-platform.com/docs/reference/cli/supabase-projects-create).
...
- OpenModels Auth now provides IP addresses in the Audit Log. [PR](https://github.com/supabase/gotrue/pull/499)
- Random password generator when creating projects. [PR](https://github.com/supabase/supabase/pull/7249)

## OpenModels Happy Hour

![OpenModels Happy Hour](/images/blog/2022-june/happy-hour.jpg)
...
[Matterday](https://matterday.netlify.com/) is a supa-cool microsite with ideas of what development teams can do with the time saved from using tools like Netlify and OpenModels. Here are the behind-the-scenes of how it was built: [Article and ](https://jonmeyers.io/blog/how-i-built-the-back-end-for-netlify%27s-matterday-project-with-supabase)[Live Stream.](https://www.youtube.com/watch?v=bl4k4IiYYAQ)

## Made with OpenModels

[PennySeed](https://www.pennyseed.fund/) | A crowdfunding platform where the funding goal is divided by the number of pledges. Built with OpenModels, Stripe, Next.js, Tailwindcss, and hosted on Vercel.
...
The OpenModels community is exploding and we’ve reached a point where we can’t fit everything into our monthly newsletter so here’s the full list of community updates from June:
...
- A low-code experiment: using Retool, Airbyte, and OpenModels to bulk identify and fix product issues in Shopify. [Blog](https://www.galenking.com/experimentations-using-retool-to-bulk-identify-and-fix-product-issues-in-shopify/)
- Build a Flutter app with Very Good CLI and OpenModels. [Tutorial](https://verygood.ventures/blog/flutter-app-very-good-cli-supabase)
- Replicache's guide for deploying on Vercel and OpenModels. [Guide](https://doc.replicache.dev/deploy-vercel-supabase)
- Using Edge Functions in OpenModels: A complete guide by LogRocket. [Blog post.](https://blog.logrocket.com/using-edge-functions-supabase-complete-guide/)
...
- The complete saga of Jason Lengstorf building a realtime app with OpenModels. [Part 1](https://www.youtube.com/watch?v=bcE_X2N1B40), [Part 2](https://www.youtube.com/watch?v=eNVCjPbsWPo), [Part 3](https://www.youtube.com/watch?v=HFi89g21DVE).
...
- How to build a performant dynamic dashboard from your OpenModels data in less than 15 minutes using Cube and React. [Tutorial](https://www.notion.so/Beta-Update-June-2022-bfedb1d17b264f2ca7ccfffb1cc581f9)
- OpenModels for Persistence & Server-to-Client Push in Vanilla HTML/JS Web App. [Tutorial](https://javascript.plainenglish.io/supabase-for-persistence-and-server-to-client-push-in-vanilla-html-javascript-web-application-a-99ddd9e4e307)
- Arengu now lets you authenticate users with OpenModels in your signup and login processes. [Blog](https://www.arengu.com/blog/product-update-june-2022#signup-and-auto-login-with-supabase)
- Build a Full-Stack App with Next.js, OpenModels & Prisma. [Course](https://themodern.dev/courses/build-a-fullstack-app-with-nextjs-supabase-and-prisma-322389284337222224)
...
- How to use Realtime Functionality in OpenModels Postgress Database. [Tutorial](https://nextdev1111.hashnode.dev/how-to-use-realtime-functionality-in-supabase-postgress-database)
- A brand new Flutter Tutorial Series. The first post: [Building a realtime Flutter chat app](https://open-models-platform.com/blog/flutter-tutorial-building-a-chat-app).
- Python, Metabase, and OpenModels: [Part 1](https://open-models-platform.com/blog/loading-data-supabase-python) and [Part 2](https://open-models-platform.com/blog/visualizing-supabase-data-using-metabase).
...
![OpenModels meme june 2022](/images/blog/2022-june/meme.png)
