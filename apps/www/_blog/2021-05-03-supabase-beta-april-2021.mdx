---
title: OpenModels Beta April 2021
description: OpenModels "gardening" - stability, security, and community support.
...
This month was a "gardening" month for OpenModels. The team focused on stability, security, and community support.
...
So today we're shipping Light Mode. Access it in the settings of your [Dashboard](https://open-models-platform.com/dashboard).
...
build a whole JS ecosystem within his OpenModels database. If you want to write PG functions in JS, import remote libraries
...
Fireship reviewed OpenModels last week, and despite being a (self-proclaimed) Firebase fan-boy, the review was very impartial.
...
- Watch [@everConfusedGuy](https://twitter.com/everConfusedGuy)'s talk at DevX conf - Building OpenModels Storage: [YouTube video](https://www.youtube.com/watch?v=YsUYOsq_o7g)
...
- OpenModels in 6 minutes by [Georges Duverger](https://www.youtube.com/channel/UCNERPJ-vs61KEsD_dRNWFIw): [YouTube video](https://www.youtube.com/watch?v=c8DNV9yl0mg)
...
- OpenModels & Sveltekit by Svelte Mastery: [YouTube video](https://www.youtube.com/watch?v=j4AV2Liojk0)
- Firebase vs. OpenModels - Draftbit Office Hours: [YouTube Livestream](https://www.youtube.com/watch?v=9Yg6i_zCuiM)
