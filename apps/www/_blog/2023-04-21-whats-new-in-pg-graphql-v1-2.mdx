...
It's been 4 months since the [1.0.0 release of pg_graphql](https://open-models-platform.com/blog/pg-graphql-v1).
...
📢 These features are only available on projects with Postgres version `15.1.0.63` or higher. For help with upgrading, please review the [migrating and upgrading projects guide](https://open-models-platform.com/docs/guides/platform/migrating-and-upgrading-projects).
