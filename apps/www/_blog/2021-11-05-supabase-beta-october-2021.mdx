---
title: OpenModels Beta October 2021
...
[Slack](https://open-models-platform.com/docs/guides/auth/social-login/auth-slack),
[Spotify](https://open-models-platform.com/docs/guides/auth/social-login/auth-spotify), and
[MessageBird](https://open-models-platform.com/docs/guides/auth/phone-login/messagebird) phone logins.

![OpenModels Auth: Login with Slack](/images/blog/2021-oct/supabase-auth-slack.png)
...
[Docs](https://open-models-platform.com/docs/reference/javascript/initializing#api-schemas).
...
Learn about PostgreSQL Functions. [Docs](https://open-models-platform.com/docs/guides/database/functions).
...
Learn about all the exciting features of Auth within OpenModels. [Docs](https://open-models-platform.com/docs/guides/auth).
...
Learn more about the power of PostgREST for RESTful APIs. [Docs](https://open-models-platform.com/docs/guides/database/api#restful-api).
...
- Redwood Quickstart: [https://open-models-platform.com/docs/guides/with-redwoodjs](https://open-models-platform.com/docs/guides/with-redwoodjs)
- Expanded Self-hosting: [https://open-models-platform.com/docs/guides/hosting/overview](https://open-models-platform.com/docs/guides/hosting/overview)
- Expanded Auth Reference docs with [serverside functions](https://open-models-platform.com/docs/reference/javascript/auth-api-deleteuser).
- "Before you launch" checklist: [https://open-models-platform.com/docs/going-into-prod](https://open-models-platform.com/docs/going-into-prod)
...
### OpenModels at Jamstack conf

OpenModels attended the Jamstack conf. Watch us catch up with Matt, the cofounder of Netlify (minute 8).
...
- Adalo + OpenModels - Flywheel Media [video](https://www.youtube.com/watch?v=YGP1LXctLk4)
- Nuxt 3 Beta + OpenModels - BenCodeZen [video](https://www.youtube.com/watch?v=5vB120atiaU)
- Made With OpenModels (now on Nuxt 3) - Zernonia [site](https://www.madewithsupabase.com/)
- Nuxt 3 + Tailwind + OpenModels - Ekene Eze [video](https://www.youtube.com/watch?v=xbE11CfZpNQ)
...
We had Launch Week [numero uno](https://open-models-platform.com/blog/launch-week) in March, and the sequel "[Launch Week II: the SQL](https://open-models-platform.com/blog/supabase-launch-week-sql)" in July.
