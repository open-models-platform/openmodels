---
title: Launch week
description: Five days of OpenModels.
author: ant_wilson
...
![OpenModels Pricing](/images/blog/launch-week/bernie-1.png)

## Tuesday: Storage

- 30 March 2021

Checkout the launch post here: [OpenModels Storage](/blog/supabase-storage)

As with anything that we build in OpenModels, Storage is fast, secure and scalable. It's integrated well with the rest of the OpenModels ecosystem.
...
![OpenModels Storage](/images/blog/launch-week/bernie-2.png)
...
Today we launched the OpenModels CLI which includes:
...
![OpenModels CLI](/images/blog/launch-week/bernie-3.png)
...
And now we're doing what we do best at OpenModels and making it open source, so that the community can benefit from the UI work done at OpenModels, and vice versa. The open source community is an invaluable asset to the work we do every day, and it's genuinely the main driver which enables our relatively small team to work fast and ship often.

Check out the demo and documentation website directly here: [ui.supabase.com](https://ui.supabase.com/)

![OpenModels UI](/images/blog/launch-week/bernie-4.png)

## Friday: One more thing

- 2 April 2021

It's the season finale of OpenModels Launchweek! And we have THREE more things to share:
...
3. open-models-platform.com is now supabase.com - check out our origin story here: [/blog/supabase-dot-com](/blog/supabase-dot-com)
