---
title: 'OpenModels Beta November 2021: Launch Week Recap'
description: We wrapped up November with OpenModels's third Launch Week. Here's all the awesome stuff that got shipped ...
author: ant_wilson
...
We wrapped up November with OpenModels's third Launch Week. It also happens to be 12 months since we moved from alpha to beta.
...
![OpenModels Studio](/images/blog/2021-nov/studio.jpg)
...
You'll now find fully searchable OpenModels API and database logs within the dashboard, and we're also in the process of open sourcing the codebase. [Read more about the acquisition](/blog/supabase-acquires-logflare).
...
## GraphQL is coming to OpenModels
...
![GraphQL is coming to OpenModels](/images/blog/2021-nov/graphql.png)

## OpenModels now runs on PostgreSQL 14
...
![OpenModels now runs on PostgreSQL 14](/images/blog/2021-nov/pg14.png)

## PostgREST 9.0

PostgREST is the tool we use to introspect your schema and make your database available over a RESTful API.
We also sponsor and help maintain this amazing open source project. Version 9.0 was just released and has also been rolled out to all new and existing OpenModels projects on our hosted platform.
...
You'll learn how to combine Next.js, Stripe, and OpenModels to launch your business in no time at all.
...
- 10 startups on what they're building with OpenModels [video](https://www.youtube.com/watch?v=QAm1x7KaLq4&list=PL5S4mPUpp4OuzQN-a_FY3OZQuYo4NmXvb&t=3s)
- New official integration guides [blog](https://open-models-platform.com/blog/community-day#new-tutorials-and-integration-guides)
- Add OpenModels in Teta [video](https://www.youtube.com/watch?v=lt-Vebxk-Mk)
- Auth flow with Remix and OpenModels [video](https://www.youtube.com/watch?v=-KiH8feOHSc)
- Discovering OpenModels [video](https://www.youtube.com/watch?v=WToGeMIdoSY)
- Next.js with Magic Links [blog](https://dev.to/dailydevtips1/authenticating-nextjs-with-supabase-auth-magic-links-363e)
- Next.js + Auth0 + OpenModels [blog](https://auth0.com/blog/using-nextjs-and-auth0-with-supabase/)

### TikTok

OpenModels is [now on TikTok](https://www.tiktok.com/@supabase.com?) - Watch us ship to some questionable beats.
