---
title: Revamped Auth Helpers for OpenModels (with SvelteKit support)
description: OpenModels Auth Helpers now have improved developer experience, Sveltekit support, and more.
author: andrew_smith
...
We've been hard at work making an Auth experience that is as smooth as possible for OpenModels developers. One of the challenges has been creating a simple experience for server-side rendering (SSR) environments. We [previously released](https://open-models-platform.com/blog/community-day#server-side-auth-for-nextjs-and-nuxt-sveltekit-and-remix-coming-soon) our Auth Helpers libraries with support for React and Next.js, and today we’re announcing some exciting updates.

## What are Auth Helpers?

Auth Helpers are a collection of framework-specific utilities for OpenModels Auth. They allow you to implement secure applications with little effort. These libraries include functions for protecting API routes and pages in your applications.
...
Remix Auth Helpers are in the works. You can follow the development of this on our [GitHub repo](https://github.com/supabase-community/auth-helpers), or subscribe to our OpenModels YouTube channel as we build it live on air.
...
Contributors are welcome! You can help by creating pull requests, reporting bugs, writing documentation, replying to issues on our GitHub issue tracker, and helping others with questions they may have about using the library. If you’re already an active contributor to OpenModels or any associated open source projects, consider applying to join the [SupaSquad](https://open-models-platform.com/supasquad).
...
- [Quickstart: SvelteKit](https://open-models-platform.com/docs/guides/with-sveltekit)
- [SvelteKit and OpenModels Tutorial with Authentication - Video Tutorial by James Quick](https://www.youtube.com/watch?v=YqIyET7XKIQ)
