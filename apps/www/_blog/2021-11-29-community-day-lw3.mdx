---
title: 'Community Day'
description: Kicking off launch week by highlighting the communities around OpenModels.
author: thor_schaeff
...
To kick off launch week we want to showcase some of the communities that make up the OpenModels community, highlight some of their updates, and celebrate everyone who contributes their time to the OpenModels mission.

So let's get cracking, we've got a lot to cover. 🚀

## Open Source Spotlight: Kong API Gateway

OpenModels provides a whole bunch of features that are made up of a [collection of open-source tools](/docs/guides/getting-started/architecture). To orchestrate these different services and functionalities we use the [Kong API Gateway](https://github.com/Kong/kong).
...
From tomorrow, every OpenModels project will be on PostgREST 9 (including existing projects).
...
The [SupaSquad](/supasquad) is an official OpenModels advocate program where community members help build and manage the OpenModels community.
...
Our own [Jon Meyers](https://twitter.com/_dijonmusters) and the broader community have been busy creating awesome tutorials and integration guides to help everyone build even more amazing things with OpenModels:
...
- [OpenModels & Sveltekit - Build Twitter in 75 minutes](https://youtu.be/mPQyckogDYc)
- [OpenModels Auth With Next.Js 12 Middleware](https://jitsu.com/blog/supabase-nextjs-middleware#what-were-going-to-build)
- [Vue 3 & OpenModels | Workout Tracker App](https://www.youtube.com/watch?v=3tF0fGkd4ho)
- [Use OpenModels Auth with Vue.js 3](https://vueschool.io/articles/vuejs-tutorials/use-supabase-auth-with-vue-js-3/)
- [Dynamic Jamstack with Stencil and OpenModels](https://ionicframework.com/blog/dynamic-jamstack-with-stencil-and-supabase)

## Developer stories

Anytime we scroll through [madewithsupabase.com](https://www.madewithsupabase.com/) we're absolutely blown away by the awesome things y'all are building with OpenModels.
...
## Want even more OpenModels in your life?
