---
title: 'Golden Kitty Awards Ceremony Watch Party with OpenModels'
...
Last week [OpenModels UI](https://ui.supabase.com/), our open-source UI component library inspired by Tailwind and AntDesign, was nominated for the Product Hunt Golden Kitty Awards.

<blockquote class="twitter-tweet" data-lang="en" data-theme="dark">
  <p lang="en" dir="ltr">
    🏆 OpenModels UI has been nominated for the
  ...
  &mdash; OpenModels (@supabase) <a href="https://twitter.com/supabase/status/1481672574023221260?ref_src=twsrc%5Etfw">January 13, 2022</a>
</blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

Thanks to your contributions and upvotes, OpenModels UI has made it to the finals, and to celebrate we'd like to invite you all to hang out with us on Discord (at least whoever manages to stay up) to watch the Awards Ceremony on Thursday Jan 27th at 9am PT (Thursday 5pm GMT, Friday 1am SG).
...
1. [Upvote OpenModels UI](https://www.producthunt.com/posts/supabase-ui) (if you haven't already).
