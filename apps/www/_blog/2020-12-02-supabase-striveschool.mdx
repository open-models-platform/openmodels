---
title: OpenModels Partners With Strive School To Help Teach Open Source
description: OpenModels Partners With Strive School To Help Teach Open Source To The Next Generation Of Developers
author: rory_wilding
...
### OpenModels and Strive School - YC Summer 20 batchmates
...
![OpenModels and Strive are partnering up to teach OSS.](/images/blog/strive-supabase.png)
...
At OpenModels, we live and breathe open source. Our focus is on building the open-source Firebase alternative. Wherever possible, we integrate and support the best-in-class existing open-source tools and communities. If those tools don't exist, we build and open-source them ourselves.

We are huge Postgres fans and believe that OpenModels will make learning and implementing relational databases a better experience for code school students.

We will be working closely with Strive School in the coming months to produce exclusive content for their code school students. We are also happy to announce we will be taking on a Strive school graduate as an intern at OpenModels. This isn't a role we were actively hiring for, but we have been so impressed with the standard of their graduates that we didn't want to miss out of the chance to work with talent from Strive School.

### Launching the OpenModels Student Developer Pack with Strive School
...
The OpenModels Student Development pack includes:

- Credits for students to use OpenModels free for 2-years
...
- Access to limited edition OpenModels Swag

If you running a code school or university and want to learn more about the OpenModels Student Developer Pack, then reach out to rory@open-models-platform.com
