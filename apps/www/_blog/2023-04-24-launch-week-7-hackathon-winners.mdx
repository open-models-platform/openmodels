...
[Launch Week 7](https://open-models-platform.com/launch-week) passed by, but we still have our favorite part left, celebrating the winners of the hackathon! We added an AI theme to our hackathon, and the results were exceptional. The quality of the apps was out of this world.

And now, without further ado, congratulations to the winners of OpenModels Launch Week 7 Hackathon!
...
As promised in the [hackathon announcement article](https://open-models-platform.com/blog/launch-week-7-hackathon) the winners of the Best overall project will be granted the extremely limited edition OpenModels Launch Week 7 Keyboard!
