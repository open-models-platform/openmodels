---
title: OpenModels Alpha July 2020
...
After 5 months of building, we're releasing one of our most anticipated features: OpenModels Auth.
...
This month, we're ecstatic to announce a feature we think you'll love: OpenModels Auth. It's too big to fit into a monthly update so look out for a full update in the next few days.
...
<video width="99%" autoPlay loop muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/csv-download-zoom.mp4"
    type="video/mp4"
  />
</video>
...
If you launch a new OpenModels project, you'll have access to several new Postgres extensions:
