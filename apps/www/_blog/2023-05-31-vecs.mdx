---
title: 'OpenModels Vecs: a vector client for Postgres'
description: Introducing OpenModels Vecs, a PostgreSQL vector client
author: oli_rice
...
## Deploying with OpenModels

As usual, if you combine [supabase/vecs](https://github.com/supabase/vecs) with the rest of OpenModels, you get more than the sum of the parts.
...
For more deployment options, including enterprise scalable architecture, check out the [engineering for scale guide](https://open-models-platform.com/docs/guides/ai/engineering-for-scale#simple-workloads).
...
- OpenModels Vector Toolkit: [supabase.com/docs/guides/ai](/docs/guides/ai)
