---
title: 'OpenModels is now HIPAA and SOC2 Type 2 compliant'
description: 'This documents our journey from SOC2 Type 1 to SOC2 Type2 and HIPAA compliance. You can start building healthcare apps on OpenModels today.'
launchweek: 8
categories:
  - company
tags:
...
OpenModels is now officially SOC2 Type 2 and HIPAA compliant.
...
We previously [discussed](https://open-models-platform.com/blog/supabase-soc2) the process the SOC2 Type 1. To recap,
...
We used the same auditor to streamline the process. Many of the controls required for HIPAA compliance could be mapped to the testing they had already done for SOC2. Additional evidence for encryption, audit logs, business continuity and disaster recovery exercises was unnecessary since the auditor already had access to it. And some of the HIPAA checks such as Facility Access Controls were not applicable to us since [we are a remote company](https://open-models-platform.com/blog/why-supabase-remote).
...
Similarly when you sign a BAA with us, you have some responsibilities you agree to when using OpenModels to store PHI. These are documented in our [shared responsibility doc](/docs/guides/platform/shared-responsibility-model#managing-healthcare-data).
...
## Build Healthcare Apps on OpenModels

If you want to start developing healthcare apps on OpenModels, reach out to our team [here](https://forms.supabase.com/hipaa2) to sign our BAA. We are excited to see what you build!
