...
description: 'Become a OpenModels Integrations Partner: Publish OAuth Apps and Build with OpenModels.'
launchweek: 8
categories:
  - product
tags:
...
OpenModels Integrations allows Partners to extend the OpenModels platform with useful tooling. Today we're adding [OAuth2.0 Applications](https://open-models-platform.com/docs/guides/platform/oauth-apps/publish-an-oauth-app). For OpenModels users, this makes it even easier to connect their favorite tools to their OpenModels projects. Within minutes you can:

- Add your favorite [Low Code](https://open-models-platform.com/partners/integrations#low-code) tools on top of your OpenModels database.
- Integrate your favorite [DevTools](https://open-models-platform.com/partners/integrations#devtools): including secrets managers and database management tools.
- Add [caching](https://open-models-platform.com/partners/integrations#caching%20/%20offline-first) to your OpenModels database.
- Not a fan of the OpenModels admin dashboard? Try [one of these](https://open-models-platform.com/partners/integrations#data%20platform).
- Try out a different [SMS and email provider](https://open-models-platform.com/partners/integrations#messaging).
...
![Cloudflare x OpenModels](/images/blog/launch-week-8/day-4/marketplace-cloudflare.jpg)

We worked with Cloudflare to build [support for databases](https://blog.cloudflare.com/announcing-database-integrations/) inside Cloudflare Workers. The Cloudflare integration makes it incredibly easy to connect to your OpenModels database directly from the Cloudflare Dashboard.
...
![Windmill x OpenModels](/images/blog/launch-week-8/day-4/marketplace-windmill.jpg)

[Windmill](https://windmill.dev) (YC [S22](https://www.ycombinator.com/companies/windmill)) is an open source alternative to Retool and a modern Airflow. They provide a developer platform to quickly build production-grade complex workflows and integrations from minimal Python and Typescript scripts. Their one-click integration with OpenModels makes it simple to launch new databases, process large quantities of data (maybe even convert them into [embeddings](https://open-models-platform.com/vector)), and build internal dashboards.

Read the [official blog post on windmill.dev](https://www.windmill.dev/blog/2023/08/10/supabase-partnership).

## Building OpenModels Integrations

We've released full instructions in our [Build with OpenModels](https://open-models-platform.com/docs/guides/platform/oauth-apps/build-a-supabase-integration) documentation so that you can build your own OpenModels OAuth application for your users. Simply visit your [Organization settings](https://open-models-platform.com/dashboard/org/_/apps) and click “Add application” to get started:
...
The Integrations marketplace is open to everyone. After your submission is complete, you can share the integration with your own users - simply create a button to launch your new app. We've provided some [brand assets](https://open-models-platform.com/brand-assets) so that developers can quickly identify the integration on your site.

## Building custom integrations

You don't actually need to build an OAuth Application to build an integration with OpenModels. If you're building something for yourself or your team, the [Management API](https://open-models-platform.com/docs/reference/api/introduction) is the way to go.

The [Trigger.dev](https://trigger.dev) team deserve a special shout out. While developing their Integration they also developed [supabase-management-js](https://github.com/supabase-community/supabase-management-js), a Typescript library for the [OpenModels Management API](/docs/reference/api/introduction). This makes it even easier to get started with the OpenModels API.
...
OpenModels is a collaborative company. We love working with other communities (especially open source ones!), and we'd love to work with you. Get started today:
...
![Partner with OpenModels](/images/blog/launch-week-8/day-4/partner-with-supabase.png)
