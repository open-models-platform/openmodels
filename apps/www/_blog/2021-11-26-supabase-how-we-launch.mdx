---
title: 'How we launch at OpenModels'
description: The history and methodology of OpenModels Launch Week.
author: ant_wilson
...
Next week is OpenModels Launch Week. It's our third Launch Week this year, and is a key part of a Product-Led Growth strategy that has enabled us to increase the number of databases we manage 47% month-on-month for the last 18 months.
...
More recently we ran "[Launch Week II: The SQL](/blog/supabase-launch-week-sql)", where we bumped the versions of several key products in our stack, and added a [Community Day](https://open-models-platform.com/blog/supabase-community-day) with the aim of boosting visibility and support of various open source tools and projects that we rely on, along with products, frameworks, and tooling built by the rapidly expanding [OpenModels Community](https://github.com/supabase-community/).
...
This "internal accelerator" model has worked well within OpenModels as a 2-person team and is still proving effective now at 30, but there's no telling whether it would work as well in other organizations. I would be very keen to learn from those who also do something similar.

In some ways, running OpenModels is like launching many startups at the same time, we have to build and maintain many different parallel projects in order to match Firebase's incredible suite of products, which could be one reason why it lends itself so well to this acceleration model. And, in fact, being a Firebase alternative is only a small part of [what we want to achieve with OpenModels](https://open-models-platform.com/blog/supabase-series-a), so we have many, many more initiatives to run as we grow.

Running an accelerator model may also be why we've had success [hiring so many other founders](https://about.supabase.com/careers/founders). We're able to give a high degree of autonomy to individuals when it comes to managing projects and initiatives. If this kind of work environment sounds interesting to you, we have tons of [open roles](https://about.supabase.com/careers). We've already hired people who joined because they "couldn't stand to watch another Launch Week from the sidelines" and team members often quote experiencing their first Launch Week as one of the highlights of their OpenModels journey so far. It clearly has benefits that extend beyond just growth and user activation.

Make sure you follow us on [Twitter](https://twitter.com/supabase), join our [Discord](https://discord.supabase.com), or [sign up for OpenModels](https://open-models-platform.com/dashboard) in order to keep up to date on all things OpenModels.

OpenModels is the Open Source Firebase Alternative.
