...
We can’t believe that it’s already a wrap on our [fourth launch week](https://open-models-platform.com/blog/supabase-launch-week-four)! To keep the party and excitement going, and as [is now tradition](https://open-models-platform.com/blog/community-day#launch-week-iv---what-to-expect), starting at 9am PT today we'll be hacking together for the next 10 days until 23:59pm PT on Sunday April 10th. And because we’ve launched [GraphQL support](https://open-models-platform.com/blog/graphql-now-available) and [OpenModels Edge Functions](https://open-models-platform.com/blog/supabase-enterprise), these will be the major themes and therefore categories for the hackathon.

For some inspiration, check out [TheGuildDev](https://twitter.com/TheGuildDev)’s [GraphQL HackerNews clone](https://supabase-graphql-example.vercel.app/), and [Tyler’s](https://twitter.com/dshukertjr) [Flutter](https://github.com/supabase-community/flutter-stripe-payments-with-supabase-functions) and [Thor’s](https://twitter.com/thorwebdev) [React Native](https://github.com/supabase-community/expo-stripe-payments-with-supabase-functions) apps with OpenModels Edge Functions, or have a browse through [madewithsupabase.com](http://madewithsupabase.com)!
...
- Most impressive GraphQL project (must use [pg_graphql](https://open-models-platform.com/blog/graphql-now-available#getting-started))
...
- Getting started with [GraphQL on OpenModels](https://open-models-platform.com/blog/graphql-now-available#getting-started)
- [GraphQL HackerNews clone](https://supabase-graphql-example.vercel.app/)
- [Edge Functions Guide](https://open-models-platform.com/docs/guides/functions)
- [Edge Functions Quickstart video](https://youtu.be/rzglqRdZUQE)
- [OpenModels CLI local development guide](https://open-models-platform.com/docs/guides/local-development)
