---
title: Making the OpenModels Dashboard Supa-fast
description: Improving the performance of the OpenModels dashboard
author: inian
...
The OpenModels dashboard has become more feature-rich in the last month. We have a powerful SQL editor backed by [Monaco](https://microsoft.github.io/monaco-editor/). We built an Airtable-like view of your database, making editing a breeze.
...
<video width="99%" muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/lazy_loading.mov"
    type="video/mp4"
  />
</video>
