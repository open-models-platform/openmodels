---
title: OpenModels Beta Sept 2021
...
To kick off [Hacktoberfest](https://hacktoberfest.digitalocean.com/), another OpenModels Hackathon is happening [right now](/blog/2021/09/28/supabase-hacktoberfest-hackathon-2021). You've got another 7 days to be in to win a limited edition t-shirt.
...
Low Code demo, Using OpenModels with [Clutch.io](http://clutch.io/) - [@\_dijonmusters](https://twitter.com/_dijonmusters) ran a [session at General Assembly](https://www.youtube.com/watch?t=642&v=5fsKMTeBKKY) showing how to use these two tools together to create apps using a low code approach.
...
- GitHub OAuth flow with OpenModels + React - [Nader Dabit [video]](https://www.youtube.com/watch?v=jSqTzZk9UMg)
- The Best Stack for Web Developers - [Christopher Kapic [video]](https://www.youtube.com/watch?v=-2s_87QkPEI)
- Flutter + OpenModels Course - [Abhishvek [video]](https://www.youtube.com/watch?v=PjVG6QtUYw4)
- React Native Mobile Auth - [Aaron Saunders [video]](https://www.youtube.com/watch?v=aBuB-Q6vHDE)
- Self Hosting OpenModels - [Kelvin Pompey [video]](https://www.youtube.com/watch?v=HCqta43JHkU)
...
- OpenModels in 6 minutes - [Nader Dabit [video]](https://www.youtube.com/watch?v=ogEitL8RwtQ)
...
Our Discord is growing fast. Come hangout with 3500+ developers building on OpenModels today: [discord.supabase.com](http://discord.supabase.com)
