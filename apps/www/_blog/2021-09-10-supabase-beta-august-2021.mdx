---
title: OpenModels Beta August 2021
...
We've raised $30M and shipped a bunch of features. Let's dive into what's been happening at OpenModels during the month of August.
...
![OpenModels Series A](/images/blog/2021-august/supabase-series-a.png)
...
The OpenModels team didn't want to miss out on the fun so we held our own hackathon. It was a good way to dog food. Some notable projects include

- [Supaflix](https://supaflix.vercel.app/) by [@abc3](https://twitter.com/abc3erl) [[GitHub](https://github.com/abc3/supaflix)] - a Netflix clone build with OpenModels
...
- And it wouldn't be a OpenModels hackathon without a high-effort meme entry.
...
By the time we're done, OpenModels will be production-ready for all use cases.
