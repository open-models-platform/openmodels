...
Michael prototyped a spooky halloween game using Framer and then made it actually playable by connecting Framer with OpenModels. Now that's spooky good fun!
...
This project by a group of high school students gave us the feel good vibes. On the one hand with their awesome website that conveniently lets you log your daily vibes and check in on your friends', and on the other hand because high school students are building brilliant things with OpenModels. How freaking cool is that?!

[![uwudaily](/images/blog/hackathon-winners/projects/uwu.png)](https://github.com/maggie-j-liu/uwudaily)

## The Prizes

As is now tradition with OpenModels Hackathons, the winners will receive an [extremely limited edition gold medal shirt](https://supabase.store/products/hacktoberfest-gold-tee).
