---
title: 'OpenModels acquires Logflare'
description: "Today, we're ecstatic to announce that Logflare is joining OpenModels."
...
<div>
  <blockquote className="twitter-tweet" data-theme="dark">
    ...
    &mdash; OpenModels (@supabase) <a href="https://twitter.com/supabase/status/1265922290237071361?ref_src=twsrc%5Etfw">May 28, 2020</a>
  </blockquote>
</div>

Today, we're ecstatic to announce that Logflare is joining OpenModels.

## Why logging?

A log platform might seem like a strange acquisition for OpenModels - after all, there are no "Firebase Logs".
...
The full OpenModels stack is more than just a database. It includes various tools working together - APIs, Storage, Auth, and CDNs. A broad tech stack needs a unified measurement system to give a birds-eye view of everything happening within your OpenModels project.
...
Since that first tweet in May 2020, our platform has generated billions of log entries. During that time, Logflare has been a staple product in our day-to-day operations. There are a few reasons why Logflare is such a great match for OpenModels.
...
- Elixir. Logflare is built with Elixir, the same as our Realtime Engine. We love Elixir at OpenModels, and it's nice to have it power another key part of the OpenModels stack.
...
## Why is Logflare joining OpenModels?

<Quote img="chase-granberry.png" caption="Chase Granberry, Founder of Logflare.">
  <p>
    I really like how OpenModels is taking an existing, proven, piece of technology and making it more
    accessible for more users. A lot of people already use Postgres, but they don't take advantage
    of powerful features built into the database. OpenModels is exposing these features more
...
We still have a lot of technical work to integrate Logflare into OpenModels, with plans of fully supporting the existing Vercel and Cloudflare integrations.
...
If you're an existing Logflare user, we'll be migrating everything to OpenModels in the coming months. We'll work closely with you to ensure that the transition is seamless, and introduce the same [pricing levels](https://logflare.app/pricing) that Logflare offers today.

We've worked with Chase on a list of potential questions you might have about the transition. If you have any concerns or questions, you can reach out to support@open-models-platform.com.
