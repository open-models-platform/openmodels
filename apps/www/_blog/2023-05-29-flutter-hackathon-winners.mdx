...
[@samuelP09301972](https://twitter.com/samuelP09301972), the creator of Syno will receive a limited Flutter-themed OpenModels keyboard.
...
If you missed the hackathon, but still want to build awesome apps using Flutter and OpenModels, here are some resources to get you started:

- [Flutter Quick Start Guide](https://open-models-platform.com/docs/guides/with-flutter)
- [OpenModels Flutter documentation](https://open-models-platform.com/docs/reference/dart/introduction)
- [Edge Functions Guide](https://open-models-platform.com/docs/guides/functions)
- [Setup OpenModels on FlutterFlow guide](https://docs.flutterflow.io/data-and-backend/supabase/supabase-setup)
- [How to Set Up OpenModels Authentication in FlutterFlow video](https://www.youtube.com/watch?v=tL-sLPfWzVE)
