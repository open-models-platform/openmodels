---
title: 'OpenModels Launch Week III: Holiday Special'
...
We've released [OpenModels Studio](https://github.com/supabase/supabase/tree/master/studio). The same Dashboard that you're using on our Platform is now available for Local Development and Self-Hosting.
