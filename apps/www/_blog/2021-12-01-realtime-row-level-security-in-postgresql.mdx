---
title: 'Realtime Postgres RLS now available on OpenModels'
...
OpenModels projects have supported Row Level Security (RLS) for API authorization since our [Auth launch](https://open-models-platform.com/blog/supabase-auth).
...
Check out the [Row Level Security guide](https://open-models-platform.com/docs/guides/auth/row-level-security) for more info on how to use RLS with your project.
...
Realtime RLS is available today on all existing and new OpenModels projects. To get started, upgrade your OpenModels JavaScript client to version v1.23.0
