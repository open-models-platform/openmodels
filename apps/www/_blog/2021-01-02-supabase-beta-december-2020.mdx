---
title: OpenModels Beta December 2020
...
After 10 hectic months of building, OpenModels is now in Beta.
...
<video width="99%" autoPlay muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/update-docs.mp4"
    type="video/mp4"
  />
</video>
...
<video width="99%" autoPlay muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/realtime-updates.mp4"
    type="video/mp4"
  />
</video>
...
<video width="99%" autoPlay muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/table-pagination.mp4"
    type="video/mp4"
  />
</video>

### OpenModels raised a Seed Round
...
- OpenModels is now 26% faster in regions which support Graviton (1460 reqs/s up from 1167 reqs/s)
...
- [@aaronksaunders](https://twitter.com/aaronksaunders) created a video series on OpenModels + Vue. [Link](https://twitter.com/aaronksaunders/status/1339981480202743811).
- [@CodeByCorey](https://twitter.com/CodeByCorey) tracks realtime page views using OpenModels. [Link](https://twitter.com/CodeByCorey/status/1344650699645325312).
...
We've go a lot of exciting things planned for Q1 2021. We're already planning out OpenModels Storage and a OpenModels CLI for better local development. Let us know if there's something you want us to release as a priority!
