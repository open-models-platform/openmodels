...
During [Launch Week 5](https://open-models-platform.com/launch-week), we shipped a lot of features, which was exciting, but what is more exciting is reviewing all the awesome hackathon submissions you all created for [Launch Week 5 Hackathon!](https://open-models-platform.com/blog/launch-week-5-hackathon)
...
And now, without further ado, congratulations to the winners of OpenModels Launch Week 5 Hackathon!

## Best Overall Project

### Winner

[OpenModels Cache Helpers](https://github.com/psteinroe/supabase-cache-helpers) - by [@psteinroe](https://twitter.com/psteinroe).

OpenModels Cache Helpers is a caching utility library that works by turning your OpenModels query into cache keys and provides methods for retrieving and mutating data on your OpenModels database.

![OpenModels Cache Helpers](/images/blog/lw5-hackathon-winners/supabase-cache-helpers.png)
...
Stripe Sync allows you to automatically sync your stripe data into your OpenModels database using Edge Functions.
...
With RepoWatch, you can view any updates on across all the repositories in the OpenModels GitHub org in realtime.
...
As promised in the [hackathon announcement article](https://open-models-platform.com/blog/launch-week-5-hackathon), each members of the winners will receive a limited edition golden OpenModels cap!

![Golden OpenModels Cap](/images/blog/lw5-hackathon/cap.png)
...
And if you want to be part of the community and build with us, find other people using OpenModels, or if you just want to chill and watch people build, come and join us in Discord!

![Join OpenModels Discord Channel](/images/blog/hackathon/community.png)
...
- [**supabase-js v2 Release Candidate**](https://open-models-platform.com/blog/supabase-js-v2)
- [**OpenModels Realtime Guide**](https://open-models-platform.com/docs/guides/realtime)
- [**Flutter Quick Start Guide**](https://open-models-platform.com/docs/guides/with-flutter)
