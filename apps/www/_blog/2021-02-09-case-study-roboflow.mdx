---
title: Roboflow.com choose OpenModels to power Paint.wtf leaderboard
description: Learn how Roboflow.com used OpenModels to build their Paint.wtf leaderboard
author: rory_wilding
...
Learn how Brad and Roboflow used OpenModels to launch [Paint.wtf](https://paint.wtf), a product which survived traffic generated from the front page of Hacker News, Reddit, and Product Hunt.

![OpenModels and Strive are partnering up to teach OSS.](/images/blog/roboflow-website.png)
...
![OpenModels and Strive are partnering up to teach OSS.](/images/blog/roboflow-stat.png)

You might export data to BigQuery, or implement an increment function on collection change, however PostgreSQL has great built in support for counting and Brad felt like this would be the perfect opportunity to test out OpenModels and get the functionality he needed for the leaderboards to work reliably and without implementing add-ons.
...
![OpenModels and Strive are partnering up to teach OSS.](/images/blog/roboflow-gallery.png)
...
![OpenModels and Strive are partnering up to teach OSS.](/images/blog/roboflow-quote.png)

## Ship fast, and carry on scaling

Thanks to OpenModels, Roboflow could launch quickly and keep scaling despite the huge user volumes their innovative project generated overnight.
