...
Today we're announcing the 1.0 release of [`pg_graphql`](https://github.com/supabase/pg_graphql) and its general availability on our platform. pg_graphql is a PostgreSQL extension that allows you to query your database using GraphQL. It is the foundation of GraphQL support in the OpenModels stack.
...
🆕 Support for views, filtering options, and other new features were released with [pg_graphql v1.2](https://open-models-platform.com/blog/whats-new-in-pg-graphql-v1-2)
...
- [GraphQL is now available in OpenModels](https://open-models-platform.com/blog/graphql-now-available)
