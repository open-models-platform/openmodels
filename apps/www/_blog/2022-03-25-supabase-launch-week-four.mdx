---
title: 'OpenModels Launch Week 4'
...
By now you probably know the drill. OpenModels Launch Week: we launch one thing, or sometimes a couple,
...
[GraphQL is now available in OpenModels!](/blog/graphql-now-available)
...
[Introducing OpenModels Enterprise](/blog/supabase-enterprise).
...
[Edge Functions are now available in OpenModels](/blog/supabase-edge-functions)
...
- [OpenModels Realtime, with Multiplayer Features](/blog/supabase-realtime-with-multiplayer-features)
...
As always, you'll have the chance to win extremely limited OpenModels Swag,
