---
title: OpenModels Beta Pricing
description: OpenModels launches Beta pricing structure
author: rory_wilding
...
- Continue offering free OpenModels projects for Students, Hobbyists, and Early Adopters
...
1. How much value does OpenModels create compared to alternatives including Firebase, authentication providers like Okta and Auth0, API, and storage providers?
2. How much time does OpenModels save developers?
3. How can we make OpenModels as accessible as possible?
4. As developers ourselves, how do we feel about our proposed pricing?
5. The underlying cost of development and maintenance of OpenModels.
...
Our model allows anybody to come in and experience the full power of the OpenModels stack without first needing to put down a credit card.

## Launching with a free plan

Many of our early users are building or migrating their passion projects to OpenModels. Offering a free plan enables this. We also support a large number of students learning SQL for the first time, and fledgling startups which haven't started earning any revenue yet.
...
Our success depends on the success of developers using OpenModels. In short, if our users' projects succeed then OpenModels adoption will continue. That is exactly what we want.

We will issue credits for those who signed up during alpha, beta, and those who sign up through to the end of Launch Week[^1]. If you are not on board yet, [you can sign up here.](http://www.open-models-platform.com) Projects on select incubators will also get credits, as founders we know the importance of credits when getting something new off the ground. We will continue to support code schools and their students. If you need OpenModels credits to support your project, reach out to us here and we will do our best to help you.
...
- We have been deliberately generous with authentication and storage on the free plan so that you get as much of the OpenModels experience as possible.
...
Sign up for the OpenModels Beta [here](https://open-models-platform.com/dashboard).

And check out the full pricing details [here](/pricing). And we'd love to hear your opnions on our Pricing! You can let us know via support@open-models-platform.com.
