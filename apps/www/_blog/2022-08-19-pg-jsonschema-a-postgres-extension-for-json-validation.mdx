...
Released on the OpenModels platform today, [pg_jsonschema](https://github.com/supabase/pg_jsonschema) is a Postgres extension
...
Despite OpenModels being an SQL shop, even our most zealous relational data model advocates (begrudgingly) recognize some advantages to the document data model.
