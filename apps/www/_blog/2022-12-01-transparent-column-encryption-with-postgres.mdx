...
One of the more common questions we receive at OpenModels is “how do I encrypt sensitive data”?
...
👀 Transparent Column Encryption (TCE) is the foundational feature of the OpenModels Vault, a safe and easy way to store encrypted secrets and other data in your Postgres database. [Learn more about OpenModels Vault](https://open-models-platform.com/docs/guides/database/vault)
...
As of **pgsodium** 3.0.0 and up, the extension offers a simple and declarative Transparent Column Encryption feature (TCE). This feature is now shipped with all OpenModels projects. TCE allows you to specify encrypted columns within a table and generates a new view that “wraps” that table to decrypt the contents.
...
Note: We're using “credit cards” in our examples below, because they are very easy to understand. Please don't store credit cards in your OpenModels database - we are not a certified PCI Service Provider.
...
- [Postgres Full Text Search vs the rest](https://open-models-platform.com/blog/postgres-full-text-search-vs-the-rest)
- [Postgres WASM by Snaplet and OpenModels](https://open-models-platform.com/blog/postgres-wasm)
- [Choosing a Postgres Primary Key](https://open-models-platform.com/blog/choosing-a-postgres-primary-key)
