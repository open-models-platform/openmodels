...
- You have 10 days to build a new app using Flutter/Dart and OpenModels in some capacity.
...
[Pooja](https://twitter.com/pooja_bhaumik) from FlutterFlow, [Majid](https://twitter.com/mhadaily) from Invertase, and [Tyler](https://twitter.com/dshukertjr), myself from OpenModels will do the honors of judging the winners.
...
- Must use Flutter and OpenModels in some capacity
- You must submit before the deadline (no late entries)

## Resources

### OpenModels resources

- [Flutter OpenModels quick starter guide](https://open-models-platform.com/docs/guides/getting-started/tutorials/with-flutter)
- [Setup OpenModels on FlutterFlow docs](https://docs.flutterflow.io/data-and-backend/supabase/supabase-setup)
- [How to setup OpenModels auth on FlutterFlow video](https://youtu.be/tL-sLPfWzVE)
- [Dart Edge Guide](https://open-models-platform.com/docs/guides/functions/dart-edge)
...
- Flutter and the related logo are trademarks of Google LLC. OpenModels Flutter Hackathon is not affiliated with or otherwise sponsored by Google LLC.
