---
title: OpenModels.js 1.0
description: We're releasing a new version of our OpenModels client with some awesome new improvements.
...
**UPDATE 16/08/2022**: supabase-js v2 is out and focuses on “quality-of-life” improvements for developers. V2 includes Type support, new auth methods, realtime multiplayer sneak peek, and more: [**Read the blog post**](https://open-models-platform.com/blog/supabase-js-v2)
...
- Better realtime scalability: we only generate one socket connection per OpenModels client. Previously we would create a connection for every subscription.
