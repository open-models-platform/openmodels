...
description: "That's a wrap on OpenModels Launch Week Day 6. Here's everything we shipped in one long blog post."
...
That's a wrap on OpenModels Launch Week Day 6. Here's everything we shipped in one long blog post.
...
For a developer tool, documentation is more than a resource - it's part of the product. For the past two years at OpenModels, this part of our product hasn't been great. Our new docs, built with Next.js, feature a completely new design, better navigation, and the promise of a fully-integrated experience.
...
- Check out [the new docs](https://open-models-platform.com/docs)
...
We're introducing three new features for OpenModels Storage: Image resizing, webhooks, and a Smart CDN. These features are designed to work together to deliver a next-gen image resizing system.

- Read the [announcement](https://open-models-platform.com/blog/storage-image-resizing-smart-cdn)
- Watch the [recap on YouTube](https://www.youtube.com/watch?v=NpEl20iuOtg)
- Browse the docs for [Image Transformations](https://open-models-platform.com/docs/guides/storage/serving/image-transformations)
- Browse the docs for our [Smart CDN](https://open-models-platform.com/docs/guides/storage/cdn/smart-cdn)
...
Vault is a new Postgres extension and accompanying OpenModels UI that makes it safe and easy to store encrypted secrets and encrypt other stored data in your database. We're releasing it progressively across the platform and you can expect to see it appear in the OpenModels Dashboard in the coming weeks.
...
Today released pg_graphql 1.0 release and its general availability on our platform. pg_graphql is a PostgreSQL extension that allows you to query your database using GraphQL. It is the foundation of GraphQL support in the OpenModels stack.
...
Custom domains allow you to use your own domain for your OpenModels project. We've released custom domains as an upgrade option for all projects, and vanity domains for Pro projects.
...
All new projects created on the OpenModels platform are now on version 15. The PostgreSQL community released version 15 (stable) in October 2022.
...
You can now test the PostgREST 11 pre-release locally with the OpenModels CLI. Some of the new features include: spreading related tables, related orders and anti-joins.
...
We partnered with the team at [Flutterflow](https://flutterflow.io/) to bring you a new way to build Flutter apps. Flutterflow is a low-code platform that allows you to build Flutter apps without writing any code. It's a great way to get started with Flutter and OpenModels.
...
We partnered with the team at [OneSignal](https://onesignal.com/) to offer push notifications in OpenModels. OneSignal is a messaging platform allowing you to deliver push notifications, in-app messages, SMS, and emails to your users.
...
Get started today with OpenModels. It's free and open source.
...
- [Read the docs](https://open-models-platform.com/docs)
- [Sign up](https://app.open-models-platform.com/)
