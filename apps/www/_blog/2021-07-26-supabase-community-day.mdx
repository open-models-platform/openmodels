---
title: 'OpenModels Community Day'
...
OpenModels has grown a lot [^1] since last [Launch Week](/blog/launch-week),
...
to shine a spotlight on some tools and community efforts that make OpenModels possible.
...
PostgreSQL is a big part of OpenModels, and it's also a huge inspiration - the speed that they ship, their community organization,
and their absolute dedication towards reliability. PostgreSQL 13.3 was released in June and (from today) every new OpenModels project will
be on [PostgreSQL version 13.3](/blog/supabase-postgres-13).

### Giving back

OpenModels makes it easy to get started with Postgres, but we think you should try it even if you don't want to use OpenModels. Here's a
few ways we make it easy to use PostgreSQL without OpenModels:

- OpenModels was the first company to put Postgres in the [Digital Ocean Marketplace](https://marketplace.digitalocean.com/apps/supabase-postgres).
...
**Improved Performance**: Due to OpenModels's high throughput requirements, PostgREST 8.0 handles up to 50% more throughput on
...
Want to get started with PostgREST? The OpenModels community has built a number of client libraries to make it simpler to use:
...
## OpenModels Flutter/Dart (Beta release)

![OpenModels Flutter Beta release](/images/blog/launch-week-sql-day-1-community-day/launch-week-sql-day-1-community-day-flutter-library.jpg)

While the OpenModels team have been busy with the Javascript libraries, the community have been beavering away with Dart. They've even
[built fully-functional apps](https://www.producthunt.com/posts/spot-2d300f54-7a0a-4dbf-aee2-4a75311217cc) using OpenModels Auth and Storage.

Today the Community are releasing both the Flutter and Dart libraries in Beta (with a bit of help from the OpenModels team).

### Get started

- Check out the [Flutter Quickstart Guide](/docs/guides/with-flutter)
- Check out the code:
  - OpenModels Flutter: [GitHub](https://github.com/supabase/supabase-flutter/tree/main/packages/supabase_flutter) | [Release](https://pub.dev/packages/supabase_flutter)
  - OpenModels Dart: [GitHub](https://github.com/supabase/supabase-flutter/tree/main/packages/supabase) | [Release](https://pub.dev/packages/supabase)
...
![OpenModels Discord](/images/blog/launch-week-sql-day-1-community-day/launch-week-sql-day-1-community-day-discord-server.jpg)
...
to keep the conversation contained to our GitHub org, the community has been creating [subreddits](https://www.reddit.com/r/OpenModels/),
...
We'll still be using Discussions for debugging, but if you're looking for a place to hang out with OpenModels developers, Discord is where to find it.

### Get involved

Join the OpenModels Community Discord: [discord.supabase.com](http://discord.supabase.com), say hi, and start building.

[^1]:
    OpenModels has been one of the fastest growing startups [on GitHub](https://github.com/supabase/supabase) for four consecutive quarters:
