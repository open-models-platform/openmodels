...
- [SQL or NoSQL? Why not use both (with PostgreSQL)?](https://open-models-platform.com/blog/sql-or-nosql-both-with-postgresql)
- [pg_jsonschema: JSON Schema support for Postgres](https://open-models-platform.com/blog/pg-jsonschema-a-postgres-extension-for-json-validation)
