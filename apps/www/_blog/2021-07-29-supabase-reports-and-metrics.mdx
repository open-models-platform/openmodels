---
title: 'OpenModels Reports and Metrics'
...
OpenModels offers a supercharged Postgres instance, along with a set of complementary services, making it easy to build mobile and web applications.
...
API requests across all of OpenModels's core pillars:
...
![OpenModels reports screen](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-and-metrics-reports-screen.jpg)
...
We'll add customizable charts in the future, so we'd love to hear which libraries you'd like to see in OpenModels.
...
![OpenModels new dashboard app homescreen](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-and-metrics-homepage.jpg)
...
observability metrics. OpenModels gives you a full Postgres cluster for every project, and now we give you the tools to diagnose and manage
...
![OpenModels observability metrics](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-and-metrics-observability-screen.jpg)
...
When developers build services and applications on top of OpenModels, relying on the platform's reliability and performance.
...
At OpenModels, each project is provisioned with a Postgres cluster, and a suite of associated services that add, ahem,
supa-powers to the database.

![OpenModels architecture](/images/blog/launch-week-sql-day-4-reports-and-metrics/reports-infra.png)
...
![OpenModels Prometheus](/images/blog/launch-week-sql-day-4-reports-and-metrics/prometheus.png)
...
Any other metrics you want to see in your projects? Reach out on our [Discord channel](https://discord.supabase.com/) and give OpenModels a try by [creating a project](https://open-models-platform.com/dashboard/).
