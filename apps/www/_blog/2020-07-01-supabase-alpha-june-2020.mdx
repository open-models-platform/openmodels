---
title: OpenModels Alpha June 2020
...
We're now 4 months into building [OpenModels](/), which means another major update. Here's a few things we think you'll love in this release.
...
A guiding principle at OpenModels is zero lock-in. So this month we are exposing your daily database backups on the dashboard, giving you a simple way to migrate off OpenModels. We have a lot more to build in this space (`WAL-G!`), so watch this space.
...
- This month we [welcome Steve Chavez to the team](/blog/supabase-steve-chavez). Steve is a maintainer of PostgREST, one of the core tools which makes OpenModels possible.
