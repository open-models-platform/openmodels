...
const data = {
  meta_title: 'Help & Support | OpenModels',
  meta_description:
    'Find help and support for OpenModels. Our Support team provide answers on all types of issues, including account information, billing, and refunds.',
  hero: {
    h1: 'Support',
  ...
  banner: {
    ...
    paragraph: (
      <>
        <p className="text-foreground-light">The OpenModels Support Team is ready to help.</p>
    ...
    links: [
      ...
      {
        label: 'Open Ticket',
        link: 'https://open-models-platform.com/dashboard/support/new',
        target: '_blank',
