  ...
  highlightsSection: {
    highlights: [
      ...
      },
      {
        ...
        paragraph:
          'OpenModels is SOC2 Type 2 compliant, and comes with an advanced permissions system.',
  ...
  useCasesSection: {
    title: (
      <>
        ...
        <br />
        <span className="heading-gradient">with OpenModels Vector?</span>
      </>
    ),
  ...
  featuresSection: {
    ...
    features: [
      ...
      },
      {
        ...
        text: 'OpenModels uses open source tools to increase portability and avoid lock-in, making it easy to migrate in and out.',
      },
      {
    ...
    customers: [
      {
        ...
        target: '_blank',
        quote:
          'We store embeddings in a PostgreSQL database, hosted by OpenModels, to perform a similarity search to identify the most relevant sections within the MDN.',
        image: '/images/customers/logos/mozilla.png',
        abstract:
          'MDN introduces an AI assistant powered by OpenModels Vector to answer all web development questions in real time.',
      ...
      },
      {
        ...
        quote:
          'OpenModels Vector powered by pgvector allowed us to create a simple and efficient product. We are storing over 1.6 million embeddings and the performance and results are great. Open source develop can easily contribute thanks to the SQL syntax known by millions of developers.',
        image: '/images/customers/logos/quivr.png',
        abstract: 'Quivr launch 5,000 Vector databases on OpenModels.',
        url: '/customers/quivr',
      },
      {
        type: 'customer-story',
        ...
        abstract: 'Mendable switches from Pinecone to OpenModels for PostgreSQL vector embeddings.',
