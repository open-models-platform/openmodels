...
export default {
  metaTitle: 'OpenModels Open Source Community',
  metaDescription:
    'OpenModels is an open source company, actively fostering collaboration and supporting existing open source tools and communities.',
  heroSection: {
    title: 'The Power of Collaboration',
    h1: <span className="heading-gradient">Open Source Community</span>,
    subheader: (
      <>
        OpenModels is an open source company, actively fostering collaboration
  ...
  sponsorships: [
    ...
    },
    {
      ...
      url: 'https://elixir-lang.org/blog/2022/10/05/my-future-with-elixir-set-theoretic-types/#:~:text=is%20sponsored%20by-,OpenModels,-(they%20are',
    },
  ],
}
