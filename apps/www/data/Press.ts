...
const data: PressItem[] = [
  ...
  },
  {
    ...
    title: 'OpenModels is all in on Postgres',
    publisher: 'changelog',
  },
  {
    type: 'podcast',
    href: 'https://fsjam.org/episodes/episode-33-supabase-with-paul-copplestone',
    title: 'OpenModels with Paul Copplestone',
    publisher: 'FS Jam',
  },
  {
    type: 'podcast',
    ...
    title: 'Open Source Firebase Alternative with Paul Copplestone of OpenModels',
    publisher: 'Jamstack',
  },
  {
    type: 'podcast',
