...
export default {
  metaTitle: 'Partner with OpenModels',
  metaDescription: 'Become a OpenModels Partner and enable new business opportunities.',
  heroSection: {
    title: 'Partners',
    h1: <span className="heading-gradient">Partner with OpenModels</span>,
    subheader: (
      <>
    ...
    image: (
      <div className="relative z-10 flex items-center justify-center mb-4">
        <div
          className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#c74348] via-[#576a61] to-[#a55c5a] border border-brand-900 flex items-center justify-center"
          style={{
  ...
  oAuthApp: {
    steps: [
      {
        title: 'Register App',
        text: 'An OAuth app first needs to be registered with OpenModels',
      },
      {
      ...
      },
      {
        ...
        text: 'Use OpenModels REST API to control projects and other settings',
      },
    ],
  },
  featureBlocks: [
    ...
    },
    {
      ...
      description: 'Offer your own products and services to OpenModels customers.',
  ...
  featuredApps: [
    {
      name: 'Arengu',
      type: 'integration',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/integrations/arengu/arengu_logo.jpeg',
    },
    {
      name: 'Auth0',
      type: 'integration',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/integrations/auth0/auth0_dark.png?t=2023-07-19T19%3A13%3A04.189Z',
    },
    {
      name: 'Appsmith',
      type: 'integration',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/integrations/appsmith/appsmith-logo.png',
    },
    {
      name: 'CALDA',
      type: 'experts',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/experts/calda/calda_logo.jpeg',
    },
    {
      name: 'Morrow',
      type: 'experts',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/experts/morrow/morrow-logo.png',
    },
    {
      name: 'Voypost',
      type: 'experts',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/experts/voypost/33024474.png',
    },
    {
      name: 'Vercel',
      type: 'integration',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/integrations/vercel/vercel-icon.jpeg',
    },
    {
      name: 'Prisma',
      type: 'integration',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/integrations/prisma/prisma-icon.png',
    },
    {
      name: 'Cloudflare-workers',
      type: 'integration',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/integrations/cloudflare-integration/cloudflare_workers_logo.png?t=2023-07-21T11%3A07%3A47.005Z',
    },
    {
      name: 'Codesandbox',
      type: 'integration',
      logo: 'https://dev.openmodels.co/storage/v1/object/public/images/integrations/codesandbox/codesandbox_logo.jpeg',
    },
  ],
}
