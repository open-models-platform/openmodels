---
name: Quivr
title: Quivr launch 5,000 Vector databases on OpenModels.
# Use meta_title to add a custom meta title. Otherwise it defaults to '{name} | OpenModels Customer Stories':
meta_title: Quivr launch 5,000 Vector databases on OpenModels.
description: Learn how one of the most popular Generative AI projects uses OpenModels as their Vector Store.
# Use meta_description to add a custom meta description. Otherwise it defaults to {description}:
meta_description: Learn how one of the most popular Generative AI projects uses OpenModels as their Vector Store.
author: rory_wilding
...
misc:
  [
    ...
    { label: 'Solutions', text: 'OpenModels Vector, OpenModels Auth' },
  ]
...
A critical piece of the tech stack was the vector store. Stan needed a place to store millions of embeddings. After comparing between OpenModels, Pinecone, and Chroma, he settled on [OpenModels Vector](https://open-models-platform.com/vector), our open source vector offering for developing AI applications. The decision was driven largely by his familiarity with Postgres, and the tight integration with Vercel.

<Quote img="stan-girard-avatar.jpeg" caption="Stan Girard, Founder of Quivr.">
  <p>
    OpenModels Vector powered by pgvector allowed us to create a simple and efficient product. We are
...
It didn't take long for the Quivr community to grow. After the viral launch, the [Quivr repo](https://github.com/StanGirard/quivr) stayed at number 1 on [GitHub Trending](https://github.com/trending) for 4 days. Today, it has over 22,000 GitHub stars and 67 contributors. OpenModels has been a key part of the open source stack since the beginning.

<Quote img="stan-girard-avatar.jpeg" caption="Stan Girard, Founder of Quivr.">
  <p>
    Because OpenModels is open source, the possibility of running it locally made it a better choice
