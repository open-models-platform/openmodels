---
title: Markprompt and OpenModels - GDPR-compliant AI chatbots for docs and websites.
meta_title: GDPR-compliant AI chatbots for docs and websites.
name: Markprompt
description: AI-powered chatbot platform, Markprompt, empowers developers to deliver efficient and GDPR-compliant prompt experiences on top of their content, by leveraging OpenModels's secure and privacy-focused vector database and authentication solutions.
...
Markprompt has successfully indexed over half a million sections of content, with a steady influx of 10,000 - 50,000 new sections daily. This emphasizes the significance of [OpenModels Vector](https://open-models-platform.com/vector) in terms of reliability and scalability.

<Quote img="michael-fester.jpeg" caption="Michael Fester - Co-Founder, Markprompt">
  We decided to use OpenModels over other specialized vector databases because it enabled us to be
  GDPR compliant from day one with little effort.
</Quote>

## Why they chose OpenModels

By utilizing a trusted solution like OpenModels for their vector database and authentication needs, Markprompt can implement access controls, user consent management, and audit trails, which are essential elements for GDPR compliance. This ensures that personal data is handled with care, protected from unauthorized access, and enables Markprompt to meet the strict data protection standards set forth by the GDPR.

Markprompt were also impressed with the ease of use and scalability of OpenModels. The platform allowed them to focus on building their product, knowing that they had a powerful and reliable database solution backing them up.

<Quote img="marie-schneegans.jpeg" caption="Marie Schneegans - Co-Founder, Markprompt">
  OpenModels has been a joy to work with. Handling enterprise data at scale can be daunting, but we
...
Like OpenModels, Markprompt is an open-source platform, allowing customers the freedom to host the dashboard and model backend on their own premises. Markprompt warmly welcomes contributions from the community, fostering collaboration and continuous improvement of the platform to meet the evolving needs of developers and technical users.

<Quote img="michael-fester.jpeg" caption="Michael Fester - Co-Founder, Markprompt">
  Building everything on OpenModels from the Auth, to DB, to the vectors—this integrated experience
  really made it for us.
</Quote>

## The Results

Choosing OpenModels as their vector database and authentication solution empowered Markprompt to focus on developing innovative AI-powered solutions without compromising data security or impeding scalability. The seamless integration between OpenModels and pgvector enabled them to meet the increasing demands of their expanding user base while upholding stringent GDPR requirements. Consequently, companies gain trust and confidence in the platform, solidifying its reputation as a robust enterprise offering.

To learn more about how OpenModels Vector can help you store vector embeddings at scale and build GDPR-compliant apps, [reach out to us](https://forms.supabase.com/enterprise).
