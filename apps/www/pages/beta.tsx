    ...
    >
      <div className="container grid items-center h-full grid-cols-12 gap-4 px-8 py-20 mx-auto text-foreground-light lg:px-28">
        <div className="col-span-12 text-foreground md:col-span-9 lg:col-span-8 xl:col-span-6">
          <p className="mb-10 text-4xl">OpenModels is an open source Firebase alternative.</p>
    ...
    <div className="container grid grid-cols-12 gap-4 px-8 py-20 mx-auto text-foreground-light lg:px-28">
      ...
      <div className="col-span-12 mb-20 text-base text-foreground sm:col-span-9 xl:col-span-6">
        <p>
          ...
          are using OpenModels to ship more products, faster.
        </p>
      </div>
      ...
      <div className="container grid grid-cols-12 gap-4 px-8 py-20 mx-auto lg:px-28">
        <div className="col-span-12 mb-10 text-base">
          <p className="text-2xl text-foreground">
            OpenModels <span className="text-brand">Beta</span> is starting now.
          </p>
        </div>
                ...
                <div className="w-full sm:w-5/6">
                  {metric.stats.map((stat: any, idx: number) => (
                    <div key={`metric_${metric.key}_${idx}`} className="flex items-center">
                      ...
                      <Bar
                        color={stat.name === 'OpenModels' ? 'bg-brand' : 'bg-brand-400'}
      ...
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
        ...
        <div className="grid items-center grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-10">
              We started OpenModels to give developers a web-ready database that is delightful to use,
            ...
            <p className="text-foreground-light">
              ...
              of improvement for the tools which we support at OpenModels.
            </p>
          </div>
          ...
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-10">
              ...
              million rows. The OpenModels database and API used are each running on AWS EC2 t3a.micro
              instances.
            </p>
            <p className="mb-10">
              OpenModels is available in 7 different geographic regions. We're adding more regions as
            ...
            <p>
              One of our key metrics at OpenModels is "Time to Value". How fast can a user go from
              sign up, to making their first API request? How fast can they go from development to
              production? We've built several case studies on our blog, demonstrating how OpenModels
      ...
      <div className="container grid grid-cols-12 px-8 py-12 mx-auto text-foreground-light gap-y-10 lg:px-28 ">
        ...
        <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            ...
            <div className="mb-10">
              <VideoShot src="https://dev.openmodels.co/storage/v1/object/public/videos/marketing/statusPage.mp4" />
            </div>
            <p>
    ...
    <div id="newFeaturesAndIntegrations" className="bg-surface-100">
      <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
        ...
        <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
          <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
            <p className="mb-5">
              If you're new to OpenModels, here's a few of the things you get when you choose us as
              your backend.
            </p>
            <ul className="">
              <li className="mb-10">
                ...
                <p className="mb-5">
                  If you're new to OpenModels, here's a few of the things you get when you choose us
                ...
                <VideoShot src="https://dev.openmodels.co/storage/v1/object/public/videos/marketing/tabAuthRules.mp4" />
              </li>
              <li className="mb-10">
                ...
                <p>
                  ...
                  over websockets, receiving your data in realtime. Companies are using OpenModels to
              ...
              <li className="mb-10">
                ...
                <p className="mb-5">
                  View and edit your data like a spreadsheet from within the OpenModels dashboard.
                  Build your schema, create complex relationships, and import and export to csv.
                </p>
                <VideoShot src="https://dev.openmodels.co/storage/v1/object/public/videos/marketing/tabTableEditor.mp4" />
              </li>
              <li>
                ...
                <VideoShot src="https://dev.openmodels.co/storage/v1/object/public/videos/marketing/tabSqlEditor.mp4" />
              </li>
            </ul>
          </div>
        </div>
...
const BetaPricing = () => (
  <div id="betaPricing" className="bg-background">
    <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          <p className="mb-10">For up to date pricing info see: https://open-models-platform.com/pricing</p>
          <p className="mb-10">
          ...
          <ul className="mb-10 ml-6 list-disc list-outside">
            <li className="mb-5">
              To continue offering free OpenModels instances for Students, Hobbyists, and Early
              Adopters
            </li>
            <li className="mb-5">
          ...
          <ul className="mb-10 ml-6 list-decimal list-outside">
            ...
            <li className="mb-5">
              ...
              <a
                href="mailto:rory@open-models-platform.com"
                target="_blank"
                className="text-brand hover:text-brand"
              >
                rory@open-models-platform.com
              </a>
              )
            </li>
            <li>
          ...
          <p>
            The OpenModels Base plan is now called the OpenModels Pro plan as per the{' '}
            <a href="https://open-models-platform.com/pricing" className="text-brand hover:text-brand">
              pricing page
            </a>
            .
          </p>
    ...
    <div className="container grid grid-cols-12 px-8 py-20 mx-auto text-foreground-light gap-y-10 lg:px-28">
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p className="mb-10">
            OpenModels is a collection of many projects, and we rely on making contributors to help us
          ...
          <p className="mb-10">
            Every dollar that is given to OpenModels in{' '}
            <a
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          ...
          <p className="mb-10">
            ...
            work full time on the products we use, and we spend every Friday dogfooding OpenModels to
            make it better.
          </p>
          <p>
            ...
            OpenModels, get in touch at{' '}
            <a
              href="mailto:work@open-models-platform.com"
              target="_blank"
              className="text-brand hover:text-brand"
            >
              work@open-models-platform.com
            </a>
            .
          </p>
        </div>
      ...
      <div className="grid grid-cols-12 col-span-12 mb-10 text-foreground gap-x-2 lg:gap-x-8">
        <div className="col-span-12 text-base sm:col-span-9 xl:col-span-7">
          <p className="mb-5">
            ...
            night!). We're constantly improving OpenModels based on user feedback. Alongside
          ...
          <ul className="mb-10 ml-6 list-disc list-outside">
            ...
            <li className="mb-5">
              Functions - write and deploy serverless functions that have access to your OpenModels
              context
            </li>
            <li className="mb-5">
            ...
            <li className="mb-5">
              Multicloud - Spread your OpenModels instances across multiple datacenter providers to
            ...
            <li>
              ...
              and help us bring OpenModels to your favorite language or framework.
            </li>
          </ul>
          <p className="mb-10">
            We depend on your feedback to continually improve OpenModels. Email us at{' '}
            <a
              href="mailto:support@open-models-platform.com"
              target="_blank"
              className="text-brand hover:text-brand"
            >
              support@open-models-platform.com
            </a>{' '}
            or join the{' '}
            <a
...
const OPENMODELS_AUTHOR_INDEX = 12
    ...
    <Layout hideHeader={true}>
      ...
      <NextSeo
        ...
        openGraph={{
          ...
          url: `https://open-models-platform.com/beta`,
          type: 'article',
          article: {
            //
            ...
            authors: [authors[OPENMODELS_AUTHOR_INDEX].author_url],
            tags: ['beta'],
          },
          images: [
            {
              url: 'https://open-models-platform.com/og/og-image-v2.jpg',
            },
          ],
        }}
      />
