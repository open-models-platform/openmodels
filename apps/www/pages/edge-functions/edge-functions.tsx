...
const featureHighlights = [
  ...
  {
    title: 'Use anything from OpenModels',
    description:
      'supabase-js can interact with any part of the OpenModels stack from Edge Functions, while respecting auth row level security policies.',
  ...
  {
    title: 'No limits',
    description: `You're empowered to run any logic you like using any data from the OpenModels database.`,
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://open-models-platform.com/edge-functions`,
          images: [
            {
            ...
            <div className="grid items-center gap-6 lg:grid-cols-12 lg:gap-16">
              <div className="flex flex-col gap-8 lg:col-span-5">
                <div>
                  ...
                  <p className="p">
                    Asynchronous tasks within minutes using OpenModels Functions with simple
                    authenticated access to the rest of the OpenModels Ecosystem.
                  </p>
                </div>
...
serve(async (req) => {
  try {
    ...
    const customer = await stripe.customers.create({
      description: 'My First Stripe Customer (created by a OpenModels edge function)',
      phone: data.phone,
