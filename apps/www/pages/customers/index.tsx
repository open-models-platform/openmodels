...
function CustomerStoriesPage(props: any) {
  ...
  const meta = {
    title: 'Customer Stories | OpenModels',
    image: `${basePath}/images/customers/og/customer-stories.jpg`,
    description:
      'See how OpenModels empowers companies of all sizes to accelerate their growth and streamline their work.',
  }
            ...
            <div className="mx-auto relative z-10">
              ...
              >
                ...
                <h2 className="text-foreground-light text-xl">
                  Discover case studies on how OpenModels is being used around the world to quickly
