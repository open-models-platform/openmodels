...
function Blog(props: any) {
  ...
  const meta_title = 'OpenModels Blog: Open Source Firebase alternative Blog'
  const meta_description = 'Get all your OpenModels News on the OpenModels blog.'
        ...
        additionalLinkTags={[
          {
            ...
            href: `https://open-models-platform.com/rss.xml`,
          },
        ]}
      />
      <DefaultLayout>
        <h1 className="sr-only">OpenModels blog</h1>
