    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://open-models-platform.com/auth`,
          images: [
            {
      ...
      <DefaultLayout>
        <ProductHeader
          ...
          subheader={[
            'Every OpenModels project comes with a complete User Management system that works without any additional tools.',
        ...
        <SectionContainer>
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-12 lg:col-span-3 lg:col-start-9">
              ...
              <p className="p text-base">
                User data stored in your OpenModels database so you never have to worry about 3rd
          ...
          <div className="grid grid-cols-12 lg:mt-16 lg:gap-16">
            <div className="col-span-12 mb-8 lg:col-span-5">
              ...
              <p className="p text-base lg:text-lg">
                OpenModels Auth works without any additional servers. Build Authorization rules with
