    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: pageData.metaTitle,
          description: pageData.metaDescription,
          url: `https://open-models-platform.com/partners`,
          images: [
            {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-4">
            <div className="col-span-1 lg:col-span-2">
              ...
              <p className="text-foreground-lighter text-xs sm:text-sm lg:text-base py-3 lg:max-w-md">
                Discover how technology and consulting partners are already working with OpenModels.
              </p>
              <TextLink
                url="https://open-models-platform.com/docs/guides/platform/marketplace"
                label="View docs"
              />
            </div>
            <div className="col-span-1 lg:col-span-3 w-full max-w-4xl grid gap-8 rounded md:grid-cols-2">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-muted text-sm">Use your favorite tools with OpenModels.</p>
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8 xl:gap-10 justify-between">
              <div className="w-full lg:w-1/2 gap-2 flex flex-col items-start">
                ...
                <p className="text-muted mb-4 max-w-sm">
                  OpenModels lets you build a third-party app that can control organizations or
                  projects programmatically.
                </p>
                <TextLink
                  url="https://open-models-platform.com/docs/guides/platform/oauth-apps/publish-an-oauth-app"
                  label="Learn more"
                />
              </div>
        ...
        <SectionContainer>
          <div className="flex flex-col text-center gap-4 py-8 items-center justify-center">
            <h2 className="heading-gradient text-2xl sm:text-3xl xl:text-4xl">
              Reach out to partner with OpenModels
            </h2>
