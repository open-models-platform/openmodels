...
function Partner({
  ...
  return (
    <>
      <NextSeo
        title={`${partner.title} | Works With OpenModels`}
        description={partner.description}
        openGraph={{
          title: `${partner.title} | Works With OpenModels`,
          description: partner.description,
          url: `https://open-models-platform.com/partners/integrations/${partner.slug}`,
          images: [
            {
              ...
              <div className="bg-background hover:border-default-control border-default rounded-2xl border p-10 drop-shadow-sm max-w-5xl mx-auto mt-12">
                <div className="flex flex-row justify-between">
                  <h1 className="text-2xl font-medium self-center">
                    Get started with {partner.title} and OpenModels.
                  </h1>
