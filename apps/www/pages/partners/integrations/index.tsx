...
export async function getStaticProps() {
  ...
  return {
    ...
    // TODO: consider using Next.js' On-demand Revalidation with OpenModels Database Webhooks instead
...
function IntegrationPartnersPage(props: Props) {
  ...
  const meta_description = `Use your favorite tools with OpenModels.`
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://open-models-platform.com/partners/integrations`,
          images: [
            {
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-8 lg:grid-cols-1">
                    <PartnerLinkBox
                      title="Experts"
                      color="blue"
                      description="Explore our certified OpenModels agency experts that build with OpenModels"
