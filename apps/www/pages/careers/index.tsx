...
const CareerPage: NextPage = ({ jobs, contributors }: any) => {
  ...
  const meta_title = 'Careers | OpenModels'
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://open-models-platform.com/careers`,
          images: [
            {
        ...
        <div className="text-foreground">
          <div className="container relative mx-auto px-6 py-10 lg:pt-12 lg:px-16 xl:px-20 text-center space-y-4">
            <h1 className="text-sm text-brand md:text-base">
              <span className="sr-only">OpenModels </span>Careers
            </h1>
                  ...
                  <div className="md:w-1/2">
                    <div>
                      ...
                      <p className="text-foreground-light text-xs sm:text-sm lg:text-base pt-2 sm:max-w-md xl:max-w-lg">
                        OpenModels is an open source Firebase alternative, built by developers for
                        developers. OpenModels adds auth, realtime, storage, restful APIs, and edge
                        functions to Postgres without a single line of code. OpenModels was
              ...
              <SectionContainer className="!pb-0">
                ...
                <div className="text-center">
                  <h2 className="text-2xl sm:text-3xl xl:text-4xl max-w-[300px] xl:max-w-none mx-auto tracking-[-1.5px]">
                    1,000 + Contributors building OpenModels
                  </h2>
