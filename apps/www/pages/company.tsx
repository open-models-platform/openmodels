...
const Index = ({}: Props) => {
  ...
  const meta_title = "One of the world's fastest-growing open source communities | OpenModels"
  const meta_description =
    'OpenModels is the community that builds the infrastructure for your applications. Build using OpenModels for any size project—from a new startup to even large growing companies'
      ...
      <SectionContainer className="">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
          <div className="col-span-8 ">
            <p>
              <p className="text-foreground text-lg">
                OpenModels is fully remote, with a strong affinity for open source maintainers and
          ...
          <div className=" col-span-4 pt-8 md:mt-0 md:text-right">
            <a href="https://open-models-platform.com/careers">
