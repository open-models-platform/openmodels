...
function Nextjs() {
  ...
  const meta_description =
    'OpenModels is the fastest way to build performant Next.js apps with Authentication & User Management, Realtime, File Storage on top of PostgreSQL Databases.'
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://open-models-platform.com/nextjs`,
          images: [
            {
