...
export default function IndexPage() {
  ...
  const meta_title = 'Pricing & fees | OpenModels'
  const meta_description =
    'Explore OpenModels fees and pricing information. Find our competitive pricing plans, with no hidden pricing. We have a generous free plan for those getting started, and Pay As You Go for those scaling up.'
  ...
  const addons = [
    {
      ...
      leftCtaLink: 'https://open-models-platform.com/docs/guides/platform/compute-add-ons',
    ...
    },
    {
      ...
      price: 'Flat fee $10',
      description:
        'Use your own domain for your OpenModels project to present a more polished product to your users.',
      leftCtaText: 'Documentation',
      leftCtaLink: 'https://open-models-platform.com/docs/guides/platform/custom-domains',
    ...
    },
    {
      ...
      leftCtaText: 'Documentation',
      leftCtaLink: 'https://open-models-platform.com/docs/guides/platform/backups',
      rightCtaText: 'See Pricing breakdown',
      rightCtaLink: 'http://',
    },
  ]
    ...
    return (
      <div className="mt-8 px-4 mobile-header">
        ...
        <Button asChild size="medium" block>
          <Link href="https://open-models-platform.com/dashboard/new">Get started</Link>
        </Button>
      </div>
    )
  }
        ...
        <div>
          <div className="text-center">
            ...
            <p className="text-foreground-light mt-4 mb-8 lg:mb-16 text-lg">
              Level up your OpenModels experience with add-ons.
            </p>
          </div>
                  ...
                  <tr className="border-default border-t">
                    ...
                    <td className="px-6 pt-5">
                      <Button asChild size="tiny" type="primary" block>
                        <Link
                          href="https://open-models-platform.com/dashboard/new?plan=free"
                          as="https://open-models-platform.com/dashboard/new?plan=free"
                        >
                          Get Started
                        </Link>
                      </Button>
                    ...
                    <td className="px-6 pt-5">
                      <Button asChild size="tiny" type="primary" block>
                        <Link
                          href="https://open-models-platform.com/dashboard/new?plan=pro"
                          as="https://open-models-platform.com/dashboard/new?plan=pro"
                        >
                          Get Started
                        </Link>
                      </Button>
                    ...
                    <td className="px-6 pt-5">
                      <Button asChild size="tiny" type="primary" block>
                        <Link href="https://open-models-platform.com/dashboard/new?plan=team">Get Started</Link>
                      </Button>
                    </td>
          ...
          <div className="mx-auto max-w-5xl gap-y-10 gap-x-10 lg:grid-cols-2">
            <div className="sm:py-18 mx-auto px-6 py-16 md:py-24 lg:px-16 lg:py-24 xl:px-20">
              ...
              <p className="p text-center">
                ...
                <a
                  target="_blank"
                  href="https://open-models-platform.com/dashboard/support/new"
