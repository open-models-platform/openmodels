...
const OpenSource = () => {
  ...
  const meta_title = pageData.metaTitle || 'Open Source | OpenModels'
  const meta_description =
    pageData.metaDescription ||
    'OpenModels is an open source company, supporting existing open source tools and communities wherever possible.'
