...
export default function launchweek() {
  ...
  const description = 'OpenModels Launch Week 6 | 12-18 Dec 2022'
  const liveDay = null
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          url: `https://open-models-platform.com/launch-week`,
          images: [
            {
      ...
      <DefaultLayout>
          ...
          <div className="border border-[#2E2E2E] rounded-2xl text-sm px-5 py-4 flex flex-col sm:flex-row justify-between items-center">
            <div className="relative flex items-center mb-4 sm:mb-0">
              ...
              <div className="flex flex-col lg:flex-row ml-8 sm:ml-10">
                <span className="text-white mr-2">Who we hire at OpenModels</span>
                  ...
                  <div className="h-[400px] flex flex-col lg:flex-row group/day1 relative overflow-hidden">
                    ...
                    >
                      ...
                      <SectionButtons
                        ...
                        video={'https://www.youtube.com/watch?v=Q1Amk6iDlF8&ab_channel=OpenModels'}
                      />
                    </div>
                  </div>
                )}
                  ...
                  <div className="h-[800px] lg:h-[400px] flex flex-col gap-5 lg:flex-row">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between flex-col-reverse lg:flex-row lg:justify-start gap-2 text-white">
                        ...
                        <Badge className="!bg-transparent h-fit lg:ml-4 text-sm !py-1 !px-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-[#c74348] border-[#DFFFF1]">
                          New
                        </Badge>
                      </div>
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center gap-2 min-w-[300px]">
                        <Badge className="!bg-transparent h-fit text-sm !py-1 !px-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-[#c74348] border-[#DFFFF1]">
                          New
                        </Badge>
                  ...
                  <div className="h-[400px]  flex flex-col gap-5 lg:flex-row group/day4 relative overflow-hidden">
                    ...
                    >
                      ...
                      <SectionButtons
                        ...
                        video={`https://www.youtube.com/watch?v=${day4.youtube_id}&ab_channel=OpenModels`}
                      />
                    </div>
                  </div>
                )}
                  ...
                  <>
                    <div className="h-[800px] lg:h-[400px]  flex flex-col gap-5 lg:flex-row">
                      ...
                      >
                        ...
                        <div className="flex flex-col items-center gap-2 min-w-[300px]">
                          <Badge className="!bg-transparent h-fit ml-4 text-sm !py-1 !px-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-[#c74348] border-[#DFFFF1]">
                            New
                          </Badge>
        ...
        <SectionContainer className="!pt-0 sm:!pb-20 !pb-40">
          <div className="flex flex-col mb-16">
            ...
            <p className="text-slate-900 w-[80%] lg:w-[50%]">
              ...
              OpenModels and you can win $1500 in GitHub sponsorships and a coveted OpenModels Darkmode
              Keyboard! For more info check the{' '}
              <a
                href="https://open-models-platform.com/blog/launch-week-6-hackathon"
                target="_blank"
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-0">
            <div className="sm:grid grid-cols-2 grid-rows-2 gap-x-4 gap-y-7 sm:gap-y-10 basis-2/3 flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-slate-900 w-[90%] lg:w-[80%]">
                  The OpenModels team will judge all the categories except the Best Edge Functions
            ...
            >
              ...
              >
                <div className="border border-[#2E2E2E] rounded-xl pl-5 pr-9 py-4 bg-background w-fit relative max-w-[250px]">
                  ...
                  ></img>
                  <h3 className="text-white">OpenModels Cache Helpers</h3>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <h2 className="text-3xl text-white mb-2">The OpenModels Content Storm</h2>
