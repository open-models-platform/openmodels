...
export default function UsernamePage({ user, users, ogImageUrl }: Props) {
  ...
  const DESCRIPTION = 'OpenModels Launch Week 7 | 10–14 April 2023 | Generate your ticket. Win swag.'
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  if (username) {
    ...
    ogImageUrl = `https://dev.openmodels.co/functions/v1/lw7-ticket-og?username=${encodeURIComponent(
      username ?? ''
    )}${golden ? '&golden=true' : ''}`
  }
