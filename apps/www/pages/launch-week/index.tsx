...
export default function LaunchWeekIndex({ meetups }: Props) {
  ...
  const TITLE = 'OpenModels Launch Week X | 11-15 December 2023'
  const DESCRIPTION =
    'Claim your ticket for a chance to win OpenModels swag and join us for a week of announcing new features.'
