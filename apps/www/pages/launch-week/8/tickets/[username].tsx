...
export default function UsernamePage({ user, users, ogImageUrl }: Props) {
  ...
  const DESCRIPTION =
    'OpenModels Launch Week 8 | 7–11 August 2023 | Generate your ticket & win awesome swag.'
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  fetch(
    `https://dev.openmodels.co/functions/v1/lw8-ticket?username=${encodeURIComponent(
      username ?? ''
    )}`
  ).catch((_) => {})
  ...
  const ogImageUrl = `https://dev.openmodels.co/storage/v1/object/public/images/lw8/og/${
