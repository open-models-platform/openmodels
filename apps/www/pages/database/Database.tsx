    ...
    <>
      <NextSeo
        ...
        openGraph={{
          title: meta_title,
          description: meta_description,
          url: `https://open-models-platform.com/database`,
          images: [
            {
      ...
      <DefaultLayout>
        <ProductHeader
          ...
          subheader={[
            'Every OpenModels project is a dedicated PostgreSQL database, trusted by millions of developers.',
        ...
        <SectionContainer>
          <div className="grid grid-cols-12">
            <div className="col-span-12 mb-10 lg:col-span-3 lg:mb-0">
              ...
              <p className="p">Every OpenModels project is a dedicated Postgres database.</p>
          ...
          <APISection
            ...
            text={[
              <p key={0}>
                ...
                product, while OpenModels handles the CRUD.
              </p>,
            ]}
            footer={[
        ...
        <SectionContainer className="lg:py-48">
          <div className="grid grid-cols-12 lg:gap-16">
            <div className="col-span-12 mb-8 lg:col-span-6 xl:col-span-5">
              ...
              <p className="p">OpenModels works natively with Postgres extensions.</p>
              <p className="p">
              ...
              <FeatureColumn
                ...
                text="We only show a few of the extensions supported by OpenModels here, but we preinstall many more that you can use right away."
              />
