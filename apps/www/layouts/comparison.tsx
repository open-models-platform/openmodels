    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          url: `https://open-models-platform.com/alternatives/${props.blog.slug}`,
          type: 'article',
          article: {
            //
          ...
          <div className="">
            ...
            <div className="py-16">
              ...
              <div className="mt-4 flex items-center space-x-4">
                <Link
                  href={`https://twitter.com/share?text=${props.blog.title}&url=https://open-models-platform.com/blog/${props.blog.slug}`}
                  target="_blank"
                ...
                <Link
                  href={`https://www.linkedin.com/shareArticle?url=https://open-models-platform.com/blog/${props.blog.slug}&title=${props.blog.title}`}
                  target="_blank"
                  className="text-muted hover:text-foreground"
                >
                  <svg
