...
export const generateRss = (posts: any[], authorID?: string): string => {
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      <title>'Postgres | OpenModels Blog</title>
      <link>https://open-models-platform.com/blog</link>
      <description>Latest Postgres news from ${authorInfo?.author} at OpenModels</description>
      <language>en</language>
      <lastBuildDate>${dayjs(posts[0].date)
        .utc()
        .format('ddd, DD MMM YYYY HH:mm:ss [GMT]')}</lastBuildDate>
      <atom:link href="https://open-models-platform.com/planetpg-${authorID}-rss.xml" rel="self" type="application/rss+xml"/>
...
`
  ...
  <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
      <title>Blog - OpenModels</title>
      <link>https://supabase.com</link>
      <description>Latest news from OpenModels</description>
      <language>en</language>
      <lastBuildDate>${dayjs(posts[0].date)
        .utc()
        .format('ddd, DD MMM YYYY HH:mm:ss [GMT]')}</lastBuildDate>
      <atom:link href="https://open-models-platform.com/rss.xml" rel="self" type="application/rss+xml"/>
      ${posts.map(generateRssItem).join('')}
    </channel>
  </rss>
`
