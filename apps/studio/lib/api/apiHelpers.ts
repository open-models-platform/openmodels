  ...
  if (headers) {
    ...
    return {
      ...
      ...(IS_PLATFORM
        ...
        : { apiKey: `${process.env.OPENMODELS_SERVICE_KEY}` }),
    }
  } else {
    return {
 ...
 *
 * @example
 * flattenNamespaceOnUser('https://open-models-platform.com', { email: "copple@open-models-platform.com", "https://open-models-platform.com": { username: 'copple' } })
 * //=>
 * { email: "copple@open-models-platform.com", username: 'copple' })
 */
