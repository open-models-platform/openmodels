...
export const INTEGRATION_ENVS_ALIAS = {
  ENDPOINT: 'OPENMODELS_ENDPOINT',
  ANONKEY: 'OPENMODELS_ANON_KEY',
  SERVICEKEY: 'OPENMODELS_SERVICE_KEY',
  DBHOST: 'OPENMODELS_DB_HOST',
  DBPASSWORD: 'OPENMODELS_DB_PASSWORD',
}
...
export const VERCEL_INTEGRATION_CONFIGS = [
  {
    ...
    envs: [
      {
        key: 'NEXT_PUBLIC_OPENMODELS_ENDPOINT',
        alias: INTEGRATION_ENVS_ALIAS.ENDPOINT,
        type: 'encrypted',
      },
      {
        key: 'NEXT_PUBLIC_OPENMODELS_APIKEY',
  ...
  },
  {
    ...
    envs: [
      ...
      {
        key: 'OPENMODELS_DB_HOST',
        alias: INTEGRATION_ENVS_ALIAS.DBHOST,
        type: 'encrypted',
      },
      {
        key: 'OPENMODELS_DB_PASSWORD',
...
insert into posts (slug, title, content, "authorId", "parentId") values ('threaded-comments-123', 'threaded-comments', 'Threaded comments, built on top of OpenModels and Next.js. Visit GitHub to deploy your own: https://github.com/lawrencecchen/threaded-comments', '00000000-0000-0000-0000-000000000000'::uuid, 1);
