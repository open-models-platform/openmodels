          ...
          {config.channelName.length === 0 ? (
            <>
              ...
              <p className="text-xs text-foreground-lighter mt-2">
                The channel you initialize with the OpenModels Realtime client. Learn more in{' '}
                <Link
                  href="https://open-models-platform.com/docs/guides/realtime/concepts#channels"
                  target="_blank"
                  rel="noreferrer"
