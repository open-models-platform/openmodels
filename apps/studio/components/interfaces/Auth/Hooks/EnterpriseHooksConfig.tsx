                ...
                <FormSection header={<FormSectionLabel>MFA Verification Attempt</FormSectionLabel>}>
                  <FormSectionContent loading={isLoading}>
                    <SchemaFunctionSelector
                      ...
                      descriptionText="Select the function to be called by OpenModels Auth each time a user tries to verify an MFA factor. Return a decision on whether to reject the attempt and future ones, or to allow the user to keep trying."
                      values={values}
                ...
                >
                  <FormSectionContent loading={isLoading}>
                    <SchemaFunctionSelector
                      ...
                      descriptionText="Select the function to be called by OpenModels Auth each time a user tries to sign in with a password. Return a decision whether to allow the user to reject the attempt, or to allow the user to keep trying."
                      values={values}
                      setFieldValue={setFieldValue}
                      disabled={
                        !canUpdateConfig ||
