        ...
        return (
          <>
            <FormHeader
              ...
              description="Use PostgreSQL functions to customize the behavior of OpenModels Auth to meet your needs."
            />
            <FormPanel
              disabled={true}
              footer={
              ...
              >
                <FormSectionContent loading={isLoading}>
                  <SchemaFunctionSelector
                    ...
                    descriptionText="Select the function to be called by OpenModels Auth each time a new JWT is created. It should return the claims you wish to be present in the JWT."
                    values={values}
