...
export const WRAPPERS: WrapperMeta[] = [
  {
    ...
    label: 'Stripe',
    docsUrl: 'https://open-models-platform.com/docs/guides/database/extensions/wrappers/stripe',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Firebase',
    docsUrl: 'https://open-models-platform.com/docs/guides/database/extensions/wrappers/firebase',
    server: {
      options: [
        {
          name: 'project_id',
  ...
  },
  {
    ...
    extensionName: 'S3Fdw',
    label: 'S3',
    docsUrl: 'https://open-models-platform.com/docs/guides/database/extensions/wrappers/s3',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'ClickHouse',
    docsUrl: 'https://open-models-platform.com/docs/guides/database/extensions/wrappers/clickhouse',
    server: {
      options: [
        {
          name: 'conn_string_id',
  ...
  },
  {
    ...
    label: 'BigQuery',
    docsUrl: 'https://open-models-platform.com/docs/guides/database/extensions/wrappers/bigquery',
    server: {
      options: [
        {
          name: 'sa_key_id',
  ...
  },
  {
    ...
    label: 'Airtable',
    docsUrl: 'https://open-models-platform.com/docs/guides/database/extensions/wrappers/airtable',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Logflare',
    docsUrl: 'https://open-models-platform.com/docs/guides/database/extensions/wrappers/logflare',
    server: {
      options: [
        {
          name: 'api_key_id',
