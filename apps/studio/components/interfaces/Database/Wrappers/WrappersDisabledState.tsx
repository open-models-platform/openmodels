      ...
      >
        <div className="w-3/5 space-y-8">
          <div className="space-y-2">
            <h4 className="text-lg">OpenModels Wrappers</h4>
            <p className="text-sm text-foreground-light">
              OpenModels Wrappers is a framework for building Postgres Foreign Data Wrappers (FDW)
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2 my-1 ml-[1px]">
                <Button asChild type="default" icon={<IconExternalLink />}>
                  <Link
                    href="https://open-models-platform.com/docs/guides/database/extensions/wrappers/overview"
                    target="_blank"
                    rel="noreferrer"
                  >
                    About Wrappers
