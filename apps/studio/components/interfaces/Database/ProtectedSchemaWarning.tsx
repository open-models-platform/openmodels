...
export const ProtectedSchemaModal = ({
  ...
  return (
    <Modal
      size="medium"
      visible={visible}
      header="Schemas managed by OpenModels"
      customFooter={
    ...
    >
      <Modal.Content className="py-4 space-y-2">
        <p className="text-sm">
          The following schemas are managed by OpenModels and are currently protected from write
        ...
        <p className="text-sm !mt-4">
          These schemas are critical to the functionality of your OpenModels project and hence we
  ...
  return (
    <>
      <Alert_Shadcn_>
        ...
        <AlertDescription_Shadcn_>
          <p className="mb-2">
            The <code className="text-xs">{schema}</code> schema is managed by OpenModels and is
