        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-2">
            <Button asChild type="default" icon={<IconExternalLink strokeWidth={1.5} />}>
              <Link
                href="https://open-models-platform.com/docs/guides/database/query-optimization"
                target="_blank"
                rel="noreferrer"
              >
                Documentation
            ...
            <Button asChild type="default" icon={<IconExternalLink strokeWidth={1.5} />}>
              <Link
                href="https://open-models-platform.com/docs/guides/database/extensions/index_advisor"
                target="_blank"
                rel="noreferrer"
              >
