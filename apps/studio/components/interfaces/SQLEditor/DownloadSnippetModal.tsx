...
const DownloadSnippetModal = ({ id, ...props }: DownloadSnippetModalProps) => {
  ...
  return (
    <Modal
      ...
      showCloseButton
      size="xlarge"
      header={<p>Download snippet as local migration file via the OpenModels CLI.</p>}
      {...props}
    >
      <TabsProvider>
        <div className="flex flex-col items-start justify-between gap-4 py-5 relative">
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="flex justify-between items-center gap-x-2 mx-5">
              ...
              >
                <Link
                  href="https://open-models-platform.com/docs/guides/cli/local-development#database-migrations"
                  target="_blank"
                  rel="noreferrer"
                >
                  About migrations
              ...
              >
                <Link
                  href="https://open-models-platform.com/docs/guides/cli/local-development"
                  target="_blank"
                  rel="noreferrer"
                >
                  About CLI
