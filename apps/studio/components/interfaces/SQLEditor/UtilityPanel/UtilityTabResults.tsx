...
const UtilityTabResults = ({ id, isExecuting }: UtilityTabResultsProps) => {
  ...
  // Customers on HIPAA plans should not have access to OpenModels AI
            ...
            <div className="flex flex-col gap-y-1">
              ...
              <p className="font-mono text-sm text-foreground-light">
                ...
                <a
                  ...
                  href="https://open-models-platform.com/docs/guides/platform/performance#examining-query-performance"
                >
                  optimize your query
                </a>
                , or{' '}
                <a
                  ...
                  rel="noreferrer"
                  className="underline transition hover:text-foreground"
                  href="https://open-models-platform.com/docs/guides/database/timeouts"
                >
