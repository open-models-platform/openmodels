  ...
  return (
    <>
      ...
      <h2 className="doc-heading">
        GraphQL <span className="lowercase">vs</span> OpenModels
      </h2>
      <div className="doc-section">
        <article className="code-column text-foreground">
          <p>
          ...
          <p>
            ...
            Apollo GraphQL and OpenModels.
            <br />
            <br />
          </p>
          <h4>Still want GraphQL?</h4>
          <p>
            If you still want to use GraphQL, you can. OpenModels provides you with a full Postgres
