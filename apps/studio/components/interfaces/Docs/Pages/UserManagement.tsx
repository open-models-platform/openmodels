...
export default function UserManagement({
  ...
  const keyToShow = showApiKey ? showApiKey : 'OPENMODELS_KEY'
    ...
    <>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          <p>OpenModels makes it easy to manage your users.</p>
          <p>
            OpenModels assigns each user a unique ID. You can reference this ID anywhere in your
            database. For example, you might create a <code>profiles</code> table references the
            user using a <code>user_id</code> field.
          </p>
          <p>
            OpenModels already has built in the routes to sign up, login, and log out for managing
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            After they have signed up, all interactions using the OpenModels JS client will be
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            After they have logged in, all interactions using the OpenModels JS client will be
            performed as "that user".
          </p>
        </article>
        <article className="code">
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            After they have clicked the link, all interactions using the OpenModels JS client will be
            performed as "that user".
          </p>
        </article>
        <article className="code">
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            ...
            <a
              href="https://open-models-platform.com/docs/guides/auth#providers"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          <p>
            After calling log out, all interactions using the OpenModels JS client will be
            "anonymous".
          </p>
        </article>
        <article className="code">
