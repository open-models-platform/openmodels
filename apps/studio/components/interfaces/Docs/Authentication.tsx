...
const Authentication = ({ autoApiService, selectedLang, showApiKey }: AuthenticationProps) => {
  ...
  const defaultApiKey =
    showApiKey !== 'OPENMODELS_KEY'
      ? autoApiService?.defaultApiKey ?? 'OPENMODELS_CLIENT_API_KEY'
      : 'OPENMODELS_CLIENT_API_KEY'
  const serviceApiKey =
    showApiKey !== 'OPENMODELS_KEY'
      ? autoApiService?.serviceApiKey ?? 'OPENMODELS_SERVICE_KEY'
    ...
    <>
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          <p>OpenModels works through a mixture of JWT and Key auth.</p>
          <p>
      ...
      <div className="doc-section ">
        <article className="code-column text-foreground">
          ...
          <p>
            In this documentation, we will refer to the key using the name <code>OPENMODELS_KEY</code>
            .
          </p>
          <p>
        ...
        <article className="code">
          <CodeSnippet
            ...
            snippet={Snippets.authKey('CLIENT API KEY', 'OPENMODELS_KEY', defaultApiKey)}
          />
          <CodeSnippet
            selectedLang={selectedLang}
