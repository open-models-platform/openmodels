    ...
    <>
      <h2 className="doc-heading flex items-center justify-between">
        ...
        <Button asChild type="default" icon={<IconExternalLink />}>
          <Link
            href="https://open-models-platform.com/docs/guides/database/api/generating-types"
            target="_blank"
            rel="noreferrer"
          >
            Documentation
      ...
      <div className="doc-section">
        <article className="code-column text-foreground">
          <p>
            OpenModels APIs are generated from your database, which means that we can use database
            introspection to generate type-safe API definitions.
          </p>
          <p>
            You can generate types from your database either through the{' '}
            <Link href="https://open-models-platform.com/docs/guides/database/api/generating-types">
              OpenModels CLI
            </Link>
