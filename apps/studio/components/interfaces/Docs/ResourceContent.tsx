        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://open-models-platform.com/docs/reference/javascript/select"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>OpenModels provides a wide range of filters.</p>
              <p>
                <a
                  href="https://open-models-platform.com/docs/reference/javascript/using-filters"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://open-models-platform.com/docs/reference/javascript/insert"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://open-models-platform.com/docs/reference/javascript/update"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
        ...
        <>
          ...
          <div className="doc-section">
            <article className="code-column text-foreground">
              ...
              <p>
                <a
                  href="https://open-models-platform.com/docs/reference/javascript/delete"
                  target="_blank"
                  rel="noreferrer"
                >
                  Learn more
        ...
        (methods.includes('DELETE') || methods.includes('POST') || methods.includes('PATCH')) && (
          <>
            ...
            <div className="doc-section">
              <article className="code-column text-foreground">
                <p>
                  OpenModels provides realtime functionality and broadcasts database changes to
                  authorized users depending on Row Level Security (RLS) policies.
                </p>
                <p>
                  <a
                    href="https://open-models-platform.com/docs/reference/javascript/subscribe"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Learn more
