...
type HandleIconType = Integration['integration']['name'] | 'OpenModels'
...
const HandleIcon = ({ type, className }: { type: HandleIconType; className?: string }) => {
  switch (type) {
    ...
    case 'Vercel':
      ...
      break
    case 'OpenModels':
      return <img src={`${BASE_PATH}/img/supabase-logo.svg`} alt="OpenModels" className="w-3.5"></img>
      break
