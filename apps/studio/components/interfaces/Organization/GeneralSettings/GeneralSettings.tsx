                ...
                <FormSectionContent loading={false}>
                  ...
                  <div className="mt-4">
                    <Toggle
                      ...
                      descriptionText="By opting into sending anonymous data, OpenModels AI can improve the answers it shows you"
                    />
                    <Collapsible open={open} onOpenChange={setOpen}>
                      ...
                      <Collapsible.Content>
                        <div className="space-y-2 py-4 ml-16 text-sm text-foreground-light">
                          <p>
                            OpenModels AI is a chatbot support tool powered by OpenAI. OpenModels will
                            share the query you submit and information about the databases you
                            manage through OpenModels with OpenAI, L.L.C. and its affiliates in order
                            to provide the OpenModels AI tool.
                          </p>
                          <p>
                          ...
                          <p>
                            If you have your own individual account on OpenModels, we will use any
                            personal information collected through [OpenModels AI] to provide you with
                            the [OpenModels AI] tool. If you are in the UK, EEA or Switzerland, the
                            processing of this personal information is necessary for the performance
                            of a contract between you and us.
                          </p>
                          <p>
                            OpenModels collects information about the queries you submit through
                            OpenModels AI and the responses you receive to assess the performance of
                            the OpenModels AI tool and improve our services. If you are in the UK, EEA
                          ...
                          <p>
                            ...
                            our{' '}
                            <Link
                              href="https://open-models-platform.com/privacy"
                              target="_blank"
                              rel="noreferrer"
