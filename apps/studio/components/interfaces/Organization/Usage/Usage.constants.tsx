    ...
    attributes: [
      {
        ...
        links: [
          {
            name: 'Documentation',
            url: 'https://open-models-platform.com/docs/guides/platform/database-size',
          },
        ],
        chartDescription: 'The data refreshes every 24 hours.',
      ...
      },
      {
        ...
        links: [
          {
            name: 'Storage',
            url: 'https://open-models-platform.com/docs/guides/storage',
          },
        ],
      },
      {
    ...
    attributes: [
      {
        ...
        links: [
          {
            name: 'Auth',
            url: 'https://open-models-platform.com/docs/guides/auth',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            url: 'https://open-models-platform.com/docs/guides/auth/sso/auth-sso-saml',
          },
        ],
      },
      {
        ...
        links: [
          {
            name: 'Documentation',
            url: 'https://open-models-platform.com/docs/guides/storage/image-transformations',
          },
        ],
      },
      {
        ...
        links: [
          {
            name: 'Edge Functions',
            url: 'https://open-models-platform.com/docs/guides/functions',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            url: 'https://open-models-platform.com/docs/guides/realtime/quotas',
          },
        ],
      },
      {
