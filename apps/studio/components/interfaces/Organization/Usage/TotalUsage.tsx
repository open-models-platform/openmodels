          ...
          links: [
            {
              ...
              url: 'https://open-models-platform.com/docs/guides/platform/org-based-billing',
            },
            {
              name: 'OpenModels Plans',
              url: 'https://open-models-platform.com/pricing',
            },
          ],
        }}
      >
              ...
              <p className="text-sm">
                {!hasExceededAnyLimits ? (
                  ...
                  <span>
                    ...
                    <span className="font-medium">{subscription?.plan.name}</span> plan quota in
                    this billing cycle. Upgrade your plan to continue using OpenModels without
                    restrictions.
                  </span>
                ) : hasExceededAnyLimits &&
                  ...
                  <span>
                    You have exceeded your{' '}
                    <span className="font-medium">{subscription?.plan.name}</span> plan quota in
                    this billing cycle. Disable your spend cap to continue using OpenModels without
                    restrictions.
                  </span>
