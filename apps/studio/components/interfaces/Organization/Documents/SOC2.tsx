  ...
  return (
    <ScaffoldSection>
      ...
      <ScaffoldSectionContent>
        ...
        <ConfirmationModal
          visible={isOpen}
          header="Non-Disclosure Agreement to access OpenModels's SOC2 Report"
          buttonLabel="I agree"
            ...
            <div className="py-4 text-sm text-foreground-light pl-30">
              <ol className="list-decimal list-inside">
                ...
                <li>
                  ...
                  contained in the agreement between OpenModels, Inc ("OpenModels", "we", "our" or "us")
                  and the OpenModels customer that has authorized you to access our platform to obtain
