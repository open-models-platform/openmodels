        ...
        header={
          <div className="flex items-center justify-between">
            ...
            <Button asChild type="default" icon={<IconExternalLink strokeWidth={1.5} />}>
              <Link href="https://open-models-platform.com/pricing" target="_blank" rel="noreferrer">
                Pricing
              </Link>
            </Button>
          </div>
                ...
                description={
                  <div>
                    ...
                    <div className="space-x-3 mt-2">
                      <Button asChild type="default" icon={<IconExternalLink strokeWidth={1.5} />}>
                        <Link
                          href="https://open-models-platform.com/docs/guides/platform/org-based-billing"
                          target="_blank"
                          rel="noreferrer"
                        >
                          How billing works
                      ...
                      {subscription?.plan?.id === 'free' && (
                        ...
                        >
                          <Link
                            href="https://open-models-platform.com/docs/guides/platform/project-transfer"
                            target="_blank"
                            rel="noreferrer"
                          >
                            Project transfers
