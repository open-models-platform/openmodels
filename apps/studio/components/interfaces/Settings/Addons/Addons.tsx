              ...
              <ScaffoldSectionDetail>
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <Link
                        href="https://open-models-platform.com/docs/guides/platform/compute-add-ons"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <div>
                      <Link
                        href="https://open-models-platform.com/docs/guides/database/connecting-to-postgres#connection-pooler"
                        target="_blank"
                        rel="noreferrer"
                      >
                        <div className="flex items-center space-x-2 opacity-50 hover:opacity-100 transition">
              ...
              <ScaffoldSectionDetail>
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <Link
                        href="https://open-models-platform.com/docs/guides/platform/backups#point-in-time-recovery"
                        target="_blank"
                        rel="noreferrer"
                      >
                        <div className="flex items-center space-x-2 opacity-50 hover:opacity-100 transition">
              ...
              <ScaffoldSectionDetail>
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <Link
                        href="https://open-models-platform.com/docs/guides/platform/custom-domains"
                        target="_blank"
                        rel="noreferrer"
                      >
                        <div className="flex items-center space-x-2 opacity-50 hover:opacity-100 transition">
