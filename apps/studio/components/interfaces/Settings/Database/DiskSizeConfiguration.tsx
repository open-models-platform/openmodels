        ...
        <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-1 items-center lg:grid-cols-3">
                <div className="col-span-2 space-y-1">
                  ...
                  <p className="text-sm opacity-50">
                    OpenModels employs auto-scaling storage and allows for manual disk size <br />{' '}
          ...
          <Alert withIcon variant="info" title={'Importing a lot of data?'}>
            ...
            <p className="mt-4">
              ...
              <a
                className="underline"
                href="https://open-models-platform.com/docs/guides/platform/database-size#disk-management"
              >
                disk management
              </a>
              .
