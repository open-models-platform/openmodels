  ...
  const formSchema = {
    properties: {
      ...
      max_client_conn: {
        ...
        help: 'The maximum number of concurrent client connections allowed. Overrides default optimizations; refer to https://open-models-platform.com/docs/guides/platform/custom-postgres-config#pooler-config',
      },
      default_pool_size: {
        title: 'Default Pool Size',
        oneOf: [{ type: 'integer' }, { type: 'null' }],
        help: 'The maximum number of connections made to the underlying Postgres cluster, per user+db combination. Overrides default optimizations; refer to https://open-models-platform.com/docs/guides/platform/custom-postgres-config#pooler-config',
      },
    },
    required: ['pool_mode'],
    type: 'object',
              ...
              <div className="!mt-1 flex" style={{ marginLeft: 'calc(33% + 0.5rem)' }}>
                <p className="text-sm text-foreground-lighter">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href="https://open-models-platform.com/docs/guides/database/connecting-to-postgres#connection-pool"
                  >
                    click here
                  </a>
                  .
