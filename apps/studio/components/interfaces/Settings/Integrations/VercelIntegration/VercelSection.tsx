...
Connect your Vercel teams to your OpenModels organization.
`
...
OpenModels will keep your environment variables up to date in each of the projects you assign to a OpenModels project.
You can also link multiple Vercel Projects to the same OpenModels project.
`
...
You can change the scope of the access for OpenModels by configuring
