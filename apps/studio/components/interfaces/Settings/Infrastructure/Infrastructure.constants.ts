        ...
        links: [
          {
            ...
            url: 'https://open-models-platform.com/docs/guides/platform/compute-add-ons',
          },
          { name: 'High CPU Usage', url: 'https://open-models-platform.com/docs/guides/platform/exhaust-cpu' },
          {
            name: 'Metrics',
            url: 'https://open-models-platform.com/docs/guides/platform/metrics',
          },
        ],
      },
      {
        ...
        links: [
          ...
          { name: 'High RAM Usage', url: 'https://open-models-platform.com/docs/guides/platform/exhaust-ram' },
          {
            name: 'Metrics',
            url: 'https://open-models-platform.com/docs/guides/platform/metrics',
          },
        ...
        links: [
          {
            ...
            url: 'https://open-models-platform.com/docs/guides/platform/compute-add-ons#disk-throughput-and-iops',
          },
          {
            name: 'Metrics',
            url: 'https://open-models-platform.com/docs/guides/platform/metrics',
