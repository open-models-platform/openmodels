                          ...
                          <Tooltip.Content side="bottom">
                            ...
                            >
                              <span className="text-xs text-foreground">
                                Project is on the latest version of Postgres that OpenModels supports
                              </span>
                            </div>
                          </Tooltip.Content>
                        </Tooltip.Portal>
                    ...
                    >
                      ...
                      <AlertDescription_Shadcn_ className="flex flex-col gap-3">
                        ...
                        <div>
                          <Button size="tiny" type="default" asChild>
                            <Link
                              href="https://open-models-platform.com/docs/guides/platform/migrating-and-upgrading-projects#caveats"
                              target="_blank"
                              rel="noreferrer"
                            >
                              View docs
