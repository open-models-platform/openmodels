export const CLIENT_LIBRARIES = [
  {
    ...
    docsUrl: 'https://open-models-platform.com/docs/reference/javascript/installing',
  ...
  },
  {
    ...
    officialSupport: true,
    releaseState: undefined,
    docsUrl: 'https://open-models-platform.com/docs/reference/dart/installing',
  ...
  },
  {
    ...
    releaseState: 'Alpha',
    docsUrl: 'https://open-models-platform.com/docs/reference/python/initializing',
  ...
  },
  {
    ...
    officialSupport: false,
    releaseState: undefined,
    docsUrl: 'https://open-models-platform.com/docs/reference/csharp/installing',
  ...
  },
  {
    ...
    officialSupport: false,
    releaseState: undefined,
    docsUrl: 'https://open-models-platform.com/docs/reference/swift/initializing',
  ...
  },
  {
    ...
    officialSupport: false,
    releaseState: undefined,
    docsUrl: 'https://open-models-platform.com/docs/reference/kotlin/installing',
...
export const EXAMPLE_PROJECTS = [
  {
    ...
    description: 'A Trello clone using OpenModels as the storage system.',
    url: 'https://github.com/joshnuss/supabase-kanban',
  },
  {
    framework: 'nextjs',
    title: 'Next.js Realtime chat app',
    description: 'Next.js Slack clone app using OpenModels realtime subscriptions',
  ...
  },
  {
    ...
    description: 'NestJS example using OpenModels Auth',
