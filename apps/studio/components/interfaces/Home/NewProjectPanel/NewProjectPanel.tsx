            ...
            <div className="col-span-12 flex flex-col justify-center space-y-8 lg:col-span-7">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Button asChild type="default" icon={<IconExternalLink size={14} />}>
                  <Link
                    href="https://open-models-platform.com/docs/guides/database"
                    target="_blank"
                    rel="noreferrer"
                  >
                    About Database
          ...
          {authEnabled && edgeFunctionsEnabled && storageEnabled && (
            <div className="flex h-full flex-col justify-between space-y-6">
              <div className="max-w-2xl space-y-2">
                ...
                <p className="text-base text-foreground-light">
                  OpenModels provides all the backend features you need to build a product. You can
                ...
                <Panel>
                  <Panel.Content className="flex flex-col space-y-4 md:px-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <Link
                          href="https://open-models-platform.com/docs/guides/auth"
                          target="_blank"
                          rel="noreferrer"
                        >
                          About Auth
                ...
                <Panel>
                  <Panel.Content className="flex flex-col space-y-4 md:px-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <Link
                          href="https://open-models-platform.com/docs/guides/storage"
                          target="_blank"
                          rel="noreferrer"
                        >
                          About Storage
                ...
                <Panel>
                  <Panel.Content className="flex flex-col space-y-4 md:px-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <Link
                          href="https://open-models-platform.com/docs/guides/functions"
                          target="_blank"
                          rel="noreferrer"
                        >
                          About Functions
                ...
                <Panel>
                  <Panel.Content className="flex flex-col space-y-4 md:px-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <Link
                          href="https://open-models-platform.com/docs/guides/realtime"
                          target="_blank"
                          rel="noreferrer"
                        >
                          About Realtime
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-base text-foreground-light lg:max-w-sm">
              ...
              <Link href="https://open-models-platform.com/docs/reference" className="text-brand">
                OpenModels client libraries
              </Link>{' '}
              with your API keys.
            </p>
            <p className="text-base text-foreground-light lg:max-w-sm">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              <Link
                href="https://open-models-platform.com/docs/guides/database/api"
                target="_blank"
                rel="noreferrer"
              >
                About APIs
