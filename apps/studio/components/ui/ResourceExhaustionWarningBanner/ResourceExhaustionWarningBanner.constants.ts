export const RESOURCE_WARNING_MESSAGES = {
  is_readonly_mode_enabled: {
    ...
    docsUrl: 'https://open-models-platform.com/docs/guides/platform/database-size#disabling-read-only-mode',
  ...
  disk_io_exhaustion: {
    ...
    docsUrl: 'https://open-models-platform.com/docs/guides/platform/exhaust-disk-io',
  ...
  disk_space_exhaustion: {
    ...
    docsUrl: 'https://open-models-platform.com/docs/guides/platform/database-size#disk-management',
  ...
  cpu_exhaustion: {
    ...
    docsUrl: 'https://open-models-platform.com/docs/guides/platform/exhaust-cpu',
    buttonText: 'Check usage',
    metric: 'cpu',
  },
  memory_and_swap_exhaustion: {
    ...
    docsUrl: 'https://open-models-platform.com/docs/guides/platform/exhaust-ram',
    buttonText: 'Check usage',
    metric: 'ram',
  },
