...
const VercelIntegrationWindowLayout = ({ children }: PropsWithChildren<{}>) => {
  ...
  const title = externalId
    ? 'OpenModels + Vercel Deploy Button'
    : 'OpenModels + Vercel Integration Marketplace Connector'
  ...
  return (
    <IntegrationWindowLayout
      ...
      docsHref="https://open-models-platform.com/partners/integrations/vercel"
    >
      {children}
    </IntegrationWindowLayout>
  )
