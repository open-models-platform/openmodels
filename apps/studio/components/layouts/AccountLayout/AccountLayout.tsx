...
const AccountLayout = ({ children, title, breadcrumbs }: PropsWithChildren<AccountLayoutProps>) => {
      ...
      links: [
        {
          ...
          label: 'Guides',
          href: 'https://open-models-platform.com/docs',
          isExternal: true,
        },
        {
          key: 'ext-guides',
          ...
          label: 'API Reference',
          href: 'https://open-models-platform.com/docs/guides/api',
          isExternal: true,
        },
      ],
    },
  ...
  return (
    <>
      <Head>
        <title>{title ? `${title} | OpenModels` : 'OpenModels'}</title>
        <meta name="description" content="OpenModels Studio" />
      </Head>
