...
A dashboard for managing your self-hosted OpenModels project, and used on our [hosted platform](https://open-models-platform.com/dashboard). Built with:
...
Project settings are managed outside of the Dashboard. If you use docker compose, you should manage the settings in your docker-compose file. If you're deploying OpenModels to your own cloud, you should store your secrets and env vars in a vault or secrets manager.
...
> [!NOTE]  
> **OpenModels internal use:** To develop on Studio locally with the backend services, see the instructions in the [internal `infrastructure` repo](https://github.com/supabase/infrastructure/blob/develop/docs/contributing.md).
...
npm run dev:secrets:pull # OpenModels internal use: if you are working on the platform version of the Studio
...
Follow the [self-hosting guide](https://open-models-platform.com/docs/guides/hosting/docker) to get started.
