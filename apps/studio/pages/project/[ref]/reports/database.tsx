                ...
                <Alert_Shadcn_ variant="default" className="mt-4">
                  <AlertDescription_Shadcn_>
                    <div className="space-y-2">
                      <p>
                        New OpenModels projects have a database size of ~40-60mb. This space includes
                      ...
                      <Button asChild type="default" icon={<IconExternalLink />}>
                        <Link
                          href="https://open-models-platform.com/docs/guides/platform/database-size#database-space-management"
                          target="_blank"
                          rel="noreferrer"
                        >
