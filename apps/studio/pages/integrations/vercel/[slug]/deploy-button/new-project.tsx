        ...
        <ScaffoldColumn className="mx-auto w-full max-w-md">
          <header>
            ...
            <Markdown
              ...
              content={`Choose the OpenModels organization you wish to install in`}
            />
          </header>
          <CreateProject />
          <Alert withIcon variant="info" title="You can uninstall this Integration at any time.">
            <Markdown
              content={`You can remove this integration at any time via Vercel or the OpenModels dashboard.`}
            />
          </Alert>
        </ScaffoldColumn>
      </ScaffoldContainer>
...
const CreateProject = () => {
  ...
  return (
    <div className="">
      <p className="mb-2">OpenModels project details</p>
      <div className="py-2">
        <Input
          autoFocus
          id="projectName"
