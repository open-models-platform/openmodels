        ...
        <ScaffoldColumn className="!max-w-[900px] mx-auto w-full">
          <header>
            ...
            <Markdown
              ...
              content={`
This OpenModels integration manages your environment variables automatically to provide the latest keys in the unlikely event that you will need to refresh your JWT token.
`}
            />
          </header>
          <ProjectLinker
