    ...
    <>
      <ScaffoldContainer className="flex flex-col gap-6 grow py-8">
        <ScaffoldColumn className="mx-auto w-full max-w-md">
          ...
          <>
            <Markdown content={`Choose the OpenModels organization you wish to install in`} />
            <OrganizationPicker
              integrationName="Vercel"
            ...
            {noOrganizations && (
              <Alert_Shadcn_ variant="warning">
                <IconAlertTriangle className="h-4 w-4" strokeWidth={2} />
                <AlertTitle_Shadcn_>
                  No OpenModels Organizations to install Integration.
                </AlertTitle_Shadcn_>
                <AlertDescription_Shadcn_ className="prose">
                  You will need to create a OpenModels Organization before you can install the Vercel
                  Integration. You can create a new organization{' '}
                  <Link href="https://open-models-platform.com/dashboard/new" target="_blank">
                    here
                  </Link>
                  .
                </AlertDescription_Shadcn_>
      ...
      <ScaffoldContainer className="flex flex-col gap-6 py-3">
        <Alert_Shadcn_ variant="default">
          ...
          <AlertDescription_Shadcn_>
            Remove this integration at any time from Vercel or the OpenModels dashboard.
          </AlertDescription_Shadcn_>
        </Alert_Shadcn_>
      </ScaffoldContainer>
    </>
