          ...
          <ScaffoldContainer className="flex flex-col gap-6 grow py-8">
            <header>
              <h1 className="text-xl text-foreground">
                Link a OpenModels project to a GitHub repository
              </h1>
              <Markdown
                className="text-foreground-lighter"
                // explain what this integration does
                content={`
This OpenModels integration will allow you to link a OpenModels project to a GitHub repository. This will allow you to deploy your database schema to your OpenModels project.
`}
              />
            </header>
            <ProjectLinker
