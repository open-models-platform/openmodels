        ...
        <div className="space-y-12 py-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="m-0 text-lg">OpenModels support</h1>
            </div>
            <div className="flex items-center space-x-3">
              <Button asChild type="default" icon={<IconTool />}>
                <Link
                  href="https://open-models-platform.com/docs/guides/platform/troubleshooting"
                  target="_blank"
                  rel="noreferrer"
                >
                  Troubleshooting
              ...
              <Tooltip.Root delayDuration={0}>
                ...
                <Tooltip.Portal>
                  <Tooltip.Content side="bottom">
                    ...
                    >
                      <span className="text-xs text-foreground">Check OpenModels status page</span>
                    </div>
                  </Tooltip.Content>
                </Tooltip.Portal>
              </Tooltip.Root>
