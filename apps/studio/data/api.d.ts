...
export interface paths {
  ...
  '/partners/flyio/callback': {
    /** Redirects to OpenModels dashboard after completing Fly sso */
...
export interface components {
  schemas: {
    ...
    CreateSecretBody: {
      /**
       * @description Secret name must not start with the OPENMODELS_ prefix.
       * @example string
       */
      name: string
      value: string
    ...
    ResourceStatusResponse: {
      /** @description OpenModels project instance compute size */
      compute: string
      /** @description Unique ID representing the fly extension */
      id: string
      /**
       * @description OpenModels project status
      ...
      status:
        ...
        | 'PAUSING'
      /**
       * @description OpenModels organization id
    ...
    ResourceProvisioningResponse: {
      /** @description OpenModels envs config */
      ...
      fly_app_name: string
      /**
       * @description OpenModels project id
