...
const PROVIDER_EMAIL = {
  ...
  misc: {
    ...
    helper: `To complete setup, add this authorisation callback URL to your app's configuration in the Apple Developer Console.
            [Learn more](https://open-models-platform.com/docs/guides/auth/social-login/auth-apple#configure-your-services-id)`,
  },
}
...
[Learn more](https://open-models-platform.com/docs/guides/auth/social-login/auth-apple#generate-a-client_secret)`,
      type: 'string',
      isSecret: true,
    },
...
const EXTERNAL_PROVIDER_AZURE = {
  ...
  properties: {
    ...
    EXTERNAL_AZURE_SECRET: {
      // [TODO] Change docs
      title: 'Secret Value',
      description: `Enter the data from Value, not the Secret ID. [Learn more](https://open-models-platform.com/docs/guides/auth/social-login/auth-azure#obtain-a-secret-id)`,
      type: 'string',
      isSecret: true,
    },
    EXTERNAL_AZURE_URL: {
...
const EXTERNAL_PROVIDER_GOOGLE = {
  ...
  misc: {
    ...
    helper: `Register this callback URL when using Sign-in with Google on the web using OAuth.
            [Learn more](https://open-models-platform.com/docs/guides/auth/social-login/auth-google#configure-your-services-id)`,
  },
}
...
export const PROVIDER_SAML = {
  ...
  properties: {
    SAML_ENABLED: {
      ...
      description:
        'You will need to use the [OpenModels CLI](https://open-models-platform.com/docs/guides/auth/sso/auth-sso-saml#managing-saml-20-connections) to set up SAML after enabling it',
      type: 'boolean',
    },
  },
  validationSchema: object().shape({
