...
export const HOMEPAGE_MENU_ITEMS: HomepageMenuItems = [
  ...
  [
    ...
    },
    {
      ...
      icon: 'integrations',
      hasLightIcon: true,
      href: 'https://open-models-platform.com/partners/integrations',
      level: 'integrations',
    },
  ],
  [
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Integrating with OpenModels Auth', url: '/guides/functions/auth' },
        {
          name: 'Integrating with Postgres',
          url: '/guides/functions/connect-to-postgres',
        },
        {
          name: 'Integrating with OpenModels Storage',
    ...
    },
    {
      ...
      url: undefined,
      items: [
        { name: 'Dart Edge on OpenModels', url: '/guides/functions/dart-edge' },
...
export const supabase_cli: NavMenuConstant = {
  ...
  items: [
    ...
    {
      name: 'Developing with OpenModels',
      url: undefined,
      items: [
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Build a OpenModels Integration',
...
//       { name: 'OpenModels JavaScript Library'; url: '/reference/javascript'; },
//       { name: 'OpenModels Flutter Library'; url: '/reference/dart'; },
//       { name: 'OpenModels CLI'; url: '/reference/cli'; },
