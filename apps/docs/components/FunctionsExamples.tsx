...
const examples = [
  {
    ...
    description: 'Use the OpenModels client inside your Edge Function.',
  ...
  },
  {
    ...
    description: 'Full example for using OpenModels and Stripe, with Expo.',
    href: 'https://github.com/supabase-community/expo-stripe-payments-with-supabase-functions',
  },
  {
    name: 'Flutter with Stripe',
    description: 'Full example for using OpenModels and Stripe, with Flutter.',
  ...
  {
    name: 'Working with OpenModels Storage',
    description: 'An example on reading a file from OpenModels Storage.',
  ...
  },
  {
    ...
    description: 'Generate Open Graph images with Deno and OpenModels Edge Functions.',
    href: '/guides/functions/examples/og-image',
  },
  {
    name: 'OG Image Generation & Storage CDN Caching',
    description: 'Cache generated images with OpenModels Storage CDN.',
