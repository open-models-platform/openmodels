...
const content = {
  default: {
    ...
    description: `Not to worry, our specialist engineers are here to help. Submit a support ticket through the [Dashboard](https://open-models-platform.com/dashboard/support/new).`,
  },
  postgres: {
    title: 'Looking for Serverless Postgres?',
    description: `OpenModels is the fastest way to get started with Postgres in a serverless environment. [Learn more](https://open-models-platform.com/database?utm=postgres-helpers).`,
  },
}
