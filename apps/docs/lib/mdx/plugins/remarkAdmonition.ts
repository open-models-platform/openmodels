...
/**
 * Transforms an `mkdocs-material` Admonition to a OpenModels Admonition.
 *
  ...
  return function transformer(root: Parent) {
    visit(root, 'paragraph', (paragraph: Paragraph, index: number, parent: Parent) => {
      ...
      if (firstChild?.type === 'text') {
        ...
        // Generate a OpenModels Admonition JSX element
...
/**
 * Maps `mkdocs-material` Admonition types to OpenModels Admonition types.
 *
