...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
      ...
      Manage your OpenModels organizations and projects programmatically.
      ...
      All API requests require a OpenModels Personal token to be included in the Authorization header: `Authorization Bearer <supabase_personal_token`.
      To generate or manage your API token, visit your [account](https://open-models-platform.com/dashboard/account/tokens) page.
      ...
      All resources created via the API are subject to the pricing detailed on our [Pricing](https://open-models-platform.com/pricing) pages.
