...
#### Use a custom `access_token` JWT with OpenModels
...
For Next.js you can use the [Auth Helpers](https://open-models-platform.com/docs/guides/auth/auth-helpers/nextjs) to help you manage cookies.
If you can't use the Auth Helpers, you can use [server-side rendering](https://open-models-platform.com/docs/guides/auth/server-side-rendering).
