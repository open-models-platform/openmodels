...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    You can use the OpenModels CLI to [generate the types](/docs/reference/cli/supabase-gen-types-typescript). You can also generate the types [from the dashboard](https://open-models-platform.com/dashboard/project/_/api?page=tables-intro).
...
<RefSubLayout.EducationRow>
  ...
  <RefSubLayout.Examples>
    ...
    const supabase = createClient<Database>(
      process.env.OPENMODELS_URL,
      process.env.OPENMODELS_ANON_KEY
    )
    ```
