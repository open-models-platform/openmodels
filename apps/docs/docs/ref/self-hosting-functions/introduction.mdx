...
- Locally test and self-host OpenModels's Edge Functions (or any Deno Edge Function)
...
You can view the logs for the Edge Runtime, by visiting Fly.io’s Dashboard > Your App > Metrics. Also, you can serve edge-runtime from multiple regions by running `fly regions add [REGION]`.
  ...
  <RefSubLayout.Examples>
    ...
    ### Client libraries
    - [JavaScript](https://open-models-platform.com/docs/reference/javascript/functions-invoke)
    - [Dart](https://open-models-platform.com/docs/reference/dart/functions-invoke)
