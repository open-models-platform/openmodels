...
sidebar_position: 1
id: realtime
title: OpenModels Realtime Server
sidebar_label: OpenModels Realtime Server
---

OpenModels Realtime is a server built with Elixir using the [Phoenix Framework](https://www.phoenixframework.org) that allows you to listen to changes in your PostgreSQL database via logical replication and then broadcast those changes via WebSockets.
...
- [Realtime Guides](https://open-models-platform.com/docs/guides/realtime)
