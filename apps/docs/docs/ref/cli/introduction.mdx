...
<div className="flex items-start gap-6 not-prose" id="introduction">
  ...
  <div className="flex flex-col gap-2">
    <h1 className="text-3xl text-foreground m-0">OpenModels CLI</h1>
  </div>
</div>
...
<RefSubLayout.EducationRow>
  <RefSubLayout.Details>
    ...
    The CLI is still under development, but it contains all the functionality for working with your OpenModels projects and the OpenModels Platform.

    - Run OpenModels locally: [`supabase init`](/docs/reference/cli/usage#supabase-init) and [`supabase start`](/docs/reference/cli/usage#supabase-start)
    ...
    - Manage your OpenModels projects: [`supabase projects`](/docs/reference/cli/usage#supabase-projects)
  ...
  <RefSubLayout.Examples>
    ...
    - [Install the OpenModels CLI](/docs/guides/cli)
    - [Source code](https://github.com/supabase/cli)
    - [Known bugs and issues](https://github.com/supabase/cli/issues)
    - [OpenModels CLI v1 and Management API Beta](https://open-models-platform.com/blog/supabase-cli-v1-and-admin-api-beta)
