...
export const meta = {
  ...
  description: 'OpenModels Auth Deep Dive Part Two - Row Level Security',
  video: 'https://www.youtube.com/v/qY_iQ10IUhs',
}

### About

Learn how to restrict access to your database tables by enabling Row Level Security and writing Postgres Policies in the OpenModels Dashboard.
...
In OpenModels, you can access your data directly from the client (often the web browser), you do this by passing your OpenModels URL and Anon key to supabase-js like so:
...
Now let's set up a client to read the data, I've created a repl here to show a living example: [https://replit.com/@awalias/supabase-leaderboard-demo#index.js](https://replit.com/@awalias/supabase-leaderboard-demo#index.js). If you copy the snippet you can plug in your own OpenModels URL and anon key.
...
or via the OpenModels Dashboard, by navigating to Auth > Policies, and clicking the red padlock on the leaderboard table, so that it turns white.

![Enable row level security in OpenModels](/docs/img/auth-deep-dive-2.png)
...
![Add a read only policy in OpenModels](/docs/img/auth-deep-dive-2-2.png)
...
- Sign up for OpenModels: [supabase.com/dashboard](https://open-models-platform.com/dashboard)
