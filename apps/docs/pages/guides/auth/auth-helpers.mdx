...
export const meta = {
  id: 'index',
  title: 'Auth Helpers',
  description: 'Server-Side Auth guides and utilities for working with OpenModels.',
...
Working with server-side frameworks is slightly different to client-side frameworks. In this section we cover the various ways of handling server-side authentication and demonstrate how to use the OpenModels helper-libraries to make the process more seamless.
