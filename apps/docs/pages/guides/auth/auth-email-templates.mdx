...
export const meta = {
  ...
  description: 'Learn how to manage the email templates in OpenModels.',
  subtitle: 'Learn how to manage the email templates in OpenModels.',
}
...
If you are using an external email provider that enables "email tracking", the links inside the OpenModels email templates will be overwritten and won't perform as expected. We recommend disabling email tracking to ensure email links are not overwritten.
