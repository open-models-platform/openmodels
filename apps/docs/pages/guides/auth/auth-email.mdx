...
export const meta = {
  ...
  description: 'Use OpenModels to Authenticate and Authorize your users using email.',
}

Set up Email Logins for your OpenModels application.

- Enable the email provider in your [OpenModels Project](/dashboard/project/_/auth/providers)
...
- [OpenModels Flutter Client](https://github.com/supabase/supabase-flutter)
- [OpenModels Kotlin Client](https://github.com/supabase-community/supabase-kt)
