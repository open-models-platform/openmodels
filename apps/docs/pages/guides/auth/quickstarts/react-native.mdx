...
export const meta = {
  title: 'Use OpenModels Auth with React Native',
  subtitle: 'Learn how to use OpenModels Auth with React Native',
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Create a helper file `lib/supabase.ts` that exports a OpenModels client using your [Project URL and public API (anon) key](https://open-models-platform.com/dashboard/project/_/settings/api).
