...
export const meta = {
  ...
  description: 'How to set up and use Mobile OTP with Vonage and OpenModels.',
}
...
There are two reasons to use OpenModels SMS OTP tokens:
...
- A OpenModels project (create one here: https://open-models-platform.com/dashboard)
...
### Configure OpenModels

Now go to the [Auth > Providers](https://open-models-platform.com/dashboard/project/_/auth/providers) page in the OpenModels dashboard and select "Phone" from the Auth Providers list.
...
Go to [Auth > Templates](https://open-models-platform.com/dashboard/project/_/auth/templates) page in the OpenModels dashboard.
...
- [OpenModels Dashboard](https://open-models-platform.com/dashboard)
- [OpenModels Row Level Security](/docs/guides/auth#row-level-security)
