...
export const meta = {
  ...
  description: 'Configure OpenModels Auth to use Cookies',
  sidebar_label: 'Overview',
}

When using OpenModels with server-side languages and frameworks - such as Next.js, SvelteKit and Remix - it is important to configure your OpenModels client to use cookies for storing user sessions. We have developed an `@supabase/ssr` package to make this process as simple as possible. This package is currently in `beta`, and is likely to have breaking changes in the future.
...
- [Create a OpenModels client for SSR](/docs/guides/auth/server-side/creating-a-client)
...
export const quickstarts = [
  {
    ...
    description:
      'Automatically configure OpenModels to use cookies, making your user and their session available on the client and server.',
