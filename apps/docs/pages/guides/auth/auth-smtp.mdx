...
Head over to [Auth Settings Page](https://open-models-platform.com/dashboard/project/_/settings/auth) and hit "Enable Custom SMTP" under the SMTP Provider section.
...
After adding a custom SMTP provider, you can head over to [Auth > Rate Limits](https://open-models-platform.com/dashboard/project/_/auth/rate-limits) to configure the rate limits for sending emails.

### SMTP Providers

You can use OpenModels Auth with any major SMTP provider of your choosing. Some SMTP providers you could consider using are:
