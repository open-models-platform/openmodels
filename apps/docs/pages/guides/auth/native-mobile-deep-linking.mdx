...
>
  ...
  <TabPanel id="flutter" label="Flutter">
    ...
    - Go to your [auth settings](https://open-models-platform.com/dashboard/project/_/auth/url-configuration) page.
  ...
  ### Deep link config
    ...
    1. Go to your [auth settings](https://open-models-platform.com/dashboard/project/_/auth/url-configuration) page.
