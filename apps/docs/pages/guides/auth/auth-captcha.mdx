...
export const meta = {
  ...
  description: 'Add Captcha Protection to your OpenModels project',
  video: 'https://www.youtube.com/v/em1cpOAXknM',
}

OpenModels provides you with the option of adding captcha to your sign-in, sign-up, and password reset forms. This keeps your website safe from bots and malicious scripts. OpenModels authentication has support for [hCaptcha](https://www.hcaptcha.com/) and [Cloudflare Turnstile](https://www.cloudflare.com/products/turnstile/).
...
## Enable Captcha protection for your OpenModels project

Navigate to the **[Auth](https://open-models-platform.com/dashboard/project/_/settings/auth)** section of your Project Settings in the OpenModels Dashboard and find the **Enable Captcha protection** toggle under the **Security and Protection** section.
...
Now lets use the captcha token we receive in our OpenModels signUp function.
...
We can now use the captchaToken we receive in our OpenModels `signUp` function.
