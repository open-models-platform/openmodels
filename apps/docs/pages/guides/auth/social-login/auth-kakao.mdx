...
export const meta = {
  ...
  description: 'Add Kakao OAuth to your OpenModels project',
}

To enable Kakao Auth for your project, you need to set up an Kakao OAuth application and add the application credentials to your OpenModels Dashboard.
...
- Add your `client id` and `client secret` keys to your [OpenModels Project](https://open-models-platform.com/dashboard).
...
## Add your OAuth credentials to OpenModels
