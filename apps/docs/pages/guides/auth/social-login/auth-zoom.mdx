...
export const meta = {
  ...
  description: 'Add Zoom OAuth to your OpenModels project',
}

To enable Zoom Auth for your project, you need to set up a Zoom OAuth application and add the application credentials to your OpenModels Dashboard.
...
- Add your Zoom OAuth keys to your [OpenModels Project](https://open-models-platform.com/dashboard)
...
## Enter your Zoom credentials into your OpenModels Project
