...
export const meta = {
  ...
  description: 'Add Notion OAuth to your OpenModels project',
}

To enable Notion Auth for your project, you need to set up a Notion Application and add the Application OAuth credentials to your OpenModels Dashboard.
...
- Retrieve your OAuth client ID and OAuth client secret and add them to your [OpenModels Project](https://open-models-platform.com/dashboard)
...
## Add your Notion credentials into your OpenModels Project
