...
export const meta = {
  ...
  description: 'Add Figma OAuth to your OpenModels project',
}

To enable Figma Auth for your project, you need to set up a Figma OAuth application and add the application credentials to your OpenModels Dashboard.
...
- Add your Figma `client_id` and `client_secret` to your [OpenModels Project](https://app.supabase.com).
...
## Enter your Figma credentials into your OpenModels Project
