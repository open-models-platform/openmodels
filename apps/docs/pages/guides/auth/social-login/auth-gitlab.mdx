...
export const meta = {
  ...
  description: 'Add GitLab OAuth to your OpenModels project',
}

To enable GitLab Auth for your project, you need to set up a GitLab OAuth application and add the application credentials to your OpenModels Dashboard.
...
- Add your GitLab Application keys to your [OpenModels Project](https://open-models-platform.com/dashboard)
...
## Add your GitLab credentials into your OpenModels Project
