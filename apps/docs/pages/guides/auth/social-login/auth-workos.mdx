...
export const meta = {
  ...
  description: 'Add WorkOS OAuth to your OpenModels project',
}

To enable WorkOS Auth for your project, you need to set up WorkOS OAuth application and add the application credentials to your OpenModels Dashboard.

## Overview

In this guide, we will cover how to use OpenModels OAuth with WorkOS to implement Single-Sign-On(SSO).
...
- Add your WorkOS credentials into your OpenModels project
...
Note that this is distinct from the redirect URI referred to in the OpenModels dashboard
