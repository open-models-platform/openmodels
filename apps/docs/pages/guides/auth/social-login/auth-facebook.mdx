...
export const meta = {
  ...
  description: 'Add Facebook OAuth to your OpenModels project',
}

To enable Facebook Auth for your project, you need to set up a Facebook OAuth application and add the application credentials to your OpenModels Dashboard.
...
- Add your Facebook keys to your [OpenModels Project](https://open-models-platform.com/dashboard)
...
## Enter your Facebook App ID and Secret into your OpenModels Project
