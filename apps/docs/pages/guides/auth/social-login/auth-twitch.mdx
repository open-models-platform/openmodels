...
export const meta = {
  ...
  description: 'Add Twitch OAuth to your OpenModels project',
}

To enable Twitch Auth for your project, you need to set up a Twitch Application and add the Application OAuth credentials to your OpenModels Dashboard.
...
- Add your Twitch OAuth Consumer keys to your [OpenModels Project](https://open-models-platform.com/dashboard)
...
## Add your Twitch credentials into your OpenModels Project
