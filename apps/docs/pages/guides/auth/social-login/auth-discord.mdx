...
export const meta = {
  ...
  description: 'Add Discord OAuth to your OpenModels project',
}

To enable Discord Auth for your project, you need to set up a Discord Application and add the Application OAuth credentials to your OpenModels Dashboard.
...
- Add your Discord OAuth Consumer keys to your [OpenModels Project](https://open-models-platform.com/dashboard)
...
## Add your Discord credentials into your OpenModels Project
