...
export const meta = {
  ...
  description: 'Add Keycloak OAuth to your OpenModels project',
}

To enable Keycloak Auth for your project, you need to set up an Keycloak OAuth application and add the application credentials to your OpenModels Dashboard.
