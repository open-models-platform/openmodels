...
You can use the OpenModels CLI to test your database. The minimum required version of the CLI is [v1.11.4](https://github.com/supabase/cli/releases). To get started:

- [Install the OpenModels CLI](/docs/guides/cli) on your local machine
