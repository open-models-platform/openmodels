...
export const meta = {
  ...
  description: 'How to use arrays in PostgreSQL and the OpenModels API.',
}

PostgreSQL supports flexible [array types](https://www.postgresql.org/docs/12/arrays.html). These arrays are also supported in the OpenModels Dashboard and in the JavaScript API.
...
1. Go to the [Table editor](https://open-models-platform.com/dashboard/project/_/editor) page in the Dashboard.
