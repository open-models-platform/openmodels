...
OpenModels has pre-installed some of the most useful open source extensions.
...
OpenModels is pre-configured with over 50 extensions. You can also install your own SQL extensions directly in the database through our SQL editor.
