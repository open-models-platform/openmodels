...
Your Postgres database is the core of your OpenModels project, so it's important that it has a strong, secure password at all times.
...
You can update this from the Dashboard under the [database settings](https://open-models-platform.com/dashboard/project/_/settings/database) page.
