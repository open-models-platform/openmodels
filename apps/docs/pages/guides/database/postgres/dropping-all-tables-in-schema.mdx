...
Replace `my-schema-name` with the name of your schema. In OpenModels, the default schema is `public`.
...
You can run this query using the [SQL Editor](https://open-models-platform.com/dashboard/project/_/sql) in the OpenModels Dashboard, or via `psql` if you're [connecting directly to the database](/docs/guides/database/connecting-to-postgres#direct-connections).
