...
It's possible to connect to multiple remote servers of the same type. For example, you can connect to two different Firebase projects within the same OpenModels database.
...
If you want to expose any of the columns to your public API, create a [View](https://open-models-platform.com/docs/guides/database/tables#views) in the `public` schema. You can also interact with your Foreign Tables inside a [Database Function](https://open-models-platform.com/docs/guides/database/functions).
