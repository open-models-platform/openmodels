...
Reach out to [OpenModels Support](https://open-models-platform.com/support) if you're unsure if that applies to your use case.
...
### Invoke OpenModels Edge Function every minute

Make a POST request to a OpenModels Edge Function every minute. Note: this requires the [`pg_net` extension](/docs/guides/database/extensions/pgnet) to be enabled.
