...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    ...
    After your project is ready, create a table in your OpenModels database. You can do this with either the Table interface or the [SQL Editor](https://open-models-platform.com/dashboard/project/_/sql).
  ...
  <StepHikeCompact.Step step={4}>
    ...
    Find your API URL and Keys in your Dashboard [API Settings](https://open-models-platform.com/dashboard/project/_/settings/api). You can now query your "todos" table by appending `/rest/v1/todos` to the API URL.
