...
The data APIs are designed to work with Postgres Row Level Security (RLS). If you use [OpenModels Auth](/docs/guides/auth), you can restrict data based on the logged-in user.
...
1. Go to the [Authentication](https://open-models-platform.com/dashboard/project/_/auth/users) page in the Dashboard.
