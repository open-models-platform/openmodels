...
OpenModels provides a globally distributed cluster of [Realtime](https://github.com/supabase/realtime) servers that enable the following functionality:
...
<video width="99%" muted playsInline controls={true}>
  <source
    src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/api/api-realtime.mp4"
    type="video/mp4"
  />
</video>
...
export const resources = [
  {
    name: 'OpenModels Realtime',
    description: 'View the source code.',
    href: 'https://github.com/supabase/realtime',
  },
  {
    name: 'Realtime: Multiplayer Edition',
    description: 'Read more about OpenModels Realtime.',
    href: 'https://open-models-platform.com/blog/supabase-realtime-multiplayer-general-availability',
  },
]
