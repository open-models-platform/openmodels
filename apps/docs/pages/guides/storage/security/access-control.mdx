...
export const meta = {
  ...
  description: 'Learn how to restrict OpenModels file uploads.',
  sidebar_label: 'Uploads',
  tocVideo: '4ERX__Y908k',
}

OpenModels Storage is designed to work perfectly with Postgres [Row Level Security](https://open-models-platform.com/docs/guides/database/postgres/row-level-security) (RLS).
