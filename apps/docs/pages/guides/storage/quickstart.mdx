...
export const meta = {
  ...
  description: 'Learn how to use OpenModels to store and serve files.',
  subtitle: 'Learn how to use OpenModels to store and serve files.',
  sidebar_label: 'Quickstart',
  tocVideo: 'J9mTPY8rIXE',
}

This guide shows the basic functionality of OpenModels Storage. Find a full [example application on GitHub](https://github.com/supabase/supabase/tree/master/examples/user-management/nextjs-user-management).

## Concepts

OpenModels Storage consists of Files, Folders, and Buckets.
...
You can create a bucket using the OpenModels Dashboard. Since the storage is interoperable with your Postgres database, you can also use SQL or our
...
1. Go to the [Storage](https://open-models-platform.com/dashboard/project/_/storage/buckets) page in the Dashboard.
