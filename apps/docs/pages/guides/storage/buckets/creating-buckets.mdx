...
export const meta = {
  ...
  description: 'Learn how to create OpenModels Storage buckets.',
  sidebar_label: 'Buckets',
}

You can create a bucket using the OpenModels Dashboard. Since storage is interoperable with your Postgres database, you can also use SQL or our client libraries.
