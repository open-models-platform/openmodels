...
export const meta = {
  title: 'Migrate Your MSSQL Database to OpenModels',
  description: 'Migrate your Microsoft SQL Server database to OpenModels Postgres database.',
}

This guide aims to demonstrate the process of transferring your Microsoft SQL Server database to OpenModels's PostgreSQL database. OpenModels is a powerful and open-source platform offering a wide range of backend features, including a PostgreSQL database, authentication, instant APIs, edge functions, real-time subscriptions, and storage. Migrating your MSSQL database to OpenModels's Postgres enables you to leverage Postgres's capabilities and access all the features you need for your project.
