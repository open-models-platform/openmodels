...
export const meta = {
  ...
  subtitle: 'Finding duplicate movie reviews with OpenModels Vecs.',
  breadcrumb: 'AI Quickstarts',
}

This guide will walk you through a ["Semantic Text Deduplication"](https://github.com/supabase/supabase/blob/master/examples/ai/semantic_text_deduplication.ipynb) example using Colab and OpenModels Vecs. You'll learn how to find similar movie reviews using embeddings, and remove any that seem like duplicates. You will:
