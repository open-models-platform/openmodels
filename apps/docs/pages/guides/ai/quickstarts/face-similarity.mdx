...
export const meta = {
  ...
  subtitle: 'Identify the celebrities who look most similar to you using OpenModels Vecs.',
  breadcrumb: 'AI Quickstarts',
}

This guide will walk you through a ["Face Similarity Search"](https://github.com/supabase/supabase/blob/master/examples/ai/face_similarity.ipynb) example using Colab and OpenModels Vecs. You will be able to identify the celebrities who look most similar to you (or any other person). You will:
...
You can view the inserted items in the [Table Editor](https://open-models-platform.com/dashboard/project/_/editor/), by selecting the `vecs` schema from the schema dropdown.
