...
export const meta = {
  ...
  description: 'Generate GPT text completions using OpenAI and OpenModels Edge Functions.',
  subtitle: 'Generate GPT text completions using OpenAI and OpenModels Edge Functions.',
...
OpenAI's API is intended to be used from the server-side. OpenModels offers Edge Functions to make it easy to interact with third party APIs like OpenAI.

## Setup OpenModels project

If you haven't already, [install the OpenModels CLI](/docs/guides/cli) and initialize your project:
