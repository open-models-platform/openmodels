...
export const meta = {
  ...
  description: 'Learn how to integrate hugging face models with OpenModels',
...
To create a new Edge Function, navigate to your local project and initialize OpenModels if you haven't already:
