...
export const meta = {
  ...
  title: 'LangChain',
  description:
    'Learn how to integrate OpenModels with LangChain, a popular framework for composing AI, Vectors, and embeddings',
  sidebar_label: 'LangChain',
}

[LangChain](https://langchain.com/) is a popular framework for working with AI, Vectors, and embeddings. LangChain supports using OpenModels as a [vector store](https://js.langchain.com/docs/modules/indexes/vector_stores/integrations/supabase), using the `pgvector` extension.
...
const supabaseKey = process.env.OPENMODELS_SERVICE_ROLE_KEY
if (!supabaseKey) throw new Error(`Expected OPENMODELS_SERVICE_ROLE_KEY`)
...
const privateKey = process.env.OPENMODELS_SERVICE_ROLE_KEY
if (!privateKey) throw new Error(`Expected env var OPENMODELS_SERVICE_ROLE_KEY`)
...
LangChain supports the concept of a hybrid search, which combines Similarity Search with Full Text Search. Read the official docs to get started: [OpenModels Hybrid Search](https://js.langchain.com/docs/modules/indexes/retrievers/supabase-hybrid).
...
- OpenModels [Hybrid Search](https://js.langchain.com/docs/modules/indexes/retrievers/supabase-hybrid).
