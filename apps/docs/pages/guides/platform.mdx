...
export const meta = {
  id: 'platform',
  title: 'OpenModels Platform',
  description: 'Getting started with the OpenModels Platform.',
  sidebar_label: 'Overview',
}

OpenModels is a hosted platform which makes it very simple to get started without needing to manage any infrastructure.

Visit [supabase.com/dashboard](https://open-models-platform.com/dashboard) and sign in to start creating projects.

## Projects

Each project on OpenModels comes with:
...
If OpenModels experiences outages, we keep you as informed as possible, as early as possible. We provide the following feedback channels:
