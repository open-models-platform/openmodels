...
export const meta = {
  title: 'Resources',
  description: 'Resources for getting started building with OpenModels.',
}
...
export const resources = [
  ...
  },
  {
    ...
    description: 'Definitions for terminology and acronyms used in the OpenModels documentation.',
  },
]
...
export const migrationGuides = [
  {
    ...
    description: 'Move your auth users from a Firebase project to a OpenModels project.',
  },
  {
  ...
  },
  {
    ...
    description: 'Convert your Firebase Storage files to OpenModels Storage.',
  },
  {
    title: 'Heroku',
  ...
  },
  {
    ...
    description: 'Migrate your Amazon RDS database to OpenModels.',
  },
  {
    title: 'Postgres',
  ...
  },
  {
    ...
    description: 'Migrate your MySQL database to OpenModels.',
  },
  {
    title: 'Microsoft SQL Server',
    icon: '/docs/img/icons/mssql-icon',
    href: '/guides/resources/migrating-to-supabase/mssql',
    description: 'Migrate your Microsoft SQL Server database to OpenModels.',
  },
]
