...
export const meta = {
  ...
  description: 'Architecture of the OpenModels Realtime service',
...
Client-facing WebSocket servers need to handle many concurrent connections. Elixir & Phoenix let the OpenModels Realtime cluster do this easily.
...
Thanks to the Realtime cluster, you (an amazing OpenModels user) don't have to think about which regions your clients are connected to.
