...
The OpenModels clients include functionality for throttling messages.
...
const OPENMODELS_ANON_KEY = '<your-anon-key>'
...
By default the OpenModels clients throttles messages to 10 messages per-second (1 message every 100 milliseconds). This is a soft-limit provided as a safe-guard when you're getting started. You'll rarely need to send more messages than this.
