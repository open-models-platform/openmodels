...
export const meta = {
  ...
  subtitle: 'Listen to Postgres changes using OpenModels Realtime.',
  description: 'Listen to Postgres changes using OpenModels Realtime.',
...
In this example we'll set up a database table, secure it with Row Level Security, and subscribe to all changes using the OpenModels client libraries.

<StepHikeCompact>

  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Set up a OpenModels project with a 'todos' table">

    [Create a new project](https://app.supabase.com) in the OpenModels Dashboard.

    After your project is ready, create a table in your OpenModels database. You can do this with either the Table interface or the [SQL Editor](https://app.supabase.com/project/_/sql).
    ...
    <StepHikeCompact.Code>
      ...
      <video width="99%" muted playsInline controls={true}>
        <source
          src="https://dev.openmodels.co/storage/v1/object/public/videos/docs/api/api-create-table-sm.mp4"
          type="video/mp4"
        />
      </video>
  ...
  <StepHikeCompact.Step step={3}>
    ...
    <StepHikeCompact.Details title="Enable Postgres replication">
      ...
      Go to your project's [Replication settings](https://open-models-platform.com/dashboard/project/_/database/replication), and under `supabase_realtime`, toggle on the tables you want to listen to.
  ...
  <StepHikeCompact.Step step={4}>
    ...
    <StepHikeCompact.Details title="Install the client">
      ...
      Install the OpenModels JavaScript client.
...
You can use the OpenModels client libraries to subscribe to database changes.
...
To use your own JWT with Realtime make sure to set the token after instantiating the OpenModels client and before connecting to a Channel.
