...
After setting up your database for Realtime, [submit a support ticket](https://open-models-platform.com/dashboard/support/new) if you want to use your database with hosted OpenModels Realtime.
