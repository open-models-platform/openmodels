...
export const meta = {
  ...
  description: 'Learn about channels and other features in OpenModels Realtime',
  subtitle: 'Learn about channels and other features in OpenModels Realtime',
  sidebar_label: 'Concepts',
}

You can use OpenModels Realtime to build real-time applications with collaborative/multiplayer functionality. It includes 3 core features:
...
When you initialize your OpenModels Realtime client, you define a `topic` that uniquely references a channel. Clients can bi-directionally send and receive messages over a Channel.
...
Channels provide a generic networking solution. OpenModels Realtime is designed to leverage this networking primitive with "extensions". We currently support one extension: Postgres changes.
