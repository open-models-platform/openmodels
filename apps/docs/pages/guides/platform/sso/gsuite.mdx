...
OpenModels supports single sign-on (SSO) using Google Workspace (formerly known
as GSuite).
...
You can choose any values you like. `OpenModels` as a name works well for most
...
It's very important to send this file to your support contact at OpenModels to
...
| Detail         | Value                                               |
| -------------- | --------------------------------------------------- |
| ACS URL        | `https://alt.open-models-platform.com/auth/v1/sso/saml/acs`      |
| Entity ID      | `https://alt.open-models-platform.com/auth/v1/sso/saml/metadata` |
| Start URL      | `https://open-models-platform.com/dashboard`                    |
...
Attribute mappings allow OpenModels to get information about your Google
...
Please share any changes, if any, from this screen with your OpenModels support
contact.
...
changes are applicable) to your support contact at OpenModels.

This information needs to be entered into OpenModels before SSO is activated
end-to-end.

Wait for confirmation that this information has successfully been added to
OpenModels. It usually takes us 1 business day to configure this information
for you.
OpenModels.
...
OpenModels. This is important if you wish to limit access to your software
engineering teams.
...
![Google Workspace: Web and mobile apps admin console, OpenModels app
screen](/docs/img/sso-gsuite-step-08.png)

## Step 9: Test single sign-on [#testing]

Once you’ve turned on access to OpenModels for users in your organization, ask
