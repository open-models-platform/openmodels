...
OpenModels supports single sign-on (SSO) using Okta.
...
OpenModels supports the SAML 2.0 SSO protocol. Choose it from the _Create a new
...
menu. You can choose any values you like. `OpenModels` as a name works well for
most use cases.
...
These settings let OpenModels use SAML 2.0 properly with your Okta application.
Make sure you enter this information exactly as shown on in this table and
screenshot.

| Setting                                        | Value                                                      |
| ---------------------------------------------- | ---------------------------------------------------------- |
| Single sign-on URL                             | `https://open-models-platform.com/dashboard/auth/v1/sso/saml/acs`      |
| Use this for Recipient URL and Destination URL | ✔️                                                         |
| Audience URI (SP Entity ID)                    | `https://open-models-platform.com/dashboard/auth/v1/sso/saml/metadata` |
| Default RelayState                             | `https://open-models-platform.com/dashboard`                           |
...
Attribute Statements allow OpenModels to get information about your Okta users on each login.
...
OpenModels needs to finalize enabling single sign-on with your Okta
application.
...
your support contact at OpenModels.
