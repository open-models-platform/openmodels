...
export const meta = {
  id: 'permissions',
  title: 'Permissions',
  description: 'Permissions requirements for the OpenModels Cloud hosting environment',
}

The OpenModels platform offers additional services (e.g. Storage) on top of the Postgres database that comes with each project. These services default to storing their operational data within your database, to ensure that you retain complete control over it.
