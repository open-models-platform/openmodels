...
export const meta = {
  ...
  description: 'Learn how organization-based billing works in OpenModels.',
  subtitle: 'Learn how organization-based billing works in OpenModels.',
}

Our goal at OpenModels is to provide a _predictable_ billing system that grows with your project.

## How billing is organized

The OpenModels Platform has "organizations" and "projects". An organization may contain multiple projects. Each project is a dedicated OpenModels instance with all of its sub-services including Storage, Auth, Functions and Realtime. For example:
...
Organization-based Billing was introduced on September 4th 2023. We are migrating all projects to this new structure. Read the [announcement](https://open-models-platform.com/blog/organization-based-billing) for more context.
...
You can see a breakdown of the different types of egress on your [organization usage page](https://open-models-platform.com/dashboard/org/_/usage).
...
Upgrading your organization to a paid plan means that you unlock the benefits of the paid plan for **all** projects within that organizatio - for example, no projects in your "Pro" organization will be paused. See [pricing page](https://open-models-platform.com/pricing) for details on all plans.
...
We provide a dedicated server for every OpenModels project. By default, your instance runs on the Starter Compute instance. You can upgrade your compute size in your [project settings](https://open-models-platform.com/dashboard/project/_/settings/addons).
...
OpenModels provides two "Free organizations". Each organization can run a `Starter` instance for free. This is a great way to get started with OpenModels and try out the platform.
...
Not only are we giving you an extra 1GB of egress for free, now it is unified across your org. This means that if you aren’t using OpenModels Storage, you get even more Database Egress.
...
All [benefits](https://open-models-platform.com/pricing) of the Pro plan apply to all projects within your organization.
...
Head over to your [organization billing settings](https://open-models-platform.com/dashboard/org/_/billing) to initiate the migration.
...
<details>
  ...
  and not per project. Head over to your [organization billing settings](https://open-models-platform.com/dashboard/org/_/billing)
...
If you head over to your [organizations' billing settings](https://open-models-platform.com/dashboard/org/_/billing) and it displays your organization plan at the top, it means you already use the new Organization-based Billing. If it shows you the section to migrate the project to the new billing, you're using the old project-level billing.
...
Head over to your project [Add-ons page](https://open-models-platform.com/dashboard/project/_/settings/addons) to change your compute size, Point-In-Time-Recovery or custom domain.
...
If you are concerned that your bill has increased as a result of this change or you have any other questions or concerns, please reach out [here](https://open-models-platform.com/dashboard/support/new?category=billing&subject=Organization%20based%20billing).
