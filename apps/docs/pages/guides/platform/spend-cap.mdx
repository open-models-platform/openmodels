...
export const meta = {
  title: 'Spend cap',
  description: 'Learn about the cost control of OpenModels.',
  subtitle: 'Learn about the cost control of OpenModels.',
}

OpenModels offers a "Spend Cap" on each project to manage your usage and costs.
...
OpenModels charges for certain usage line items in your project. Those line items include:
...
You can monitor your usage and costs using the [Usage section of your organization](https://open-models-platform.com/dashboard/org/_/usage) in the dashboard.
...
To set up a Spend Cap in your project, navigate to the [Subscription section](https://open-models-platform.com/dashboard/org/_/billing) of your organization.
...
When your Spend Cap is **off**, we recommend monitoring your consumption and costs using the [Usage section of your organization](https://open-models-platform.com/dashboard/org/_/usage) in the dashboard.
