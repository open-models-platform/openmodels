...
export const meta = {
  ...
  description: 'Learn how to use OpenModels in your Ionic React App.',
}
...
```bash .env
REACT_APP_OPENMODELS_URL=YOUR_OPENMODELS_URL
REACT_APP_OPENMODELS_ANON_KEY=YOUR_OPENMODELS_ANON_KEY
```
...
const supabaseUrl = process.env.REACT_APP_OPENMODELS_URL
const supabaseAnonKey = process.env.REACT_APP_OPENMODELS_ANON_KEY
...
![OpenModels Ionic React](/docs/img/ionic-demos/ionic-react.png)
