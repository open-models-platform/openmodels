...
export const meta = {
  ...
  description: 'Learn how to use OpenModels in your Nuxt 3 App.',
}
...
Amazing thing about [NuxtSupabase](https://supabase.nuxtjs.org/) is that setting environment variables is all we need to do in order to start using OpenModels.
No need to initialize OpenModels. The library will take care of it automatically.
...
<template>
  <form class="row flex-center flex" @submit.prevent="handleLogin">
    <div class="col-6 form-widget">
      <h1 class="header">OpenModels + Nuxt 3</h1>
...
To access the user information, use the composable [useSupabaseUser](https://supabase.nuxtjs.org/usage/composables/use-supabase-user) provided by the OpenModels Nuxt module.
...
![OpenModels Nuxt 3](/docs/img/supabase-vue-3-demo.png)
...
That is it! You should now be able to upload a profile photo to OpenModels Storage and you have a fully functional application.
