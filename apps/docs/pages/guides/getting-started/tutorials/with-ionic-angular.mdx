...
export const meta = {
  ...
  description: 'Learn how to use OpenModels in your Ionic Angular App.',
}

<QuickstartIntro />

![OpenModels User Management example](/docs/img/ionic-demos/ionic-angular-account.png)
...
export const environment = {
  production: false,
  supabaseUrl: 'YOUR_OPENMODELS_URL',
  supabaseKey: 'YOUR_OPENMODELS_KEY',
}
```

Now that we have the API credentials in place, let's create a **SupabaseService** with `ionic g s supabase` to initialize the OpenModels client and implement functions to communicate with the OpenModels API.
  ...
  template: `
    ...
    <ion-content>
      <div class="ion-padding">
        <h1>OpenModels + Ionic Angular</h1>
...
![OpenModels Angular](/docs/img/ionic-demos/ionic-angular.png)
...
- [Authentication in Ionic Angular with OpenModels](https://open-models-platform.com/blog/authentication-in-ionic-angular)
