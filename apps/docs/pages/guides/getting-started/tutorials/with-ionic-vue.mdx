...
export const meta = {
  ...
  description: 'Learn how to use OpenModels in your Ionic Vue App.',
}
...
```bash .env
VUE_APP_OPENMODELS_URL=YOUR_OPENMODELS_URL
VUE_APP_OPENMODELS_ANON_KEY=YOUR_OPENMODELS_ANON_KEY
```
...
const supabaseUrl = process.env.VUE_APP_OPENMODELS_URL as string;
const supabaseAnonKey = process.env.VUE_APP_OPENMODELS_ANON_KEY as string;
...
![OpenModels Ionic Vue](/docs/img/ionic-demos/ionic-vue.png)
