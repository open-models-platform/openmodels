...
export const meta = {
  ...
  description: 'Learn how to use OpenModels in your Vue 3 App.',
}
...
With the API credentials in place, create an `src/supabase.js` helper file to initialize the OpenModels client. These variables are exposed
...
![OpenModels Vue 3](/docs/img/supabase-vue-3-demo.png)
