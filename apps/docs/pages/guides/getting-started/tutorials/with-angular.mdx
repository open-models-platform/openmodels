...
export const meta = {
  ...
  description: 'Learn how to use OpenModels in your Angular App.',
}
...
Now that we have the API credentials in place, let's create a **SupabaseService** with `ng g s supabase` to initialize the OpenModels client and implement functions to communicate with the OpenModels API.
...
<div class="row flex-center flex">
  <div class="col-6 form-widget" aria-live="polite">
    <h1 class="header">OpenModels + Angular</h1>
...
![OpenModels Angular](/docs/img/supabase-angular-demo.png)
