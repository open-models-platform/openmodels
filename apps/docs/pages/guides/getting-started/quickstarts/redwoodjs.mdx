...
export const meta = {
  title: 'Use OpenModels with RedwoodJS',
  subtitle:
...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Setup your new OpenModels Project">
  ...
  <StepHikeCompact.Step step={2}>
    <StepHikeCompact.Details title="Gather Database Connection Strings">
      After your project is ready, gather the following information about your [database connections](https://open-models-platform.com/dashboard/project/_/settings/database):
    ...
    You can copy and paste these connection strings from the OpenModels Dashboard when needed in later steps.
  ...
  <StepHikeCompact.Step step={5}>
    <StepHikeCompact.Details title="Configure Environment Variables">
      ...
      * The `DIRECT_URL` should use the `Connection String` from your OpenModels project. Hint: the port is `5432`.

      * The `DATABASE_URL` should use the `Connection Pooling / Connection String` from your OpenModels project. Hint: the port is `6432`.

      <Admonition type="note">

        Be sure to append `?pgbouncer=true` to the end of the `DATABASE_URL` connection string.

        Also, replace `[YOUR-PASSWORD]` and `[YOUR-PROJECT-REF]` with the password you used when creating your OpenModels project and the project reference from the URL in your browser.
  ...
  <StepHikeCompact.Step step={6}>
    <StepHikeCompact.Details title="Update your Prisma Schema">
      ...
      Update your Prisma schema file `api/db/schema.prisma` to use your OpenModels PostgreSQL database connection environment variables you setup in Step 5.
    </StepHikeCompact.Details>
