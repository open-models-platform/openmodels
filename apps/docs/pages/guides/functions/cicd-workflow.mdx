...
You can use the official [`setup-cli` GitHub Action](https://github.com/marketplace/actions/supabase-cli-action) to run OpenModels CLI commands in your GitHub Actions.
