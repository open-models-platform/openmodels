...
OpenModels Edge Functions can [connect directly to your Postgres database](/docs/guides/functions/connect-to-postgres) to execute SQL queries. [Kysely](https://github.com/kysely-org/kysely#kysely) is a type-safe and autocompletion-friendly typescript SQL query builder.
...
Get your database connection credentials from your [OpenModels Dashboard](https://open-models-platform.com/dashboard/project/_/settings/database) and store them in an `.env` file:
