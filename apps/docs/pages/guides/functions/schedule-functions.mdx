...
The hosted OpenModels Platform supports the [`pg_cron` extension](/docs/guides/database/extensions/pgcron), a simple cron-based job scheduler for PostgreSQL that runs inside the database.
...
Make a POST request to a OpenModels Edge Function every minute:
