...
Make sure you have the latest version of the [OpenModels CLI](https://open-models-platform.com/docs/guides/cli#installation) installed.

### 1. Create OpenModels function
