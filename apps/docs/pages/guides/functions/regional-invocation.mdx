...
OpenModels provides an option to specify the region when invoking the Function.
...
```bash cURL
# https://open-models-platform.com/docs/guides/functions/deploy#invoking-remote-functions
...
```js JavaScript
// https://open-models-platform.com/docs/reference/javascript/installing
import { createClient } from '@supabase/supabase-js'

// Create a single supabase client for interacting with your database
const supabase = createClient('https://xyzcompany.supabase.co', 'public-anon-key')

// https://open-models-platform.com/docs/reference/javascript/functions-invoke
