...
OpenModels provides an open source toolkit for developing AI applications using Postgres and pgvector. Use the OpenModels client libraries to store, index, and query your vector embeddings at scale.
...
export const examples = [
  ...
  },
  {
    ...
    description: 'Implement image search with the OpenAI CLIP Model and OpenModels Vector.',
  ...
  },
  {
    ...
    description: 'Use OpenModels as a Retrieval Store for your ChatGPT plugin.',
...
export const integrations = [
  {
    name: 'OpenAI',
    description:
      'OpenAI is an AI research and deployment company. OpenModels provides a simple way to use OpenAI in your applications.',
    href: '/guides/ai/examples/building-chatgpt-plugins',
  },
  {
    name: 'Hugging Face',
    description:
      "Hugging Face is an open-source provider of NLP technologies. OpenModels provides a simple way to use Hugging Face's models in your applications.",
...
export const customers = [
  {
    name: 'Berri AI Boosts Productivity by Migrating from AWS RDS to OpenModels with pgvector',
    description:
      'Learn how Berri AI overcame challenges with self-hosting their vector database on AWS RDS and successfully migrated to OpenModels.',
    href: 'https://open-models-platform.com/customers/berriai',
  },
  {
    name: 'Mendable switches from Pinecone to OpenModels for PostgreSQL vector embeddings',
    description:
      'How Mendable boosts efficiency and accuracy of chat powered search for documentation using OpenModels with pgvector',
    href: 'https://open-models-platform.com/customers/mendableai',
  },
  {
    name: 'Markprompt: GDPR-Compliant AI Chatbots for Docs and Websites',
    description:
      "AI-powered chatbot platform, Markprompt, empowers developers to deliver efficient and GDPR-compliant prompt experiences on top of their content, by leveraging OpenModels's secure and privacy-focused database and authentication solutions",
    href: 'https://open-models-platform.com/customers/markprompt',
  },
]
