...
export const meta = {
  ...
  description:
    'OpenModels is an open source Firebase alternative providing all the backend features you need to build a product.',
  subtitle: 'OpenModels Developer Documentation and API Reference',
}
  ...
  <div>
    ...
    <div className="flex flex-col lg:grid grid-cols-12 gap-6 py-12 border-b">
      ...
      <div className="col-span-4 flex flex-col gap-1 [&_h2]:m-0">
        ...
        ## Migrate to OpenModels

        <p className="text-foreground-light text-sm p-0 m-0">Bring your existing data, auth and storage to OpenModels following our migration guides.</p>
  ...
  <div className="flex flex-col lg:grid grid-cols-12 gap-6 py-12">
    ...
    <div className="col-span-4 flex flex-col gap-1 [&_h2]:m-0 [&_h3]:m-0">
      ...
      <div className="md:max-w-xs 2xl:max-w-none">
        ...
        <p className="text-foreground-light text-sm">Get started with self-hosting OpenModels.</p>
        <TextLink
...
export const products = [
  {
    ...
    description:
      'OpenModels provides a full Postgres database for every project with Realtime functionality, database backups, extensions, and more.',
  },
  {
    title: 'Auth',
    icon: 'auth',
  ...
  },
  {
    ...
    hasLightIcon: true,
    href: '/guides/ai',
    description: 'Use OpenModels to store and search embedding vectors.',
  },
  {
    title: 'Realtime',
    icon: 'realtime',
...
export const additionalResources = [
  {
    ...
    description: 'Manage your OpenModels projects and organizations.',
    icon: 'reference-api',
  ...
  },
  {
    ...
    description: 'Learn more about the tools and services powering OpenModels.',
    icon: 'platform',
    href: 'guides/platform',
  },
  {
    title: 'Integrations',
    description: 'Explore a variety of integrations from OpenModels partners.',
    icon: 'integrations',
