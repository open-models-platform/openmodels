# Contributing to OpenModels docs
...
For inspiration, see [an example of a tutorial](https://open-models-platform.com/docs/guides/getting-started/tutorials/with-nextjs).
