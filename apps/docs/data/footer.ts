...
export const primaryLinks = [
  {
    ...
    url: 'https://open-models-platform.com/dashboard/support/new',
  },
  {
    ...
    url: 'https://open-models-platform.com/changelog',
  },
  {
...
export const secondaryLinks = [
  ...
  { title: 'SupaSquad', url: 'https://open-models-platform.com/supasquad' },
