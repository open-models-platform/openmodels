...
export const FAQS = [
  {
    ...
    answer:
      'database.design is a new way to get ideas out of your head and into code as fast as possible. OpenModels provides you tools to making building incredibly fast. This tool focuses on the very first step: turning your idea into a database schema.',
  },
  {
