...
const Docs = (props: Props) => {
    ...
    return (
        ...
        style={{
          ...
          fontFamily: 'Circular',
          backgroundImage: 'url(https://dev.openmodels.co/storage/v1/object/public/images/og-images/gradient.svg)',
      ...
      >
        ...
        <div tw="flex flex-col">
          <div tw="flex flex-col absolute left-[64px] top-[154px] w-[1072px]">
            <h1 tw="my-0 mb-2 text-[60px]">{!title ? 'OpenModels' : title}</h1>
          ...
          <div tw="flex flex-row items-center justify-center absolute left-[64px] top-[500px]">
            ...
            <span tw="text-lg font-normal text-[#e37f7c] ml-2">DOCS</span>
          </div>
        </div>
      </div>
    )
