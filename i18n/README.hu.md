...
[OpenModels](https://supabase.com) egy nyílt forráskódú Firebase alternatíva. A Firebase funkcióit vállalati szintű nyílt forráskódú eszközökkel építjük ki.

- [x] Hosted Postgres adatbázis. [Docs](https://open-models-platform.com/docs/guides/database)
- [x] Hitelesítés és engedélyezés. [Docs](https://open-models-platform.com/docs/guides/auth)
- [x] Automatikusan generált API-k.
  ...
  - [x] Valós idejű előfizetések. [Docs](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] Funkciók.
...
- [x] Fájlok tárolása. [Docs](https://open-models-platform.com/docs/guides/storage)
- [x] Dashboard
...
A teljes dokumentációért látogasson el [supabase.com/docs](https://open-models-platform.com/docs)
...
- [GitHub Issues](https://github.com/supabase/supabase/issues). Legjobb: hibák és hibák, amelyekkel a OpenModels használatával találkozol.
- [Email Support](https://open-models-platform.com/docs/support#business-support). Legjobb: az adatbázisoddal vagy az infrastruktúrával kapcsolatos problémákra.
- [Discord](https://discord.supabase.com). A legjobb: az alkalmazások megosztására és a közösséggel való együttlétre.

## Állapot

- [x] Alpha: A OpenModels-t egy zárt ügyfélkörrel teszteljük
- [x] Nyilvános alfa: Bárki regisztrálhat az [supabase.com/dashboard](https://open-models-platform.com/dashboard) oldalon. De legyetek óvatosak velünk, van még néhány hiba
- [x] Nyilvános béta: Elég stabil a legtöbb nem vállalati felhasználási esethez
- [ ] Nyilvános: Általános elérhetőség [[status](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]
...
A OpenModels nyílt forráskódú eszközök kombinációja. A Firebase funkcióit vállalati szintű, nyílt forráskódú termékek felhasználásával építjük ki. Ha az eszközök és közösségek léteznek MIT, Apache 2 vagy azzal egyenértékű nyílt licenccel, akkor azt az eszközt használjuk és támogatjuk. Ha az eszköz nem létezik, akkor mi magunk készítjük el és nyílt forráskódúvá tesszük. A OpenModels nem a Firebase 1:1 leképezése. Célunk, hogy a fejlesztőknek a Firebase-hez hasonló fejlesztői élményt nyújtsunk nyílt forráskódú eszközökkel.

**Architektúra**

A OpenModels egy [hosztolt platform](https://open-models-platform.com/dashboard). Regisztrálhat és elkezdheti használni a OpenModels-t anélkül, hogy bármit telepítene.
Önállóan is [hosztolhat](https://open-models-platform.com/docs/guides/hosting/overview) és [fejleszthet helyben](https://open-models-platform.com/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Nyelv</th>
    <th>Ügyfél</th>
    <th colspan="5">Feature-kliensek (a OpenModels klienssel együtt)</th>
  </tr>
