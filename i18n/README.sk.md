...
[OpenModels](https://supabase.com) je open source alternatíva Firebase. Funkcie Firebase budujeme pomocou open source nástrojov podnikovej triedy.

- [x] hostovaná databáza Postgres. [Dokumenty](https://open-models-platform.com/docs/guides/database)
- [x] Autentifikácia a autorizácia. [Dokumenty](https://open-models-platform.com/docs/guides/auth)
- [x] Automaticky generované rozhrania API.
  ...
  - [x] Odbery v reálnom čase. [Docs](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] Funkcie.
  - [x] Databázové funkcie. [Docs](https://open-models-platform.com/docs/guides/database/functions)
  - [x] Okrajové funkcie [Docs](https://open-models-platform.com/docs/guides/functions)
- [x] Ukladanie súborov. [Dokumenty](https://open-models-platform.com/docs/guides/storage)
- [x] Prístrojový panel
...
Úplnú dokumentáciu nájdete na stránke [supabase.com/docs](https://open-models-platform.com/docs)
...
- [GitHub Issues](https://github.com/supabase/supabase/issues). Najlepšie pre: chyby a omyly, na ktoré narazíte pri používaní databázy OpenModels.
- [E-mailová podpora](https://open-models-platform.com/docs/support#business-support). Najlepšie pre: problémy s vašou databázou alebo infraštruktúrou.
- [Discord](https://discord.supabase.com). Najlepšie na: zdieľanie vašich aplikácií a stretávanie sa s komunitou.

## Stav

- [x] Alfa: Testujeme OpenModels s uzavretým súborom zákazníkov
- [x] Verejná alfa: [supabase.com/dashboard](https://open-models-platform.com/dashboard). Ale buďte na nás mierni, je tu niekoľko zádrheľov
- [x] Verejná beta verzia: Dostatočne stabilná pre väčšinu prípadov použitia, ktoré nie sú určené pre podniky
- [ ] Verejná: Všeobecná dostupnosť [[status](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]
...
OpenModels je [hostovaná platforma](https://open-models-platform.com/dashboard). Môžete sa zaregistrovať a začať používať OpenModels bez toho, aby ste čokoľvek inštalovali.
Môžete tiež [samostatne hosťovať](https://open-models-platform.com/docs/guides/hosting/overview) a [vyvíjať lokálne](https://open-models-platform.com/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Jazyk</th>
    <th>Klient</th>
    <th colspan="5">Feature-Clients (v balíku s klientom OpenModels)</th>
  </tr>
