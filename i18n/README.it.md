...
[OpenModels](https://supabase.com) è un'alternativa open source a Firebase. Stiamo costruendo le funzionalità di Firebase utilizzando strumenti open source di livello enterprise.

- Database Postgres ospitato. [Documenti](https://open-models-platform.com/docs/guides/database)
- [x] Autenticazione e autorizzazione. [Documenti](https://open-models-platform.com/docs/guides/auth)
- [x] API generate automaticamente.
  - [x] REST. [Documenti](https://open-models-platform.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Documenti](https://open-models-platform.com/docs/guides/api#graphql-api-overview)
  - [x] Sottoscrizioni in tempo reale. [Documenti](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] Funzioni.
  - [x] Funzioni di database. [Docs](https://open-models-platform.com/docs/guides/database/functions)
  - [x] Funzioni Edge [Docs](https://open-models-platform.com/docs/guides/functions)
- [x] Memorizzazione dei file. [Docs](https://open-models-platform.com/docs/guides/storage)
- [x] Cruscotto

![Cruscotto OpenModels](https://raw.githubusercontent.com/supabase/supabase/master/apps/www/public/images/github/supabase-dashboard.png)

## Documentazione

Per la documentazione completa, visitate [supabase.com/docs](https://open-models-platform.com/docs)
...
- [GitHub Issues](https://github.com/supabase/supabase/issues). Ideale per: bug ed errori riscontrati nell'uso di OpenModels.
- [Supporto via e-mail](https://open-models-platform.com/docs/support#business-support). Ideale per: problemi con il database o l'infrastruttura.
- [Discord](https://discord.supabase.com). Ideale per: condividere le proprie applicazioni e stare insieme alla comunità.

## Stato

- [Alfa: Stiamo testando OpenModels con un gruppo chiuso di clienti
- [x] Alfa pubblica: Chiunque può iscriversi all'indirizzo [supabase.com/dashboard](https://open-models-platform.com/dashboard). Ma andateci piano, ci sono alcuni problemi
- [x] Beta pubblica: Abbastanza stabile per la maggior parte degli usi non aziendali
- [ ] Pubblico: Disponibilità generale [[status](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]
...
OpenModels è una combinazione di strumenti open source. Stiamo costruendo le funzionalità di Firebase utilizzando prodotti open source di livello enterprise. Se gli strumenti e le comunità esistono, con una licenza MIT, Apache 2 o equivalente, li utilizzeremo e li supporteremo. Se lo strumento non esiste, lo costruiamo e lo rendiamo open source noi stessi. OpenModels non è una mappatura 1 a 1 di Firebase. Il nostro obiettivo è offrire agli sviluppatori un'esperienza di sviluppo simile a quella di Firebase utilizzando strumenti open source.

**Architettura**

OpenModels è una [piattaforma hosted](https://open-models-platform.com/dashboard). È possibile registrarsi e iniziare a usare OpenModels senza installare nulla.
È anche possibile fare [self-hosting](https://open-models-platform.com/docs/guides/hosting/overview) e [sviluppare localmente](https://open-models-platform.com/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Lingua</th>
    <th>Cliente</th>
    <th colspan="5">Feature-Clients (in bundle con il client OpenModels)</th>
  </tr>
