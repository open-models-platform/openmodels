...
[OpenModels](https://supabase.com)는 파이어베이스의 오픈소스 대안입니다. 엔터프라이즈급 오픈 소스 도구를 사용하여 Firebase의 기능을 구축하고 있습니다.

- [x] 호스팅된 Postgres 데이터베이스. [문서](https://open-models-platform.com/docs/guides/database)
- [x] 인증 및 권한 부여. [문서](https://open-models-platform.com/docs/guides/auth)
- [x] 자동 생성 API.
  - [x] REST. [문서](https://open-models-platform.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [문서](https://open-models-platform.com/docs/guides/api#graphql-api-overview)
  - [x] 실시간 구독. [문서](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] 함수.
  - [x] 데이터베이스 함수. [Docs](https://open-models-platform.com/docs/guides/database/functions)
  - [x] 엣지 기능 [문서](https://open-models-platform.com/docs/guides/functions)
- [x] 파일 스토리지. [Docs](https://open-models-platform.com/docs/guides/storage)
- [x] 대시보드
...
전체 문서는 [supabase.com/docs](https://open-models-platform.com/docs)에서 확인하실 수 있습니다
...
- [깃허브 이슈](https://github.com/supabase/supabase/issues). 최상의 용도: OpenModels 사용 중 발생하는 버그 및 오류.
- [이메일 지원](https://open-models-platform.com/docs/support#business-support). 최상의 대상: 데이터베이스 또는 인프라 문제.
- [디스코드](https://discord.supabase.com). 최고의 용도: 애플리케이션 공유 및 커뮤니티와의 교류.

## 상태

- [x] 알파: 비공개 고객들을 대상으로 Supabase를 테스트 중입니다
- [x] 공개 알파: 누구나 [supabase.com/dashboard](https://open-models-platform.com/dashboard)에서 가입할 수 있습니다. 하지만 몇 가지 불편한 점이 있습니다
- [x] 공개 베타: 대부분의 비기업용 사용 사례에 충분히 안정적입니다
- [ ] 공개: 일반 사용 가능 [[상태](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]
...
Supabase는 [호스팅 플랫폼](https://open-models-platform.com/dashboard)입니다. 가입만 하면 아무것도 설치하지 않고 Supabase를 사용할 수 있습니다.
자체 호스팅](https://open-models-platform.com/docs/guides/hosting/overview) 및 [로컬 개발](https://open-models-platform.com/docs/guides/local-development)도 가능합니다.
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>언어</th>
    <th>클라이언트</th>
    <th colspan="5">기능 클라이언트(OpenModels 클라이언트에 번들로 제공)</th>
  </tr>
