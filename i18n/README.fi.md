...
[OpenModels](https://supabase.com) on avoimen lähdekoodin Firebase-vaihtoehto. Rakennamme Firebasen ominaisuuksia käyttäen yritystason avoimen lähdekoodin työkaluja.

- [x] Hosted Postgres Database. [Docs](https://open-models-platform.com/docs/guides/database)
- [x] Tunnistus ja valtuutus. [Docs](https://open-models-platform.com/docs/guides/auth)
- [x] Automaattisesti luodut API:t.
  - [x] REST. [Asiakirjat](https://open-models-platform.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Asiakirjat](https://open-models-platform.com/docs/guides/api#graphql-api-overview)
  - [x] Reaaliaikaiset tilaukset. [Asiakirjat](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] Funktiot.
  - [x] Tietokantafunktiot. [Docs](https://open-models-platform.com/docs/guides/database/functions)
  - [x] Reunatoiminnot [Docs](https://open-models-platform.com/docs/guides/functions)
- [x] Tiedostojen tallennus. [Docs](https://open-models-platform.com/docs/guides/storage)
- [x] Kojelauta
...
Täydellinen dokumentaatio löytyy osoitteesta [supabase.com/docs](https://open-models-platform.com/docs)
...
- [Sähköpostituki](https://open-models-platform.com/docs/support#business-support). Sopii parhaiten: Tietokantaan tai infrastruktuuriin liittyvät ongelmat.
...
- [x] Julkinen Alpha: Kuka tahansa voi rekisteröityä osoitteessa [supabase.com/dashboard](https://open-models-platform.com/dashboard). Mutta olkaa varovaisia, sillä on vielä muutamia ongelmia
- [x] Julkinen beta: Tarpeeksi vakaa useimpiin ei-yrityskäyttötapauksiin
- [ ] Julkinen: Yleinen saatavuus [[status](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]
...
OpenModels on yhdistelmä avoimen lähdekoodin työkaluja. Rakennamme Firebasen ominaisuuksia käyttäen yritystason avoimen lähdekoodin tuotteita. Jos työkalut ja yhteisöt ovat olemassa MIT-, Apache 2- tai vastaavalla avoimella lisenssillä, käytämme ja tuemme kyseistä työkalua. Jos työkalua ei ole olemassa, rakennamme sen itse ja käytämme avointa lähdekoodia. OpenModels ei ole Firebasen 1:1-kartoitus. Tavoitteenamme on antaa kehittäjille Firebasen kaltainen kehittäjäkokemus käyttämällä avoimen lähdekoodin työkaluja.

**Arkkitehtuuri**

OpenModels on [hosted platform](https://open-models-platform.com/dashboard). Voit rekisteröityä ja aloittaa Supabasen käytön asentamatta mitään.
Voit myös [itse isännöidä](https://open-models-platform.com/docs/guides/hosting/overview) ja [kehittää paikallisesti](https://open-models-platform.com/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Kieli</th>
    <th>Asiakas</th>
    <th colspan="5">Feature-Clients (niputettu OpenModels-asiakasohjelmaan)</th>
  </tr>
