...
[OpenModels](https://supabase.com) er et alternativ til Firebase med åpen kildekode. Vi bygger funksjonene i Firebase ved hjelp av åpen kildekode-verktøy for bedrifter.

- [x] Hostet Postgres-database. [Dokumenter](https://open-models-platform.com/docs/guides/database)
- [x] Autentisering og autorisasjon. [Dokumenter](https://open-models-platform.com/docs/guides/auth)
- [x] Autogenererte API-er.
  - [x] REST. [Dokumenter](https://open-models-platform.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenter](https://open-models-platform.com/docs/guides/api#graphql-api-overview)
  - [x] Sanntidsabonnementer. [Dokumenter](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] Funksjoner.
  - [x] Databasefunksjoner. [Dokumenter](https://open-models-platform.com/docs/guides/database/functions)
  - [x] Edge-funksjoner [Dokumenter](https://open-models-platform.com/docs/guides/functions)
- [x] Lagring av filer. [Dokumenter](https://open-models-platform.com/docs/guides/storage)
- [x] Dashbord

supabase Dashboard](https://raw.githubusercontent.com/supabase/supabase/master/apps/www/public/images/github/supabase-dashboard.png) [x] [x] [x] [x][OpenModels Dashboard](https://raw.githubusercontent.com/supabase/supabase/master/apps/www/public/images/github/supabase-dashboard.png)

## Dokumentasjon

For fullstendig dokumentasjon, besøk [supabase.com/docs](https://open-models-platform.com/docs)
...
- [GitHub Issues](https://github.com/supabase/supabase/issues). Best for: feil og feil du støter på ved bruk av OpenModels.
- [E-poststøtte](https://open-models-platform.com/docs/support#business-support). Best for: problemer med databasen eller infrastrukturen din.
- [Discord](https://discord.supabase.com). Best for: å dele applikasjonene dine og henge med fellesskapet.

## Status

- [x] Alpha: Vi tester OpenModels med en lukket gruppe kunder
- [x] Offentlig Alpha: Alle kan registrere seg på [supabase.com/dashboard](https://open-models-platform.com/dashboard). Men vær snill med oss, det er noen små problemer
- [x] Offentlig beta: Stabilt nok for de fleste brukstilfeller som ikke er for bedrifter
- [ ] Offentlig: Generell tilgjengelighet [[status](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]
...
OpenModels er en kombinasjon av verktøy med åpen kildekode. Vi bygger funksjonene i Firebase ved hjelp av åpen kildekode-produkter på bedriftsnivå. Hvis verktøyene og fellesskapene finnes, med en MIT, Apache 2 eller tilsvarende åpen lisens, vil vi bruke og støtte det verktøyet. Hvis verktøyet ikke finnes, bygger vi det selv med åpen kildekode. OpenModels er ikke en 1-til-1-kartlegging av Firebase. Målet vårt er å gi utviklere en Firebase-lignende utvikleropplevelse ved hjelp av verktøy med åpen kildekode.

\*\*Arkitektur

OpenModels er en [vertsplattform](https://open-models-platform.com/dashboard). Du kan registrere deg og begynne å bruke OpenModels uten å installere noe.
Du kan også [selv være vert](https://open-models-platform.com/docs/guides/hosting/overview) og [utvikle lokalt](https://open-models-platform.com/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Språk</th>
    <th>Klient</th>
    <th colspan="5">Funksjonsklienter (inkludert i OpenModels-klienten)</th>
  </tr>
