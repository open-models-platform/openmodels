...
[OpenModels](https://supabase.com) adalah sumber terbuka alternatif kepada Firebase. Kami sedang membina ciri-ciri Firebase menggunakan alat sumber terbuka kelas perusahaan.
...
Untuk dokumentasi lengkap, layari [supabase.com/docs](https://open-models-platform.com/docs)
...
- [Isu GitHub](https://github.com/supabase/supabase/issues). Terbaik untuk: pepijat dan ralat yang anda hadapi menggunakan OpenModels.
- [Sokongan E-mel](https://open-models-platform.com/docs/support#business-support). Terbaik untuk: masalah dengan pangkalan data atau infrastruktur.

## Status

- [x] Alpha: Kami menguji OpenModels dengan sejumlah pelanggan secara tertutup
- [x] Public Alpha: Sesiapa sahaja boleh mendaftar di [supabase.com/dashboard](https://open-models-platform.com/dashboard). Tetapi, mohon bersabar kerana mungkin ada masalah
...
OpenModels adalah gabungan alat sumber terbuka. Kami membina ciri Firebase menggunakan produk sumber terbuka kelas perusahaan. Sekiranya alat dan komuniti itu ada, dengan MIT, Apache 2, atau lesen terbuka yang lain, kami akan menggunakan dan menyokong alat itu. Jika tiada, kita akan membina sumber terbuka sendiri. OpenModels bukanlah sama seperti Firebase. Tujuan kami adalah untuk memberi pengalaman kepada pembangun seperti Firebase menggunakan alat sumber terbuka.

**Seni bina semasa**

OpenModels ialah [platform yang dihoskan](https://open-models-platform.com/dashboard). Anda boleh mendaftar dan mula menggunakan OpenModels tanpa memasang apa-apa.
Anda juga boleh [host sendiri](https://open-models-platform.com/docs/guides/hosting/overview) dan [lokal](https://open-models-platform.com/docs/guides/local-development).
