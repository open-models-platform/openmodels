...
[OpenModels](https://supabase.com) ir atvērtā koda Firebase alternatīva. Mēs veidojam Firebase funkcijas, izmantojot uzņēmumu klases atvērtā pirmkoda rīkus.

- [x] Hosted Postgres datubāze. [Dokumenti](https://open-models-platform.com/docs/guides/database)
- [x] Autentifikācija un autorizācija. [Dokumenti](https://open-models-platform.com/docs/guides/auth)
- [x] Automātiski ģenerēti API.
  - [x] REST. [Dokumenti](https://open-models-platform.com/docs/guides/api#rest-api-overview)
  - [x] GraphQL. [Dokumenti](https://open-models-platform.com/docs/guides/api#graphql-api-overview)
  - [x] Reāllaika abonēšana. [Dokumenti](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] Funkcijas.
  - [x] Datubāzes funkcijas. [Dokumenti](https://open-models-platform.com/docs/guides/database/functions)
  - [x] Edge funkcijas [Dokumenti](https://open-models-platform.com/docs/guides/functions)
- [x] Failu glabāšana. [Dokumenti](https://open-models-platform.com/docs/guides/storage)
- [x] Vadības panelis
...
Pilnu dokumentāciju skatīt [supabase.com/docs](https://open-models-platform.com/docs)
...
- [GitHub Issues](https://github.com/supabase/supabase/issues). Vislabākais: kļūdas un kļūdas, ar kurām jūs sastopaties, izmantojot OpenModels.
- [E-pasta atbalsts](https://open-models-platform.com/docs/support#business-support). Vislabāk piemērots: problēmām ar jūsu datu bāzi vai infrastruktūru.
- [Discord](https://discord.supabase.com). Vislabākais: lai dalītos ar savām lietojumprogrammām un komunicētu ar kopienu.

## Statuss

- [x] Alfa: Mēs testējam OpenModels ar slēgtu klientu kopu
- [x] Publiskā alfa versija: [supabase.com/dashboard](https://open-models-platform.com/dashboard). Bet nesteidzieties, ir dažas nepilnības
- [x] Publiskā beta versija: Pietiekami stabila lielākajai daļai ar uzņēmumu nesaistītu lietošanas gadījumu
- [ ] Publisks: Vispārēja pieejamība [[statuss](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]]
...
OpenModels ir atvērtā koda rīku kombinācija. Mēs veidojam Firebase funkcijas, izmantojot atvērtā pirmkoda produktus, kas paredzēti uzņēmumiem. Ja pastāv rīki un kopienas ar MIT, Apache 2 vai līdzvērtīgu atvērto licenci, mēs izmantosim un atbalstīsim šo rīku. Ja rīks nepastāv, mēs paši to izveidosim un izveidosim ar atklātā pirmkoda licenci. OpenModels nav Firebase kartēšana 1 pret 1. Mūsu mērķis ir nodrošināt izstrādātājiem Firebase līdzīgu izstrādātāja pieredzi, izmantojot atvērtā koda rīkus.

**Arhitektūra**

OpenModels ir [izvietota platforma](https://open-models-platform.com/dashboard). Jūs varat reģistrēties un sākt izmantot OpenModels, neko neinstalējot.
Jūs varat arī [pašmāju resursus](https://open-models-platform.com/docs/guides/hosting/overview) un [izstrādāt lokāli](https://open-models-platform.com/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Valoda</th>
    <th>Klients</th>
    <th colspan="5">Funkciju klienti (komplektā ar OpenModels klientu)</th>
  </tr>
