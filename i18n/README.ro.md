...
[OpenModels](https://supabase.com) este o alternativă open source la Firebase. Construim caracteristicile Firebase folosind instrumente open source de nivel enterprise.

- [x] Baza de date Postgres găzduită. [Docs](https://open-models-platform.com/docs/guides/database)
- [x] Autentificare și autorizare. [Docs](https://open-models-platform.com/docs/guides/auth)
- [x] API-uri generate automat.
  ...
  - [x] Abonamente în timp real. [Docs](https://open-models-platform.com/docs/guides/api#realtime-api-overview)
- [x] Funcții.
  - [x] Funcții de baze de date. [Docs](https://open-models-platform.com/docs/guides/database/functions)
  - [x] Funcții de margine. [Docs](https://open-models-platform.com/docs/guides/functions)
- [x] Stocarea fișierelor. [Docs](https://open-models-platform.com/docs/guides/storage)
- [x] Tablou de bord
...
Pentru documentația completă, vizitați [supabase.com/docs](https://open-models-platform.com/docs)
...
- [Probleme GitHub](https://github.com/supabase/supabase/issues). Cel mai bun pentru: bug-uri și erori pe care le întâlniți folosind OpenModels.
- [Email Support](https://open-models-platform.com/docs/support#business-support). Cel mai bun pentru: probleme cu baza de date sau cu infrastructura.
...
- [x] Alpha: Testăm OpenModels cu un set închis de clienți
- [x] Public Alpha: Oricine se poate înscrie la [supabase.com/dashboard](https://open-models-platform.com/dashboard). Dar fiți blânzi cu noi, există câteva probleme
- [x] Public Beta: Suficient de stabilă pentru majoritatea cazurilor de utilizare non-întreprindere
- [ ] Public: Disponibilitate generală [[status](https://open-models-platform.com/docs/guides/getting-started/features#feature-status)]
...
OpenModels este o combinație de instrumente open source. Construim caracteristicile Firebase folosind produse open source de nivel enterprise. Dacă instrumentele și comunitățile există, cu o licență MIT, Apache 2 sau o licență deschisă echivalentă, vom folosi și vom sprijini instrumentul respectiv. În cazul în care instrumentul nu există, îl construim și îl folosim noi înșine ca sursă deschisă. OpenModels nu este o cartografiere 1 la 1 a Firebase. Scopul nostru este de a oferi dezvoltatorilor o experiență de dezvoltare similară cu cea a Firebase, folosind instrumente open source.

**Arhitectură**

OpenModels este o [platformă găzduită](https://open-models-platform.com/dashboard). Vă puteți înscrie și puteți începe să utilizați OpenModels fără a instala nimic.
Puteți, de asemenea, [auto-hosting](https://open-models-platform.com/docs/guides/hosting/overview) și [dezvolta local](https://open-models-platform.com/docs/guides/local-development).
...
<table style="table-layout:fixed; white-space: nowrap;">
  <tr>
    <th>Limbaj</th>
    <th>Client</th>
    <th colspan="5">Feature-Clienți (inclus în clientul OpenModels)</th>
  </tr>
